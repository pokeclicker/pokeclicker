var Battle = (function () {
    ...
    Battle.prototype.generateNewEnemy = function () {
    };
    Battle.prototype.throwPokeball = function () {
    };
    Battle.prototype.catch = function () {
    };
    return Battle;
}());
var gameConstants;
...
var battlePokemon = (function () {
     ...
     */
    function battlePokemon(name, type1, type2, maxHealth, catchRate, exp, money, shiny) {
        this.name = name;
        this.type1 = type1;
        this.type2 = type2;
...
var randomBattlePokemonGenerator = (function () {
    ...
    randomBattlePokemonGenerator.generate = function (route, region) {
        if (route > 25) {
            return null;
        }
        ...
        var basePokemon = PokemonHelper.findPokemonByName(name);
        ...
        var shiny = this.generateShiny();
        return new battlePokemon(name, type1, type2, maxHealth, catchRate, exp, money, shiny);
    };
    randomBattlePokemonGenerator.generateShiny = function () {
        var chance = gameConstants.SHINY_CHANCE_BATTLE;
...
var PokemonHelper = (function () {
    ...
    PokemonHelper.findPokemonByName = function (name) {
