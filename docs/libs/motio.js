...
(function (h, C) {
    function l(a, D) {
        ...
        var e = F(D), b = this, v = !e.frames, q = [], n = {}, d = {}, m = 0, g, y, A, s, r, w;
        b.element = a;
        ...
        b.to = function (c, a, f) {
            ...
            if (c === m) if (0 === c) m = q.length; else if (c === q.length -
                1) m = -1; else return "function" === p(f) && f.call(b), b.pause(), b;
            d.finite = !0;
            d.to = c;
            d.immediate = !!a;
            d.callback = f;
        ...
        b.on = function (c, a) {
            if ("object" === p(c)) for (var f in c) {
                if (c.hasOwnProperty(f)) b.on(f, c[f])
            } else if ("function" === p(a)) {
                f = c.split(" ");
                for (var d = 0, e = f.length; d < e; d++) n[f[d]] = n[f[d]] || [], -1 === B(f[d], a) && n[f[d]].push(a)
            } else if ("array" === p(a)) for (f = 0, d = a.length; f < d; f++) b.on(c, a[f]);
            return b
        };
        b.off = function (a, d) {
            if (d instanceof Array) for (var f = 0, e =
                d.length; f < e; f++) b.off(a, d[f]); else for (var f = a.split(" "), e = 0, g = f.length; e < g; e++) if (n[f[e]] = n[f[e]] || [], "undefined" === p(d)) n[f[e]].length = 0; else {
                var h = B(f[e], d);
    ...
    (function () {
        ...
        t || (u = function (a) {
            var k = +new Date, l = Math.max(0, 16 - (k - p));
            p = k + l;
    ...
    h.Motio = l;
    l.defaults = {
        fps: 15, frames: 0, vertical: 0, width: 0,
        height: 0, speedX: 0, speedY: 0, bgWidth: 0, bgHeight: 0
    }
})(window);