...
const ChangelogItems = [
    ...
    new Changelog(changelogType.NEW, 'Dungeon loot information now displays the chance of obtaining each item'),
    new Changelog(changelogType.NEW, 'Added sorting functionality to the Pokédex'),
    ...
    new Changelog(changelogType.CHANGE, 'Jaboca Berry has been rebalanced - stronger aura and shorter growth time'),
    new Changelog(changelogType.CHANGE, 'Berry mutations that required an Oak Item to be equipped or a Pokémon to be obtained have been reworked'),
    new Changelog(changelogType.CHANGE, 'Dungeon entry cost now decreases as dungeon size shrinks'),
    ...
    new Changelog(changelogType.CHANGE, 'Adjusted several Pokémon locations and evolution methods'),
    new Changelog(changelogType.CHANGE, 'Swapped the Safari effects of the Razz and Nanab bait'),
    new Changelog(changelogType.CHANGE, 'Power Herb held item now boosts Attack in Battle Frontier rather than against Dungeon bosses'),
    ...
    new Changelog(changelogType.CHANGE, 'Cell Battery effect has been reworked'),
    new Changelog(changelogType.CHANGE, 'Berry plants will now flash to indicate they are close to withering'),
    ...
    new Changelog(changelogType.FIXED, 'Various styling issues across several themes'),
    new Changelog(changelogType.FIXED, 'Magic Ball not gaining XP from capturing Pokémon in the Safari'),
    ...
    new Changelog(changelogType.NEW, 'Ability to bulk sell Underground treasures'),
    ...
    new Changelog(changelogType.NEW, 'Added keybinds to open the Achievement Tracker (T) and activate Battery Discharge (D) in the Underground'),
    ...
    new Changelog(changelogType.CHANGE, 'Underground Helpers renamed to Underground Experts and Mines given unique names'),
