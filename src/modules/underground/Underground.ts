    ...
    initialize() {
        this.upgradeList = [
            new UndergroundUpgrade(
                ...
                AmountFactory.createArray(new Array(10).fill(50), Currency.diamond),
