    ...
    static loadSaves() {
        ...
        const showContextMenu = (top: number, left: number, key: string) => {
            $('#saveSelectorContextMenu').html(`
                ...
                <a class="dropdown-item bg-warning p-0" href="#"><label class="clickable my-0" style="padding:.75rem 1.5rem;" for="import-save" onclick="Save.key = '${key}';">Import (overwrite)</label></a>
