...
export default class KeyItems implements Feature {
    ...
    initialize(): void {
        this.itemList = [
            ...
            new KeyItem(KeyItemType.Egg_Incubator, 'An Egg Incubator obtained from Mr. Pokémon. This allows you to use the Pokémon Day Care to help improve your Pokémon Attack. Some baby Pokémon can only be found through breeding, too!',
                () => App.game.statistics.routeKills[Region.kanto][5]() >= ROUTE_KILLS_NEEDED, undefined, undefined, 'Egg Incubator'),
