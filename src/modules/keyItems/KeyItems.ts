    ...
    initialize(): void {
        this.itemList = [
            ...
            new LevelableKeyItem(KeyItemType.Fishing_rod, [
                ...
                new KeyItemLevel('Allows you to encounter rare Pokémon that live in Kanto\'s, Johto\'s, Hoenn\'s, Sinnoh\'s waters and common Pokémon that live in Unova\'s waters.', undefined),
                new KeyItemLevel('Allows you to encounter rare Pokémon that live in Kanto\'s, Johto\'s, Hoenn\'s, Sinnoh\'s waters and uncommon Pokémon that live in Unova\'s waters.', () => App.game.statistics.dungeonsCleared[getDungeonIndex('Reversal Mountain')]() > 0),
