...
SubRegions.addSubRegion(Region.sinnoh, new SubRegion('Hisui', SinnohSubRegions.Hisui, new QuestLineStepCompletedRequirement('The Noble Light of Arceus', 1), 'Prelude Beach'));
