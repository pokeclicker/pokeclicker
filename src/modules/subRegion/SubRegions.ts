...
SubRegions.addSubRegion(Region.kalos, new SubRegion('Delta Episode', KalosSubRegions.DeltaEpisode, new GymBadgeRequirement(BadgeEnums.Elite_KalosChampion), 'Delta Slateport City'));
