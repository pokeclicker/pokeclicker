...
SubRegions.addSubRegion(Region.galar, new SubRegion('Lental', GalarSubRegions.Lental, new QuestLineStartedRequirement('New Pokémon Snap'), 'Professor Mirror\'s Research Lab'));
