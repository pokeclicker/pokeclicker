...
SubRegions.addSubRegion(Region.kalos, new SubRegion('Delta Episode', KalosSubRegions.DeltaEpisode, new QuestLineStartedRequirement('Delta Episode'), 'Delta Slateport City'));
