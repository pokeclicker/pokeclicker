...
SubRegions.addSubRegion(Region.galar, new SubRegion('Lental', GalarSubRegions.Lental, new QuestLineStartedRequirement('New Pokémon Snap'), 'Laboratory of Ecology and Natural Sciences'));
