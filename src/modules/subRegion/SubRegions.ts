...
SubRegions.addSubRegion(Region.sinnoh, new SubRegion('Hisui', SinnohSubRegions.Hisui, new QuestLineStepCompletedRequirement('The Frenzied Nobles of Hisui', 1), 'Prelude Beach'));
