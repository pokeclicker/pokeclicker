...
import HatcheryQueueEntry from './breeding/HatcheryQueueEntry';
import HatcheryTypeGuards from './breeding/HatcheryTypeGuards';
import * as HatcheryNameTypes from './breeding/HatcheryNameTypes';
