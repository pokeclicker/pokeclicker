...
export default class DynamicBackground {
    ...
    static addPokemon = (id) => {
        ...
        pokeElement.style.backgroundImage = `${shiny ? 'url(\'assets/images/dynamic-background/pokemon/sparkle.png\'), ' : ''}url('assets/images/dynamic-background/pokemon/${id.toString().padStart(4, 0)}${shiny ? 's' : ''}.png')`;
