...
export const Environments: Record<string, EnvironmentData> = {
    ...
    GemCave: {
        ...
        [Region.unova]: new Set(['Chargestone Cave', 'Mistralton Cave', 'Cave of Being', 'Dragonspiral Tower']),
    ...
    Mansion: {
        ...
        [Region.unova]: new Set(['Castelia City', 'Mistralton City', 'Opelucid City', 'Liberty Garden', 'Dreamyard']),
