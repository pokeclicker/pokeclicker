...
export const Environments: Record<string, EnvironmentData> = {
    Water: {
        [Region.kanto]: new Set(['Misty', 19, 20, 21, 24]),
        [Region.johto]: new Set([40, 41, 'Slowpoke Well']),
        [Region.hoenn]: new Set([105, 106, 107, 108, 109, 118, 122, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 'Wallace']),
        [Region.sinnoh]: new Set([218, 219, 220, 223, 230, 'Crasher Wake', 'Lake Verity', 'Lake Valor', 'Sendoff Spring']),
        [Region.unova]: new Set([17, 18, 21, 24, 'Undella Town', 'Marlon']),
        [Region.kalos]: new Set([8, 23, 'Ramos', 'Couriway Town', 'Sea Spirit\'s Den', 'Siebold']),
    ...
    Ice: {
        [Region.kanto]: new Set(['Seafoam Islands', 'Lorelei']),
        [Region.johto]: new Set(['Pryce', 'Ice Path']),
        [Region.hoenn]: new Set(['Shoal Cave', 'Juan', 'Glacia']),
        [Region.sinnoh]: new Set([216, 217, 'Lake Acuity', 'Candice']),
        [Region.unova]: new Set(['Giant Chasm', 'Plasma Assault']),
        [Region.kalos]: new Set([17, 'Dendemille Town', 'Wulfric', 'Frost Cavern']),
        [Region.alola]: new Set(['Mount Lanakila']),
        [Region.galar]: new Set(['Circhester', 20, 23, 24]),
    },

    Forest: {
        [Region.kanto]: new Set([25, 'Koga', 'Viridian Forest']),
        [Region.johto]: new Set([36, 38, 43, 'Bugsy', 'Ilex Forest', 'Koga2']),
        [Region.hoenn]: new Set([119, 'Petalburg Woods', 'Winona']),
        [Region.sinnoh]: new Set([201, 204, 'Eterna Forest', 'Gardenia', 'Aaron', 'Fullmoon Island', 'Newmoon Island']),
        [Region.unova]: new Set([6, 'Burgh', 'Lostlorn Forest', 'Pinwheel Forest', 'Pledge Grove']),
        [Region.kalos]: new Set([1, 14, 20, 'Valerie', 'Santalune Forest', 'Pokémon Village']),
    ...
    Cave: {
        [Region.kanto]: new Set(['Brock', 'Diglett\'s Cave', 'Mt. Moon', 'Rock Tunnel', 'Victory Road', 'Bruno']),
        [Region.johto]: new Set(['Chuck', 'Ruins of Alph', 'Union Cave', 'Mt. Mortar', 'Dark Cave', 'Victory Road Johto', 'Bruno2']),
        [Region.hoenn]: new Set(['Roxanne', 'Brawly', 'Rusturf Tunnel', 'Granite Cave', 'Fiery Path', 'Meteor Falls', 'Mt. Chimney', 'Victory Road Hoenn', 'Seafloor Cavern']),
        [Region.sinnoh]: new Set(['Oreburgh Gate', 'Roark', 'Ravaged Path', 'Wayward Cave', 'Mt. Coronet', 'Mt. Coronet South', 'Iron Island', 'Mt. Coronet North', 'Victory Road Sinnoh']),
        [Region.unova]: new Set(['Castelia Sewers', 'Seaside Cave', 'Twist Mountain', 'Reversal Mountain', 'Relic Passage', 'Relic Castle', 'Victory Road Unova']),
    ...
    GemCave: {
        [Region.kanto]: new Set(['Giovanni', 'Cerulean Cave']),
        [Region.johto]: new Set(['Clair', 'Mt. Silver', 'Whirl Islands']),
        [Region.hoenn]: new Set(['Mt. Chimney Crater', 'Cave of Origin', 'Sky Pillar', 'Sealed Chamber']),
        [Region.sinnoh]: new Set(['Spear Pillar', 'Hall of Origin', 'Stark Mountain']),
        [Region.unova]: new Set(['Chargestone Cave', 'Mistralton Cave', 'Cave of Being', 'Iris']),
    ...
    PowerPlant: {
        [Region.kanto]: new Set(['Lt. Surge', 'Power Plant']),
        [Region.johto]: new Set(['Jasmine', 'Team Rocket\'s Hideout', 'Radio Tower']),
        [Region.hoenn]: new Set(['Wattson', 'New Mauville']),
        [Region.sinnoh]: new Set(['Team Galactic Eterna Building', 'Team Galactic HQ', 'Byron', 'Volkner']),
        [Region.unova]: new Set(['Roxie', 'Elesa', 'Plasma Frigate']),
        [Region.kalos]: new Set(['Clemont', 'Kalos Power Plant', 'Pokéball Factory', 'Team Flare Secret HQ']),
    ...
    Mansion: {
        ...
        [Region.johto]: new Set(['Whitney', 'Burned Tower', 'Tin Tower']),
        [Region.hoenn]: new Set(['Flannery', 'Norman']),
    ...
    Graveyard: {
        [Region.kanto]: new Set(['Sabrina', 'Pokémon Tower', 'Agatha']),
        [Region.johto]: new Set(['Morty', 'Will']),
        [Region.hoenn]: new Set(['Tate & Liza', 'Mt. Pyre', 'Sidney', 'Phoebe']),
        [Region.sinnoh]: new Set(['Fantina', 'Solaceon Ruins', 'Distortion World', 'Lucian']),
        [Region.unova]: new Set(['Celestial Tower', 'Shauntal', 'Grimsley']),
        [Region.kalos]: new Set(['Olympia']),
        [Region.alola]: new Set(['Hau\'oli Cemetery', 'Memorial Hill', 'Nanu', 'Acerola']),
    ...
    DefaultGym: {
        ...
        [Region.unova]: new Set(['Marshal', 'Caitlin']),
