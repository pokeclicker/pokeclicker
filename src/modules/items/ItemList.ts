...
ItemList.PokeBlock_Purple    = new PokeBlock(PokeBlockColor.Purple, Infinity, 'Changes a Pokémon\'s Contest Type from Cool to Beautiful or vice versa.');
ItemList.PokeBlock_Indigo    = new PokeBlock(PokeBlockColor.Indigo, Infinity, 'Changes a Pokémon\'s Contest Type from Beautiful to Cute or vice versa.');
ItemList.PokeBlock_Brown     = new PokeBlock(PokeBlockColor.Brown, Infinity, 'Changes a Pokémon\'s Contest Type from Cute to Smart or vice versa.');
ItemList.PokeBlock_Olive     = new PokeBlock(PokeBlockColor.Olive, Infinity, 'Changes a Pokémon\'s Contest Type from Smart to Tough or vice versa.');
ItemList.PokeBlock_Orange    = new PokeBlock(PokeBlockColor.Orange, Infinity, 'Changes a Pokémon\'s Contest Type from Smart to Tough or vice versa.');
ItemList.PokeBlock_Black     = new PokeBlock(PokeBlockColor.Black, Infinity, 'Increases the Sheen of any Pokémon.');
ItemList.PokeBlock_Cool      = new PokeBlock(PokeBlockColor.Cool, Infinity, 'Adds Cool to a Pokémon\'s Contest Types.');
ItemList.PokeBlock_Beautiful = new PokeBlock(PokeBlockColor.Beautiful, Infinity, 'Adds Beautiful a Pokémon\'s Contest Types.');
ItemList.PokeBlock_Cute      = new PokeBlock(PokeBlockColor.Cute, Infinity, 'Adds Cute a Pokémon\'s Contest Types.');
ItemList.PokeBlock_Smart     = new PokeBlock(PokeBlockColor.Smart, Infinity, 'Adds Smart a Pokémon\'s Contest Types.');
ItemList.PokeBlock_Tough     = new PokeBlock(PokeBlockColor.Tough, Infinity, 'Adds Tough to a Pokémon\'s Contest Types.');
ItemList.PokeBlock_Balanced  = new PokeBlock(PokeBlockColor.Balanced, Infinity, 'Adds Balanced a Pokémon\'s Contest Types.');
