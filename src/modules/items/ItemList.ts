...
ItemList.PokeBlock_White     = new PokeBlock(PokeBlockColor.White, 1, undefined, undefined, undefined, 'A mild Pokéblock that boosts the Appeal of any Pokémon. It also ignores sheen debuff for testing.');
