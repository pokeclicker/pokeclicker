...
ItemList.PokeBlock_Red       = new PokeBlock(PokeBlockColor.Red, 1, undefined, ContestType.Cool,
    (pokemon) => pokemon.currentContestTypes.includes(ContestType.Cool) || pokemon.currentContestTypes.includes(ContestType.Balanced), 'A Spicy Pokéblock that boosts the Appeal of Cool Pokémon');
ItemList.PokeBlock_Blue      = new PokeBlock(PokeBlockColor.Blue, 1, undefined, ContestType.Beautiful,
    (pokemon) => pokemon.currentContestTypes.includes(ContestType.Beautiful) || pokemon.currentContestTypes.includes(ContestType.Balanced), 'A Dry Pokéblock that boosts the Appeal of Beautiful Pokémon');
ItemList.PokeBlock_Pink      = new PokeBlock(PokeBlockColor.Pink, 1, undefined, ContestType.Cute,
    (pokemon) => pokemon.currentContestTypes.includes(ContestType.Cute) || pokemon.currentContestTypes.includes(ContestType.Balanced), 'A Sweet Pokéblock that boosts the Appeal of Cute Pokémon');
ItemList.PokeBlock_Green     = new PokeBlock(PokeBlockColor.Green, 1, undefined, ContestType.Smart,
    (pokemon) => pokemon.currentContestTypes.includes(ContestType.Smart) || pokemon.currentContestTypes.includes(ContestType.Balanced), 'A Bitter Pokéblock that boosts the Appeal of Smart Pokémon');
ItemList.PokeBlock_Yellow    = new PokeBlock(PokeBlockColor.Yellow, 1, undefined, ContestType.Tough,
    (pokemon) => pokemon.currentContestTypes.includes(ContestType.Tough) || pokemon.currentContestTypes.includes(ContestType.Balanced), 'A Sour Pokéblock that boosts the Appeal of Tough Pokémon');
