...
ItemList.PokeBlock_Red       = new PokeBlock(PokeBlockColor.Red, 1, undefined, ContestType.Cool,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Cool) || pokemon.currentContestType.includes(ContestType.Balanced));
ItemList.PokeBlock_Blue      = new PokeBlock(PokeBlockColor.Blue, 1, undefined, ContestType.Beautiful,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Beautiful) || pokemon.currentContestType.includes(ContestType.Balanced));
ItemList.PokeBlock_Pink      = new PokeBlock(PokeBlockColor.Pink, 1, undefined, ContestType.Cute,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Cute) || pokemon.currentContestType.includes(ContestType.Balanced));
ItemList.PokeBlock_Green     = new PokeBlock(PokeBlockColor.Green, 1, undefined, ContestType.Smart,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Smart) || pokemon.currentContestType.includes(ContestType.Balanced));
ItemList.PokeBlock_Yellow    = new PokeBlock(PokeBlockColor.Yellow, 1, undefined, ContestType.Tough,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Tough) || pokemon.currentContestType.includes(ContestType.Balanced));
ItemList.PokeBlock_White     = new PokeBlock(PokeBlockColor.White, 1);
ItemList.PokeBlock_Cool      = new PokeBlock(PokeBlockColor.Cool, 1, undefined, ContestType.Cool,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Cool), undefined, 'Changes a Pokémon\'s Contest Type to Cool');
ItemList.PokeBlock_Beautiful = new PokeBlock(PokeBlockColor.Beautiful, 1, undefined, ContestType.Beautiful,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Beautiful), undefined, 'Changes a Pokémon\'s Contest Type to Beautiful');
ItemList.PokeBlock_Cute      = new PokeBlock(PokeBlockColor.Cute, 1, undefined, ContestType.Cute,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Cute), undefined, 'Changes a Pokémon\'s Contest Type to Cute');
ItemList.PokeBlock_Smart     = new PokeBlock(PokeBlockColor.Smart, 1, undefined, ContestType.Smart,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Smart), undefined, 'Changes a Pokémon\'s Contest Type to Smart');
ItemList.PokeBlock_Tough     = new PokeBlock(PokeBlockColor.Tough, 1, undefined, ContestType.Tough,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Tough), undefined, 'Changes a Pokémon\'s Contest Type to Tough');
ItemList.PokeBlock_Balanced  = new PokeBlock(PokeBlockColor.Balanced, 1, undefined, ContestType.Balanced,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Balanced), undefined, 'Changes a Pokémon\'s Contest Type to Balanced');
