...
ItemList.PokeBlock_Red       = new PokeBlock(PokeBlockColor.Red, 1, undefined, ContestType.Cool,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Cool) || pokemon.currentContestType.includes(ContestType.Balanced), 'A Spicy Pokéblock that boosts the Appeal of Cool Pokémon');
ItemList.PokeBlock_Blue      = new PokeBlock(PokeBlockColor.Blue, 1, undefined, ContestType.Beautiful,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Beautiful) || pokemon.currentContestType.includes(ContestType.Balanced), 'A Dry Pokéblock that boosts the Appeal of Beautiful Pokémon');
ItemList.PokeBlock_Pink      = new PokeBlock(PokeBlockColor.Pink, 1, undefined, ContestType.Cute,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Cute) || pokemon.currentContestType.includes(ContestType.Balanced), 'A Sweet Pokéblock that boosts the Appeal of Cute Pokémon');
ItemList.PokeBlock_Green     = new PokeBlock(PokeBlockColor.Green, 1, undefined, ContestType.Smart,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Smart) || pokemon.currentContestType.includes(ContestType.Balanced), 'A Bitter Pokéblock that boosts the Appeal of Smart Pokémon');
ItemList.PokeBlock_Yellow    = new PokeBlock(PokeBlockColor.Yellow, 1, undefined, ContestType.Tough,
    (pokemon) => pokemon.currentContestType.includes(ContestType.Tough) || pokemon.currentContestType.includes(ContestType.Balanced), 'A Sour Pokéblock that boosts the Appeal of Tough Pokémon');
...
ItemList.PokeBlock_Cool      = new PokeBlock(PokeBlockColor.Cool, 1, undefined, ContestType.Cool,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Cool), 'Adds Cool to a Pokémon\'s Contest Types. Breeding reverts this change');
ItemList.PokeBlock_Beautiful = new PokeBlock(PokeBlockColor.Beautiful, 1, undefined, ContestType.Beautiful,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Beautiful), 'Adds Beautiful to a Pokémon\'s Contest Types. Breeding reverts this change');
ItemList.PokeBlock_Cute      = new PokeBlock(PokeBlockColor.Cute, 1, undefined, ContestType.Cute,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Cute), 'Adds Cute to a Pokémon\'s Contest Types. Breeding reverts this change');
ItemList.PokeBlock_Smart     = new PokeBlock(PokeBlockColor.Smart, 1, undefined, ContestType.Smart,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Smart), 'Adds Smart to a Pokémon\'s Contest Types. Breeding reverts this change');
ItemList.PokeBlock_Tough     = new PokeBlock(PokeBlockColor.Tough, 1, undefined, ContestType.Tough,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Tough), 'Adds Tough to a Pokémon\'s Contest Types. Breeding reverts this change');
ItemList.PokeBlock_Balanced  = new PokeBlock(PokeBlockColor.Balanced, 1, undefined, ContestType.Balanced,
    (pokemon) => !pokemon.currentContestType.includes(ContestType.Balanced), 'Adds Balanced to a Pokémon\'s Contest Types. Breeding reverts this change');
