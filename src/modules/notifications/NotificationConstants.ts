...
const NotificationConstants = {
    ...
    NotificationSound: {
        General: {
            ...
            roamer: new Sound('roamer', 'Roamer Pokémon encountered'),
    ...
    NotificationSetting: {
        General: {
            ...
            encountered_roamer: new NotificationSetting('notification.encountered_roamer', 'Encountered a roamer Pokémon', true),
