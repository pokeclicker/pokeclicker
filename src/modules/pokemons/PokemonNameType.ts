...
copy(`export const pokemonNameList = [${pokemonList.map(p => `'${p.name.replace(/'/g, "\\'")}'`).join(',\n    ')}] as const;
export type PokemonNameType = typeof pokemonNameList[number];`)
...
export const pokemonNameList = ['Bulbasaur',
    'Bulbasaur (clone)',
    'Spooky Bulbasaur',
    'Bulbasaur (Rose)',
    'Ivysaur',
