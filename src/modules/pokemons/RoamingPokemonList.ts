...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Shaymin (Land)', new MultiRequirement([new ObtainedPokemonRequirement('Shaymin (Land)'), new RouteKillRequirement(1000, Region.galar, 56), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [56]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Shaymin (Land)', new MultiRequirement([new ObtainedPokemonRequirement('Shaymin (Land)'), new RouteKillRequirement(1000, Region.galar, 56), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [56]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Mew', new MultiRequirement([new ObtainedPokemonRequirement('Mew'), new RouteKillRequirement(5000, Region.galar, 57), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [57]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Mew', new MultiRequirement([new ObtainedPokemonRequirement('Mew'), new RouteKillRequirement(1000, Region.galar, 57), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [57]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Ho-Oh', new MultiRequirement([new ObtainedPokemonRequirement('Ho-Oh'), new QuestLineCompletedRequirement('New Pokémon Snap'), new RouteKillRequirement(1000, Region.galar, 61)]), [61]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Celebi', new MultiRequirement([new ObtainedPokemonRequirement('Celebi'), new RouteKillRequirement(1000, Region.galar, 62)]), [62]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Manaphy', new MultiRequirement([new ObtainedPokemonRequirement('Manaphy'), new RouteKillRequirement(1000, Region.galar, 63), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [63]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Lugia', new MultiRequirement([new ObtainedPokemonRequirement('Lugia'), new RouteKillRequirement(5000, Region.galar, 64)]), [64]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Suicune', new MultiRequirement([new ObtainedPokemonRequirement('Suicune'), new QuestLineCompletedRequirement('New Pokémon Snap'), new RouteKillRequirement(1000, Region.galar, 66), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [66]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Diancie', new MultiRequirement([new ObtainedPokemonRequirement('Diancie'), new RouteKillRequirement(5000, Region.galar, 67)]), [67]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Jirachi', new MultiRequirement([new ObtainedPokemonRequirement('Jirachi'), new QuestLineCompletedRequirement('New Pokémon Snap'), new RouteKillRequirement(1000, Region.galar, 68)]), [68]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Zeraora', new MultiRequirement([new ObtainedPokemonRequirement('Zeraora'), new RouteKillRequirement(5000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [70]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Zeraora', new MultiRequirement([new ObtainedPokemonRequirement('Zeraora'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Garden)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Garden)'), new RouteKillRequirement(5000, Region.galar, 56), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [56]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Monsoon)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Monsoon)'), new RouteKillRequirement(1000, Region.galar, 57), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [57]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Jungle)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Jungle)'), new RouteKillRequirement(5000, Region.galar, 57), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [57]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Jungle)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Jungle)'), new RouteKillRequirement(1000, Region.galar, 57), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [57]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (River)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (River)'), new RouteKillRequirement(1000, Region.galar, 57), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [57]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Sun)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Sun)'), new RouteKillRequirement(1000, Region.galar, 59), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [59]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Savanna)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Savanna)'), new RouteKillRequirement(1000, Region.galar, 59), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [59]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (High Plains)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (High Plains)'), new RouteKillRequirement(5000, Region.galar, 61)]), [61]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Modern)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Modern)'), new RouteKillRequirement(5000, Region.galar, 62)]), [62]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Elegant)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Elegant)'), new RouteKillRequirement(5000, Region.galar, 62)]), [62]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Tundra)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Tundra)'), new RouteKillRequirement(1000, Region.galar, 66), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [66]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Polar)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Polar)'), new RouteKillRequirement(5000, Region.galar, 66), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [66]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Icy Snow)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Icy Snow)'), new RouteKillRequirement(1000, Region.galar, 66), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [66]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Jungle)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Jungle)'), new RouteKillRequirement(1000, Region.galar, 67)]), [67]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Archipelago)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Archipelago)'), new RouteKillRequirement(5000, Region.galar, 67)]), [67]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Continental)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Continental)'), new RouteKillRequirement(5000, Region.galar, 68)]), [68]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (River)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (River)'), new RouteKillRequirement(1000, Region.galar, 69), new DayCyclePartRequirement([DayCyclePart.Dawn, DayCyclePart.Day])]), [69]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Ocean)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Ocean)'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Modern)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Modern)'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Tundra)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Tundra)'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Marine)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Marine)'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Jungle)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Jungle)'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Vivillon (Polar)', new MultiRequirement([new SpecialEventRequirement('Lunar New Year'), new ObtainedPokemonRequirement('Vivillon (Polar)'), new RouteKillRequirement(1000, Region.galar, 70), new DayCyclePartRequirement([DayCyclePart.Dusk, DayCyclePart.Night])]), [70]));
