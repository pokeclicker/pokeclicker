...
import {
    ...
    getDungeonIndex, Starter, ResearchLevel, SnapEggsHatched,
} from '../GameConstants';
...
// Pokémon Island
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Zapdos', new StatisticRequirement(['pokemonHatched', 145], SnapEggsHatched), [72]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Moltres', new StatisticRequirement(['pokemonHatched', 146], SnapEggsHatched), [73]));
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Articuno', new StatisticRequirement(['pokemonHatched', 144], SnapEggsHatched), [75]));
...
RoamingPokemonList.add(Region.galar, 4, new RoamingPokemon('Flying Pikachu', new MultiRequirement([new SpecialEventRequirement('Flying Pikachu'), new RouteKillRequirement(ResearchLevel[4], Region.galar, 75)]), [75])); // Flying Pikachu can be found in Snap 64
