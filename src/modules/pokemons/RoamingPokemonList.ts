...
RoamingPokemonList.add(Region.unova, 0, new RoamingPokemon('Meloetta (Aria)', new MultiRequirement([new GymBadgeRequirement(BadgeEnums.Elite_UnovaChampion), new StatisticRequirement(['npcTalkedTo', GameHelper.hash(CelestialDreamerSaveKey)], 1, 'Don\'t talk to the Celestial Dreamer.', AchievementOption.less)])));
RoamingPokemonList.add(Region.unova, 0, new RoamingPokemon('Meloetta (Pirouette)', new MultiRequirement([new GymBadgeRequirement(BadgeEnums.Elite_UnovaChampion), new StatisticRequirement(['npcTalkedTo', GameHelper.hash(CelestialDreamerSaveKey)], 1, 'Talk to the Celestial Dreamer before catching any Meloetta.')])));
