...
export const pokemonList = createPokemonArray(
    ...
    },
    {
        ...
        'evolutions': [
            ...
            DummyEvolution('Spewpa', 'Vivillon (Icy Snow)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Polar)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Tundra)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Continental)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Garden)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Elegant)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Modern)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Marine)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Archipelago)', 12),
            DummyEvolution('Spewpa', 'Vivillon (High Plains)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Sandstorm)', 12),
            DummyEvolution('Spewpa', 'Vivillon (River)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Monsoon)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Savanna)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Sun)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Ocean)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Jungle)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Poké Ball)', 12),
            DummyEvolution('Spewpa', 'Vivillon (Fancy)', 12),
        ],
        'base': {
            'hitpoints': 45,
            'attack': 22,
