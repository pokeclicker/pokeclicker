...
import getContestRankTypeProxy from './getContestRankTypeProxy';
...
export default class Statistics implements Saveable {
    ...
    contestRoundsWon: Record<string, Record<string, KnockoutObservable<number>>>;
    contestRoundHighest: Record<string, Record<string, KnockoutObservable<number>>>;
    contestTrainersDefeated: Record<string, Record<string, KnockoutObservable<number>>>;
    contestTrainerStreak: Record<string, Record<string, KnockoutObservable<number>>>;
    // DungeonGuides
    ...
    autogeneratedObservables = [
        ...
        'contestRoundsWon',
        'contestRoundHighest',
        'contestTrainersDefeated',
        'contestTrainerStreak',
    ];
    ...
    constructor() {
        ...
        this.contestRoundsWon = getContestRankTypeProxy();
        this.contestRoundHighest = getContestRankTypeProxy();
        this.contestTrainersDefeated = getContestRankTypeProxy();
        this.contestTrainerStreak = getContestRankTypeProxy();
    }
