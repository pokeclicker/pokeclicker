...
export default class Statistics implements Saveable {
     ...
     * objectObservables
     */
    pokemonCaptured: Record<string, KnockoutObservable<number>>;
    pokemonDefeated: Record<string, KnockoutObservable<number>>;
    pokemonEncountered: Record<string, KnockoutObservable<number>>;
    pokemonHatched: Record<string, KnockoutObservable<number>>;
    shinyPokemonCaptured: Record<string, KnockoutObservable<number>>;
    shinyPokemonDefeated: Record<string, KnockoutObservable<number>>;
    shinyPokemonEncountered: Record<string, KnockoutObservable<number>>;
    shinyPokemonHatched: Record<string, KnockoutObservable<number>>;
    itemsObtained: Record<string, KnockoutObservable<number>>;
    itemsUsed: Record<string, KnockoutObservable<number>>;
    ...
    // These will only allow numbers, including negative and decimal values (special events, forms etc)
    objectObservables = [
        'pokemonCaptured',
        'pokemonDefeated',
        'pokemonEncountered',
    ...
    // These will allow any key value
    objectKeyObservables = [
        'itemsObtained',
        'itemsUsed',
    ];
    ...
    constructor() {
        ...
        this.objectKeyObservables.forEach((object) => {
            this[object] = new Proxy({}, {
                get: (statistics, prop: string) => {
                    if (typeof statistics[prop] !== 'undefined') {
                        return statistics[prop];
