...
export default class Statistics implements Saveable {
    ...
    // Contests
    contestsWon: Record<string, Record<string, KnockoutObservable<number>>>;
    ...
    constructor() {
        ...
        this.contestsWon = getContestRankTypeProxy();
        this.contestHighestScore = getContestRankTypeProxy();
    }
