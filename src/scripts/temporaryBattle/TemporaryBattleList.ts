...
TemporaryBattleList.May1 = new TemporaryBattle(
    ...
    [
        ...
        new GymPokemon('Treeko', 823400, 5, new StarterRequirement(GameConstants.Region.hoenn, 2)),
    ],
...
TemporaryBattleList.May2 = new TemporaryBattle(
    ...
    [
        ...
        new GymPokemon('Treeko', 1197952, 15, new StarterRequirement(GameConstants.Region.hoenn, 2)),
    ],
