...
TemporaryBattleList['Ultra Wormhole'] = new TemporaryBattle(
    'Ultra Wormhole',
    [new CustomGymPokemon('???', 508485861, 27, [PokemonType.Rock, PokemonType.Poison], undefined, false, 'QuestionMarks.png')],
    undefined, // custom quest message
...
TemporaryBattleList.Lusamine = new TemporaryBattle(
    ...
    [
        ...
        new CustomGymPokemon('You hateful little Trainer!', 183208637, 47, [PokemonType.Rock, PokemonType.Poison], undefined, false, 'YouHatefulLittleTrainer.png'),
    ],
    undefined,
