...
TemporaryBattleList['Guzma Bug Silvally'] = new TemporaryBattle(
    'Guzma Bug Silvally',
    [
        new GymPokemon('Golisopod', 214464883, 63),
        new GymPokemon('Ariados', 214464883, 63),
        new GymPokemon('Masquerain', 214464883, 63),
        new GymPokemon('Pinsir', 214464883, 63),
        new GymPokemon('Scizor', 214464883, 63),
        new GymPokemon('Silvally (Bug)', 264464883, 63),
    ],
...
TemporaryBattleList['Kahili Flying Silvally'] = new TemporaryBattle(
    ...
    [
        new GymPokemon('Skarmory', 264464883, 63),
        new GymPokemon('Crobat', 264464883, 63),
        new GymPokemon('Oricorio (Baile)', 264464883, 63),
        new GymPokemon('Mandibuzz', 264464883, 63),
        new GymPokemon('Toucannon', 264464883, 63),
        new GymPokemon('Silvally (Flying)', 314464883, 63),
    ],
...
TemporaryBattleList['Plumeria Poison Silvally'] = new TemporaryBattle(
    ...
    [
        new GymPokemon('Gengar', 314464883, 63),
        new GymPokemon('Alolan Muk', 314464883, 63),
        new GymPokemon('Crobat', 314464883, 63),
        new GymPokemon('Toxapex', 314464883, 63),
        new GymPokemon('Salazzle', 314464883, 63),
        new GymPokemon('Silvally (Poison)', 364464883, 63),
    ],
...
TemporaryBattleList['Acerola Ghost Silvally'] = new TemporaryBattle(
    ...
    [
        new GymPokemon('Banette', 364464883, 63),
        new GymPokemon('Drifblim', 364464883, 63),
        new GymPokemon('Dhelmise', 364464883, 63),
        new GymPokemon('Froslass', 364464883, 63),
        new GymPokemon('Palossand', 364464883, 63),
        new GymPokemon('Silvally (Ghost)', 414464883, 63),
    ],
...
TemporaryBattleList['Faba Psychic Silvally'] = new TemporaryBattle(
    ...
    [
        new GymPokemon('Claydol', 414464883, 63),
        new GymPokemon('Bruxish', 414464883, 63),
        new GymPokemon('Alolan Raichu', 414464883, 63),
        new GymPokemon('Alakazam', 414464883, 63),
        new GymPokemon('Hypno', 414464883, 63),
        new GymPokemon('Silvally (Psychic)', 464464883, 63),
    ],
...
TemporaryBattleList['Molayne Steel Silvally'] = new TemporaryBattle(
    ...
    [
        new GymPokemon('Klefki', 464464883, 63),
        new GymPokemon('Bisharp', 464464883, 63),
        new GymPokemon('Magnezone', 464464883, 63),
        new GymPokemon('Metagross', 464464883, 63),
        new GymPokemon('Alolan Dugtrio', 464464883, 63),
        new GymPokemon('Silvally (Steel)', 514464883, 63),
    ],
...
TemporaryBattleList['Ryuki Dragon Silvally'] = new TemporaryBattle(
    ...
    [
        new GymPokemon('Garchomp', 514464883, 63),
        new GymPokemon('Drampa', 514464883, 63),
        new GymPokemon('Turtonator', 514464883, 63),
        new GymPokemon('Dragonite', 514464883, 63),
        new GymPokemon('Kommo-o', 514464883, 63),
        new GymPokemon('Silvally (Dragon)', 564464883, 63),
    ],
