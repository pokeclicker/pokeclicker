...
ItemList['Cracked_pot']       = new EvolutionStone(GameConstants.StoneType.Cracked_pot, 2500, undefined , 'Cracked Pot');
...
ItemList['Strawberry_sweet']  = new EvolutionStone(GameConstants.StoneType.Strawberry_sweet, 2500, undefined , 'Strawberry Sweet');
ItemList['Love_sweet']        = new EvolutionStone(GameConstants.StoneType.Love_sweet, 2500, undefined , 'Love Sweet');
ItemList['Berry_sweet']       = new EvolutionStone(GameConstants.StoneType.Berry_sweet, 2500, undefined , 'Berry Sweet');
ItemList['Clover_sweet']      = new EvolutionStone(GameConstants.StoneType.Clover_sweet, 2500, undefined , 'Clover Sweet');
