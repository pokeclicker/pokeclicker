...
ItemList['Weak_Mega_Stone']             = new EvolutionStone(GameConstants.StoneType.Weak_Mega_Stone, Infinity);
ItemList['Medium_Mega_Stone']           = new EvolutionStone(GameConstants.StoneType.Medium_Mega_Stone, Infinity);
ItemList['Strong_Mega_Stone']           = new EvolutionStone(GameConstants.StoneType.Strong_Mega_Stone, Infinity);
ItemList['Legendary_Mega_Stone']        = new EvolutionStone(GameConstants.StoneType.Legendary_Mega_Stone, Infinity);
ItemList['Strong_Legendary_Mega_Stone'] = new EvolutionStone(GameConstants.StoneType.Strong_Legendary_Mega_Stone, Infinity);
ItemList['Ultra_Legendary_Mega_Stone']  = new EvolutionStone(GameConstants.StoneType.Ultra_Legendary_Mega_Stone, Infinity);
