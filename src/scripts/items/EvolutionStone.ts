...
ItemList['Strawberry_sweet']  = new EvolutionStone(GameConstants.StoneType.Strawberry_sweet, 1000, undefined , 'Strawberry Sweet'); //Cheap because I am adding more forms of Alcremie in later with different sweet
ItemList['Unity_reins']  = new EvolutionStone(GameConstants.StoneType.Unity_reins, 7500, undefined , 'Reins of Unity');
