...
ItemList.Adamant_crystal   = new EvolutionStone(GameConstants.StoneType.Adamant_crystal, 2500, undefined, 'Adamant Crystal');
ItemList.Lustrous_globe    = new EvolutionStone(GameConstants.StoneType.Lustrous_globe, 2500, undefined, 'Lustrous Globe');
