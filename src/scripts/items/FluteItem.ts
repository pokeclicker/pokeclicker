...
ItemList['Moon_Flute']         = new FluteItem(GameConstants.FluteItemType.Moon_Flute, '+2% Bonus to Mining Energy Regeneration and Mining Energy Regeneration Time x Achievement Bonus', Infinity, undefined, ['Rock', 'Ground', 'Electric'], undefined, undefined, undefined);
ItemList['Time_Flute']         = new FluteItem(GameConstants.FluteItemType.Time_Flute, '+2% Bonus to Dungeon Timer x Achievement Bonus', Infinity, undefined, ['Grass', 'Psychic', 'Water'], undefined, undefined, undefined);
ItemList['Grass_Flute']         = new FluteItem(GameConstants.FluteItemType.Grass_Flute, '+2% Bonus to Berry Replant, Growth, and Mutation multipliers x Achievement Bonus', Infinity, undefined, ['Grass', 'Bug', 'Fairy'], undefined, undefined, undefined);
