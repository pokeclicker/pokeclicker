...
ItemList['Red_Flute']         = new BattleItem(GameConstants.BattleItemType.Red_Flute, '+50% Bonus to Pokémon attack', Infinity, undefined, undefined, 'pokemonAttack', 1.5);
ItemList['White_Flute']         = new BattleItem(GameConstants.BattleItemType.White_Flute, '+50% Bonus to Pokémon attack', Infinity, undefined, undefined, 'pokemonAttack', 1.5);
ItemList['Black_Flute']         = new BattleItem(GameConstants.BattleItemType.Black_Flute, '+50% Bonus to Pokémon attack', Infinity, undefined, undefined, 'pokemonAttack', 1.5);
ItemList['Yellow_Flute']         = new BattleItem(GameConstants.BattleItemType.Yellow_Flute, '+50% Bonus to Pokémon attack', Infinity, undefined, undefined, 'pokemonAttack', 1.5);
ItemList['Blue_Flute']         = new BattleItem(GameConstants.BattleItemType.Blue_Flute, '+50% Bonus to pokemonAttack', Infinity, undefined, undefined, 'pokemonAttack', 1.5);
ItemList['Poke_Flute']         = new BattleItem(GameConstants.BattleItemType.Poke_Flute, '+50% Bonus to Pokémon attack', Infinity, undefined, undefined, 'pokemonAttack', 1.5);
