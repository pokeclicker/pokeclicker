...
ItemList.Magikarp             = new PokemonItem('Magikarp', 50000, GameConstants.Currency.money, true);
ItemList['Magikarp Brown Stripes'] = new PokemonItem('Magikarp Brown Stripes', 100);
ItemList['Magikarp Blue Raindrops'] = new PokemonItem('Magikarp Blue Raindrops', 10000, GameConstants.Currency.diamond);
ItemList['Magikarp Saucy Violet'] = new PokemonItem('Magikarp Saucy Violet', 7500000000, GameConstants.Currency.money);
ItemList['Probably Feebas']   = new PokemonItem('Magikarp (Feebas)', 5999, GameConstants.Currency.battlePoint, false, 'Probably Feebas');
...
ItemList['Probably Chimecho']  = new PokemonItem('Hoppip (Chimecho)', 1187, GameConstants.Currency.diamond, false, 'Probably Chimecho');
...
ItemList['Furfrou (Debutante)']  = new PokemonItem('Furfrou (Debutante)', 5000000000, GameConstants.Currency.money);
ItemList['Furfrou (Diamond)']    = new PokemonItem('Furfrou (Diamond)', 15000, GameConstants.Currency.diamond);
ItemList['Furfrou (Matron)']     = new PokemonItem('Furfrou (Matron)', 1500000, GameConstants.Currency.farmPoint);
ItemList['Furfrou (Dandy)']      = new PokemonItem('Furfrou (Dandy)', 250000);
ItemList['Furfrou (Kabuki)']     = new PokemonItem('Furfrou (Kabuki)', 75000, GameConstants.Currency.battlePoint);
ItemList['Furfrou (Pharaoh)']    = new PokemonItem('Furfrou (Pharaoh)', 300000000, GameConstants.Currency.dungeonToken);
ItemList['Furfrou (Star)']    = new PokemonItem('Furfrou (Star)', 10000);
ItemList['Furfrou (La Reine)']    = new PokemonItem('Furfrou (La Reine)');
ItemList['Furfrou (Heart)']    = new PokemonItem('Furfrou (Heart)', 15000, GameConstants.Currency.contestToken);
...
// Contest
ItemList['Dugtrio (Punk)'] = new PokemonItem('Dugtrio (Punk)', 1500, GameConstants.Currency.contestToken);
ItemList['Gengar (Punk)'] = new PokemonItem('Gengar (Punk)', 3000, GameConstants.Currency.contestToken);
ItemList['Goldeen (Diva)'] = new PokemonItem('Goldeen (Diva)', 500, GameConstants.Currency.contestToken);
ItemList['Onix (Rocker)'] = new PokemonItem('Onix (Rocker)', 1000, GameConstants.Currency.contestToken);
ItemList['Tangela (Pom-pom)'] = new PokemonItem('Tangela (Pom-pom)', 400, GameConstants.Currency.contestToken);
ItemList['Weepinbell (Fancy)'] = new PokemonItem('Weepinbell (Fancy)', 700, GameConstants.Currency.contestToken);
ItemList['Sudowoodo (Golden)'] = new PokemonItem('Sudowoodo (Golden)', 2000, GameConstants.Currency.contestToken);
ItemList['Pikachu (Rock Star)'] = new PokemonItem('Pikachu (Rock Star)', 1000, GameConstants.Currency.contestToken);
ItemList['Pikachu (Belle)'] = new PokemonItem('Pikachu (Belle)', 1000, GameConstants.Currency.contestToken);
ItemList['Pikachu (Pop Star)'] = new PokemonItem('Pikachu (Pop Star)', 1000, GameConstants.Currency.contestToken);
ItemList['Pikachu (Ph. D.)'] = new PokemonItem('Pikachu (Ph. D.)', 1000, GameConstants.Currency.contestToken);
ItemList['Pikachu (Libre)'] = new PokemonItem('Pikachu (Libre)', 1000, GameConstants.Currency.contestToken);
// Event
ItemList['Elf Munchlax'] = new PokemonItem('Elf Munchlax', 3108, GameConstants.Currency.questPoint, undefined, undefined,
