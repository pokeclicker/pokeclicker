...
ItemList['Silvally (Fire)'] = new PokemonItem('Silvally (Fire)', 100000, Currency.battlePoint);
ItemList['Silvally (Electric)'] = new PokemonItem('Silvally (Electric)', 10000000000, Currency.money);
ItemList['Silvally (Ground)'] = new PokemonItem('Silvally (Ground)', 3000000, Currency.farmPoint);
