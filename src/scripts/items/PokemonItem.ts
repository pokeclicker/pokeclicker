...
ItemList['Silvally (Fighting) 1'] = new PokemonItem('Silvally (Fighting)', undefined, undefined, false, 'Silvally (Fighting)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 4), new ObtainedPokemonRequirement('Silvally (Fighting)', true)])}, 'Silvally (Fighting) 1');
...
ItemList['Silvally (Rock) 1'] = new PokemonItem('Silvally (Rock)', undefined, undefined, false, 'Silvally (Rock)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 4), new ObtainedPokemonRequirement('Silvally (Rock)', true)])}, 'Silvally (Rock) 1');
...
ItemList['Silvally (Dark) 1'] = new PokemonItem('Silvally (Dark)', undefined, undefined, false, 'Silvally (Dark)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 4), new ObtainedPokemonRequirement('Silvally (Dark)', true)])}, 'Silvally (Dark) 1');
...
ItemList['Silvally (Fairy) 1'] = new PokemonItem('Silvally (Fairy)', undefined, undefined, false, 'Silvally (Fairy)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 4), new ObtainedPokemonRequirement('Silvally (Fairy)', true)])}, 'Silvally (Fairy) 1');
...
ItemList['Silvally (Water) 1'] = new PokemonItem('Silvally (Water)', undefined, undefined, false, 'Silvally (Water)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18), new ObtainedPokemonRequirement('Silvally (Water)', true)])}, 'Silvally (Water) 1');
...
ItemList['Silvally (Grass) 1'] = new PokemonItem('Silvally (Grass)', undefined, undefined, false, 'Silvally (Grass)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18), new ObtainedPokemonRequirement('Silvally (Grass)', true)])}, 'Silvally (Grass) 1');
...
ItemList['Silvally (Fire) 1'] = new PokemonItem('Silvally (Fire)', undefined, undefined, false, 'Silvally (Fire)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18), new ObtainedPokemonRequirement('Silvally (Fire)', true)])}, 'Silvally (Fire) 1');
...
ItemList['Silvally (Electric) 1'] = new PokemonItem('Silvally (Electric)', undefined, undefined, false, 'Silvally (Electric)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18), new ObtainedPokemonRequirement('Silvally (Electric)', true)])}, 'Silvally (Electric) 1');
...
ItemList['Silvally (Ice) 1'] = new PokemonItem('Silvally (Ice)', undefined, undefined, false, 'Silvally (Ice)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18), new ObtainedPokemonRequirement('Silvally (Ice)', true)])}, 'Silvally (Ice) 1');
...
ItemList['Silvally (Ground) 1'] = new PokemonItem('Silvally (Ground)', undefined, undefined, false, 'Silvally (Ground)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18), new ObtainedPokemonRequirement('Silvally (Ground)', true)])}, 'Silvally (Ground) 1');
...
ItemList['Silvally (Bug) 1'] = new PokemonItem('Silvally (Bug)', undefined, undefined, false, 'Silvally (Bug)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Bug)', true)])}, 'Silvally (Bug) 1');
...
ItemList['Silvally (Flying) 1'] = new PokemonItem('Silvally (Flying)', undefined, undefined, false, 'Silvally (Bug)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Flying)', true)])}, 'Silvally (Flying) 1');
...
ItemList['Silvally (Poison) 1'] = new PokemonItem('Silvally (Poison)', undefined, undefined, false, 'Silvally (Poison)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Poison)', true)])}, 'Silvally (Poison) 1');
...
ItemList['Silvally (Ghost) 1'] = new PokemonItem('Silvally (Ghost)', undefined, undefined, false, 'Silvally (Ghost)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Ghost)', true)])}, 'Silvally (Ghost) 1');
...
ItemList['Silvally (Psychic) 1'] = new PokemonItem('Silvally (Psychic)', undefined, undefined, false, 'Silvally (Psychic)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Psychic)', true)])}, 'Silvally (Psychic) 1');
...
ItemList['Silvally (Steel) 1'] = new PokemonItem('Silvally (Steel)', undefined, undefined, false, 'Silvally (Steel)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Steel)', true)])}, 'Silvally (Steel) 1');
...
ItemList['Silvally (Dragon) 1'] = new PokemonItem('Silvally (Dragon)', undefined, undefined, false, 'Silvally (Dragon)',
    { visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 34), new ObtainedPokemonRequirement('Silvally (Dragon)', true)])}, 'Silvally (Dragon) 1');
