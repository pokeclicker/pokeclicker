...
ItemList['Furfrou (Dandy)']      = new PokemonItem('Furfrou (Dandy)', 500000);
...
ItemList['Type: Null']           = new PokemonItem('Type: Null', 10000);
ItemList['Poipole']              = new PokemonItem('Poipole', 25000);
