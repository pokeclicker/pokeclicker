...
ItemList.Carbos   = new Vitamin(GameConstants.VitaminType.Carbos, 1e4, GameConstants.Currency.money, { multiplier: 1.1, multiplierDecrease: false, saveName: `${GameConstants.VitaminType[GameConstants.VitaminType.Carbos]}|${GameConstants.Currency[GameConstants.Currency.money]}` }, undefined, '1% less steps required when hatching');
