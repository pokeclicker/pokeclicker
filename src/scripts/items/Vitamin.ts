...
ItemList.Calcium   = new Vitamin(GameConstants.VitaminType.Calcium, 1e6, GameConstants.Currency.money, { maxPriceMultiplier: 50, multiplier: 1.01, multiplierDecrease: false, saveName: `${GameConstants.VitaminType[GameConstants.VitaminType.Calcium]}|${GameConstants.Currency[GameConstants.Currency.money]}` }, undefined, 'Increases Pokémon EVs');
