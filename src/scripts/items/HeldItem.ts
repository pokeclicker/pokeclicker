...
ItemList.Power_Herb = new AttackBonusHeldItem('Power_Herb', 2500, GameConstants.Currency.battlePoint, undefined, 'Power Herb', 1.5, GameConstants.Region.hoenn, undefined, (pokemon) => true,
