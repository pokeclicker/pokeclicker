...
ItemList['Leek'] = new AttackBonusHeldItem('Leek', 10000, GameConstants.Currency.money, undefined, 'Leek', 1.2, GameConstants.Region.final /* GameConstants.Region.johto */, 'Farfetch\'d or Sirfetch\'d',
...
ItemList['Soft_Sand'] = new TypeRestrictedAttackBonusHeldItem('Soft_Sand', 10000, GameConstants.Currency.money, undefined, 'Soft Sand', 1.1, PokemonType.Ground, GameConstants.Region.final /* GameConstants.Region.johto */);
ItemList['Spell_Tag'] = new TypeRestrictedAttackBonusHeldItem('Spell_Tag', 10000, GameConstants.Currency.money, undefined, 'Spell Tag', 1.1, PokemonType.Ghost, GameConstants.Region.final /* GameConstants.Region.johto */);
ItemList['Twisted_Spoon'] = new TypeRestrictedAttackBonusHeldItem('Twisted_Spoon', 10000, GameConstants.Currency.money, undefined, 'Twisted Spoon', 1.1, PokemonType.Psychic, GameConstants.Region.final /* GameConstants.Region.johto */);
