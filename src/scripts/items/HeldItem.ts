...
ItemList.Quick_Powder = new AttackBonusHeldItem('Quick_Powder', 10000, GameConstants.Currency.money, undefined, 'Quick Powder', 1.3, GameConstants.Region.alola, 'Ditto',
...
ItemList.Booster_Energy = new AttackBonusHeldItem('Booster_Energy', 10000, GameConstants.Currency.money, undefined, 'Booster Energy', 1.3, GameConstants.Region.paldea, /*14 Pokémon. Probably too many to list.*/'Paradox Pokémon',
    (pokemon) => Math.floor(pokemon.id) == 984 ||  Math.floor(pokemon.id) == 985 ||  Math.floor(pokemon.id) == 986 ||  Math.floor(pokemon.id) == 987 ||  Math.floor(pokemon.id) == 988 ||  Math.floor(pokemon.id) == 989 ||  Math.floor(pokemon.id) == 990 ||  Math.floor(pokemon.id) == 991 ||  Math.floor(pokemon.id) == 992 ||  Math.floor(pokemon.id) == 993 ||  Math.floor(pokemon.id) == 994 ||  Math.floor(pokemon.id) == 995 ||  Math.floor(pokemon.id) == 1005 ||  Math.floor(pokemon.id) == 1006);
