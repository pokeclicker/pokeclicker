    ...
    initialize() {
        this.itemList = [
            ...
            new BoughtOakItem(OakItems.OakItem.Squirtbottle, 'Squirtbottle', 'Increases the chance of berry mutations', 'Johto Berry Master',
                true, [1.15, 1.3, 1.45, 1.6, 1.75], 1, 5, undefined, undefined, AmountFactory.createArray([500, 1000, 2000, 3000, 5000], GameConstants.Currency.farmPoint)),
            new BoughtOakItem(OakItems.OakItem.Sprinklotad, 'Sprinklotad', 'Increases the chance of berry replants', 'Hoenn Berry Master',
                true, [1.5, 1.75, 2, 2.25, 2.5], 1, 7, undefined, undefined, AmountFactory.createArray([500, 1000, 2000, 3000, 5000], GameConstants.Currency.farmPoint)),
        ];
    }
