...
GymList['Temple of Sinnoh'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Giratina (Altered)', 348526193, 70, new QuestLineCompletedRequirement('Volo\'s Dream')),
        new GymPokemon('Giratina (Origin)', 348526193, 70, new QuestLineCompletedRequirement('Volo\'s Dream')),
    ],
