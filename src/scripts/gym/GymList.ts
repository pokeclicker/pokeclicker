...
GymList['Iki Town'] = new Gym(
    ...
    'Iki Town',
    [
        new GymPokemon('Machop', 52749928, 15),
        new GymPokemon('Makuhita', 52749928, 15),
        new GymPokemon('Crabrawler', 53609170, 16),
    ],
...
GymList['Konikoni City'] = new Gym(
    ...
    'Konikoni City',
    [
        new GymPokemon('Anorith', 69300707, 27),
        new GymPokemon('Lileep', 69300707, 27),
        new GymPokemon('Lycanroc (Midnight)', 70695078, 28),
    ],
...
GymList['Malie City'] = new Gym(
    ...
    'Malie City',
    [
        new GymPokemon('Sableye', 86453751, 43),
        new GymPokemon('Krokorok', 86453751, 43),
        new GymPokemon('Alolan Persian', 87780987, 44),
    ],
...
GymList['Exeggutor Island'] = new Gym(
    ...
    'Exeggutor Island',
    [
        new GymPokemon('Alolan Dugtrio', 72895514, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Gastrodon (East)', 72895514, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Flygon', 72895514, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Mudsdale', 73931162, 48, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Golurk', 77548419, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
        new GymPokemon('Gastrodon (East)', 77548419, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
        new GymPokemon('Flygon', 77548419, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
        new GymPokemon('Mudsdale', 78650172, 54, new QuestLineStepCompletedRequirement('Emissary of Light', 4)),
    ],
...
// regular mons base HP: 78097988
// ace pokemon base HP: 78927916
GymList['Elite Molayne'] = new Gym(
    'Molayne',
    'Elite Molayne',
    [
        new GymPokemon('Klefki', 67050589, 56),
        new GymPokemon('Bisharp', 71714399, 56),
        new GymPokemon('Magnezone', 70534813, 56),
        new GymPokemon('Metagross', 72023700, 56),
        new GymPokemon('Alolan Dugtrio', 81407944, 57),
    ],
...
GymList['Elite Olivia'] = new Gym(
    ...
    'Elite Olivia',
    [
        new GymPokemon('Armaldo', 68871522, 56),
        new GymPokemon('Cradily', 63224547, 56),
        new GymPokemon('Gigalith', 119601953, 56),
        new GymPokemon('Probopass', 72398059, 56),
        new GymPokemon('Lycanroc (Midnight)', 127873466, 57),
    ],
...
GymList['Elite Acerola'] = new Gym(
    ...
    'Elite Acerola',
    [
        new GymPokemon('Banette', 80401013, 56),
        new GymPokemon('Drifblim', 74102310, 56),
        new GymPokemon('Dhelmise', 77502310, 56),
        new GymPokemon('Froslass', 77938189, 56),
        new GymPokemon('Palossand', 87786141, 57),
    ],
...
GymList['Elite Kahili'] = new Gym(
    ...
    'Elite Kahili',
    [
        new GymPokemon('Braviary', 73457498, 56),
        new GymPokemon('Hawlucha', 93029257, 56),
        new GymPokemon('Oricorio (Baile)', 87658652, 56),
        new GymPokemon('Mandibuzz', 75755048, 56),
        new GymPokemon('Toucannon', 77683276, 57),
    ],
...
GymList['Champion Hau'] = new Gym(
    ...
    'Champion Hau',
    [
        new GymPokemon('Alolan Raichu', 77813721, 59),
        new GymPokemon('Tauros', 76191000, 58),
        new GymPokemon('Noivern', 76191000, 58),
        new GymPokemon('Crabominable', 77813721, 59),
        new GymPokemon('Flareon', 76191000, 58, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Grass)),
        new GymPokemon('Primarina', 82216555, 60, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Grass)),
        new GymPokemon('Vaporeon', 76191000, 58, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Fire)),
        new GymPokemon('Decidueye', 82216555, 60, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Fire)),
        new GymPokemon('Leafeon', 76191000, 58, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Water)),
        new GymPokemon('Incineroar', 82216555, 60, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Water)),
    ],
...
GymList.Turffield = new Gym(
    ...
    'Turffield',
    [
        new GymPokemon('Gossifleur', 94258910, 19),
        new GymPokemon('Eldegoss', 104732124, 20),
    ],
...
GymList.Hulbury = new Gym(
    ...
    'Hulbury',
    [
        new GymPokemon('Goldeen', 101187581, 22),
        new GymPokemon('Arrokuda', 101187581, 23),
        new GymPokemon('Gigantamax Drednaw', 104253871, 24),
    ],
...
GymList.Motostoke = new Gym(
    ...
    'Motostoke',
    [
        new GymPokemon('Ninetales', 106260914, 25),
        new GymPokemon('Arcanine', 106260914, 25),
        new GymPokemon('Gigantamax Centiskorch', 112902222, 27),
    ],
...
GymList['Stow-on-Side1'] = new Gym(
    ...
    'Stow-on-Side1',
    [
        new GymPokemon('Hitmontop', 111649541, 34),
        new GymPokemon('Pangoro', 111649541, 34),
        new GymPokemon('Sirfetch\'d', 111649541, 35),
        new GymPokemon('Gigantamax Machamp', 120763802, 36),
    ],
...
GymList['Stow-on-Side2'] = new Gym(
    ...
    'Stow-on-Side2',
    [
        new GymPokemon('Galarian Yamask', 111649541, 34),
        new GymPokemon('Mimikyu', 111649541, 34),
        new GymPokemon('Cursola', 111649541, 35),
        new GymPokemon('Gigantamax Gengar', 120763802, 36),
    ],
...
GymList.Ballonlea = new Gym(
    ...
    'Ballonlea',
    [
        new GymPokemon('Galarian Weezing', 115599999, 36),
        new GymPokemon('Mawile', 115599999, 36),
        new GymPokemon('Togekiss', 115599999, 37),
        new GymPokemon('Gigantamax Alcremie', 125033229, 38),
    ],
...
GymList.Circhester1 = new Gym(
    ...
    'Circhester1',
    [
        new GymPokemon('Barbaracle', 119209158, 40),
        new GymPokemon('Shuckle', 119209158, 40),
        new GymPokemon('Stonjourner', 119209158, 41),
        new GymPokemon('Gigantamax Coalossal', 128940517, 42),
    ],
...
GymList.Circhester2 = new Gym(
    ...
    'Circhester2',
    [
        new GymPokemon('Frosmoth', 119209158, 40),
        new GymPokemon('Galarian Darmanitan', 119209158, 40),
        new GymPokemon('Eiscue (Ice Face)', 119209158, 41, new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Hail, WeatherType.Blizzard, WeatherType.Sandstorm, WeatherType.Fog, WeatherType.Windy])),
        new GymPokemon('Eiscue (Noice Face)', 119209158, 41, new WeatherRequirement([WeatherType.Harsh_Sunlight])),
        new GymPokemon('Gigantamax Lapras', 128940517, 42),
    ],
...
GymList.Spikemuth = new Gym(
    ...
    'Spikemuth',
    [
        new GymPokemon('Scrafty', 123719773, 44),
        new GymPokemon('Malamar', 123719773, 45),
        new GymPokemon('Skuntank', 123719773, 45),
        new GymPokemon('Obstagoon', 133819348, 46),
    ],
...
GymList.Hammerlocke = new Gym(
    ...
    'Hammerlocke',
    [
        new GymPokemon('Gigalith', 128585121, 46),
        new GymPokemon('Flygon', 128585121, 47),
        new GymPokemon('Sandaconda', 128585121, 46),
        new GymPokemon('Gigantamax Duraludon', 139081907, 48),
    ],
...
GymList['Elite Trainer Marnie'] = new Gym(
    ...
    [
        new GymPokemon('Liepard', 136039987, 47),
        new GymPokemon('Toxicroak', 136039987, 47),
        new GymPokemon('Scrafty', 136039987, 47),
        new GymPokemon('Morpeko', 140656943, 48),
        new GymPokemon('Gigantamax Grimmsnarl', 145833181, 49),
    ],
...
GymList['Elite Gym Leader Bede'] = new Gym(
    ...
    [
        new GymPokemon('Mawile', 136039987, 51),
        new GymPokemon('Sylveon', 136039987, 51),
        new GymPokemon('Gardevoir', 136039987, 51),
        new GymPokemon('Galarian Rapidash', 140656943, 52),
        new GymPokemon('Gigantamax Hatterene', 145833181, 53),
    ],
...
GymList['Elite Trainer Hop'] = new Gym(
    ...
    'Elite Trainer Hop',
    [
        new GymPokemon('Dubwool', 147480353, 59),
        new GymPokemon('Pincurchin', 143494813, 58),
        new GymPokemon('Snorlax', 143494813, 58),
        new GymPokemon('Corviknight', 152584457, 60),
        new GymPokemon('Gigantamax Inteleon', 160934767, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Gigantamax Rillaboom', 160934767, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Gigantamax Cinderace', 160934767, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
    ],
...
GymList['Champion Leon'] = new Gym(
    ...
    'Champion Leon',
    [
        new GymPokemon('Aegislash (Shield)', 150949640, 62),
        new GymPokemon('Dragapult', 150949640, 62),
        new GymPokemon('Haxorus', 150949640, 63),
        new GymPokemon('Seismitoad', 154304076, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Cinderace', 159335730, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Mr. Rime', 154304076, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Inteleon', 159335730, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Rhyperior', 154304076, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
        new GymPokemon('Rillaboom', 159335730, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
        new GymPokemon('Gigantamax Charizard', 167721957, 65),
    ],
...
GymList['Elite Gym Leader Klara'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Slowking', 238957862, 68),
        new GymPokemon('Galarian Weezing', 238957862, 68),
        new GymPokemon('Drapion', 238957862, 68),
        new GymPokemon('Scolipede', 243988388, 69),
        new GymPokemon('Galarian Slowbro', 251534591, 70),
    ],
...
GymList['Elite Gym Leader Avery'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Slowbro', 238957862, 68),
        new GymPokemon('Swoobat', 238957862, 68),
        new GymPokemon('Galarian Rapidash', 238957862, 68),
        new GymPokemon('Alakazam', 243988388, 69),
        new GymPokemon('Galarian Slowking', 251534591, 70),
    ],
...
GymList['Elite Dojo Matron Honey'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Darmanitan', 202356378, 73),
        new GymPokemon('Gallade', 202356378, 74),
        new GymPokemon('Salazzle', 206616513, 73),
        new GymPokemon('Togekiss', 206616513, 75),
        new GymPokemon('Gigantamax Venusaur', 213006714, 75),
        new GymPokemon('Gigantamax Blastoise', 213006714, 75),
    ],
...
GymList['Elite Dojo Master Mustard'] = new Gym(
    ...
    [
        new GymPokemon('Mienshao', 207136450, 73),
        new GymPokemon('Luxray', 207136450, 73),
        new GymPokemon('Lycanroc (Midday)', 211497255, 75),
        new GymPokemon('Kommo-o', 211497255, 75),
        new GymPokemon('Gigantamax Urshifu (Single Strike)', 218038369, 75),
        new GymPokemon('Gigantamax Urshifu (Rapid Strike)', 218038369, 75),
    ],
...
GymList['Elite Trainer Peony'] = new Gym(
    ...
    'Elite Trainer Peony',
    [
        new GymPokemon('Perrserker', 259579342, 74),
        new GymPokemon('Bronzong', 254227191, 73),
        new GymPokemon('Scizor', 254227191, 73),
        new GymPokemon('Aggron', 259579342, 74),
        new GymPokemon('Copperajah', 267607570, 74),
    ],
