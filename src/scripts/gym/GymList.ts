...
GymList['Elite Malva'] = new Gym(
    ...
    'Elite Malva',
    [
        new GymPokemon('Pyroar', 12783920, 63),
        new GymPokemon('Torkoal', 12783920, 63),
        new GymPokemon('Chandelure', 12783920, 63),
        new GymPokemon('Talonflame', 15283920, 65),
    ],
...
GymList['Elite Siebold'] = new Gym(
    ...
    'Elite Siebold',
    [
        new GymPokemon('Clawitzer', 18538204, 63),
        new GymPokemon('Gyarados', 18538204, 63),
        new GymPokemon('Starmie', 18538204, 63),
        new GymPokemon('Barbaracle', 22538204, 65),
    ],
...
GymList['Elite Wikstrom'] = new Gym(
    ...
    'Elite Wikstrom',
    [
        new GymPokemon('Klefki', 24667488, 63),
        new GymPokemon('Probopass', 24667488, 63),
        new GymPokemon('Scizor', 24667488, 63),
        new GymPokemon('Aegislash', 28667488, 65),
    ],
...
GymList['Elite Drasna'] = new Gym(
    ...
    'Elite Drasna',
    [
        new GymPokemon('Dragalge', 30796772, 63),
        new GymPokemon('Druddigon', 30796772, 63),
        new GymPokemon('Altaria', 30796772, 63),
        new GymPokemon('Noivern', 34796772, 65),
    ],
...
GymList['Champion Diantha'] = new Champion(
    ...
    'Champion Diantha',
    [
        new GymPokemon('Hawlucha', 20697848, 64),
        new GymPokemon('Tyrantrum', 20697848, 65),
        new GymPokemon('Aurorus', 20697848, 65),
        new GymPokemon('Gourgeist', 20697848, 65),
        new GymPokemon('Goodra', 20697848, 66),
        new GymPokemon('Mega Gardevoir', 24197850, 68),
    ],
