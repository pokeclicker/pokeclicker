...
GymList['Azalea Town'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Kakuna', 126875, 14),
...
GymList['Mahogany Town'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Dewgong', 240625, 29),
...
GymList['Elite Will'] = new Gym(
    ...
    'Elite Will',
    [
        new GymPokemon('Xatu', 306662, 40),
        new GymPokemon('Exeggutor', 310375, 41),
        new GymPokemon('Slowbro', 315000, 41),
        new GymPokemon('Jynx', 321250, 41),
        new GymPokemon('Xatu', 325312, 42),
    ],
...
GymList['Elite Koga'] = new Gym(
    ...
    'Elite Koga',
    [
        new GymPokemon('Ariados', 306662, 40),
        new GymPokemon('Venomoth', 310375, 41),
        new GymPokemon('Forretress', 315000, 43),
        new GymPokemon('Muk', 321250, 42),
        new GymPokemon('Crobat', 325312, 44),
    ],
...
GymList['Elite Bruno2'] = new Gym(
    ...
    'Elite Bruno2',
    [
        new GymPokemon('Hitmontop', 306662, 42),
        new GymPokemon('Hitmonlee', 310375, 42),
        new GymPokemon('Hitmonchan', 315000, 42),
        new GymPokemon('Onix', 321250, 43),
        new GymPokemon('Machamp', 325312, 46),
    ],
...
GymList['Champion Lance'] = new Gym(
    ...
    'Champion Lance',
    [
        new GymPokemon('Gyarados', 322875, 44),
        new GymPokemon('Dragonite', 327500, 47),
        new GymPokemon('Charizard', 330000, 46),
        new GymPokemon('Aerodactyl', 325312, 46),
...
GymList['Rustboro City'] = new Gym(
    ...
    'Rustboro City',
    [
        new GymPokemon('Geodude', 421190, 12),
        new GymPokemon('Geodude', 421190, 12),
        new GymPokemon('Nosepass', 451220, 15),
    ],
    BadgeEnums.Stone,
    1000,
...
GymList['Dewford Town'] = new Gym(
    ...
    'Dewford Town',
    [
        new GymPokemon('Machop', 466400, 16),
        new GymPokemon('Meditite', 466400, 16),
        new GymPokemon('Makuhita', 488400, 19),
    ],
    BadgeEnums.Knuckle,
    2000,
...
GymList['Mauville City'] = new Gym(
    ...
    'Mauville City',
    [
        new GymPokemon('Voltorb', 497200, 20),
        new GymPokemon('Electrike', 492800, 20),
        new GymPokemon('Magneton', 531300, 22),
        new GymPokemon('Manectric', 492800, 24),
    ],
    BadgeEnums.Dynamo,
    3000,
...
GymList['Lavaridge Town'] = new Gym(
    ...
    'Lavaridge Town',
    [
        new GymPokemon('Numel', 519200, 24),
        new GymPokemon('Slugma', 519200, 24),
        new GymPokemon('Camerupt', 541200, 26),
        new GymPokemon('Torkoal', 576400, 29),
    ],
    BadgeEnums.Heat,
    4000,
...
GymList['Petalburg City'] = new Gym(
    ...
    'Petalburg City',
    [
        new GymPokemon('Spinda', 539000, 27),
        new GymPokemon('Vigoroth', 583000, 27),
        new GymPokemon('Linoone', 616000, 29),
        new GymPokemon('Slaking', 655600, 31),
    ],
    BadgeEnums.Balance,
    5000,
...
GymList['Fortree City'] = new Gym(
    ...
    'Fortree City',
    [
        new GymPokemon('Swablu', 665500, 29),
        new GymPokemon('Tropius', 715000, 29),
        new GymPokemon('Pelipper', 693000, 30),
        new GymPokemon('Skarmory', 733700, 31),
        new GymPokemon('Altaria', 735900, 33),
    ],
    BadgeEnums.Feather,
    6000,
...
GymList['Mossdeep City'] = new Gym(
    ...
    'Mossdeep City',
    [
        new GymPokemon('Claydol', 772200, 41),
        new GymPokemon('Xatu', 773300, 41),
        new GymPokemon('Lunatone', 772200, 42),
        new GymPokemon('Solrock', 773300, 42),
    ],
    BadgeEnums.Mind,
    8000,
...
GymList['Sootopolis City'] = new Gym(
    ...
    'Sootopolis City',
    [
        new GymPokemon('Luvdisc', 877800, 41),
        new GymPokemon('Whiscash', 894300, 41),
        new GymPokemon('Sealeo', 905740, 43),
        new GymPokemon('Crawdaunt', 926200, 43),
        new GymPokemon('Kingdra', 951500, 46),
    ],
    BadgeEnums.Rain,
    10000,
...
GymList['Elite Sidney'] = new Gym(
    ...
    'Elite Sidney',
    [
        new GymPokemon('Mightyena', 1069200, 46),
        new GymPokemon('Shiftry', 1078000, 48),
        new GymPokemon('Cacturne', 1102200, 46),
        new GymPokemon('Crawdaunt', 1116500, 48),
        new GymPokemon('Absol', 1122000, 49),
    ],
...
GymList['Elite Phoebe'] = new Gym(
    ...
    'Elite Phoebe',
    [
        new GymPokemon('Dusclops', 1140370, 48),
        new GymPokemon('Banette', 1141800, 49),
        new GymPokemon('Sableye', 1157200, 50),
        new GymPokemon('Banette', 1141800, 49),
        new GymPokemon('Dusclops', 1169300, 51),
    ],
...
GymList['Elite Glacia'] = new Gym(
    ...
    'Elite Glacia',
    [
        new GymPokemon('Sealeo', 1190200, 50),
        new GymPokemon('Glalie', 1179200, 50),
        new GymPokemon('Sealeo', 1194600, 52),
        new GymPokemon('Glalie', 1183600, 52),
        new GymPokemon('Walrein', 1210000, 53),
    ],
...
GymList['Elite Drake'] = new Gym(
    ...
    'Elite Drake',
    [
        new GymPokemon('Shelgon', 1170400, 52),
        new GymPokemon('Altaria', 1179200, 54),
        new GymPokemon('Kingdra', 1183600, 53),
        new GymPokemon('Flygon', 1183600, 53),
        new GymPokemon('Salamence', 1272700, 55),
    ],
...
GymList['Champion Wallace'] = new Gym(
    ...
    'Champion Wallace',
    [
        new GymPokemon('Wailord', 1322200, 57),
        new GymPokemon('Tentacruel', 1280400, 55),
        new GymPokemon('Ludicolo', 1302400, 56),
        new GymPokemon('Whiscash', 1289200, 56),
        new GymPokemon('Gyarados', 1279300, 56),
        new GymPokemon('Milotic', 1300200, 58),
    ],
...
GymList['Mikan Island'] = new Gym(
    ...
    'Mikan Island',
    [
        new GymPokemon('Seadra', 2538250, 24),
        new GymPokemon('Blastoise', 2538250, 24),
    ],
...
GymList['Navel Island'] = new Gym(
    ...
    'Navel Island',
    [
        new GymPokemon('Geodude', 1015300, 24),
        new GymPokemon('Nidoqueen', 1015300, 24),
        new GymPokemon('Machoke', 1015300, 24),
        new GymPokemon('Scyther', 1015300, 24),
        new GymPokemon('Electrode', 1015300, 24),
    ],
    BadgeEnums.Sea_Ruby,
    10000,
...
GymList['Trovita Island'] = new Gym(
    ...
    'Trovita Island',
    [
        new GymPokemon('Electabuzz', 1692166, 24),
        new GymPokemon('Exeggutor', 1692166, 24),
        new GymPokemon('Starmie', 1692166, 24),
    ],
...
GymList['Kumquat Island'] = new Gym(
    ...
    'Kumquat Island',
    [
        new GymPokemon('Alakazam', 2538250, 24),
        new GymPokemon('Marowak', 2538250, 24),
    ],
...
GymList['Supreme Gym Leader Drake'] = new Gym(
    ...
    'Supreme Gym Leader Drake',
    [
        new GymPokemon('Ditto', 989472, 38),
        new GymPokemon('Onix', 989472, 39),
        new GymPokemon('Gengar', 989472, 40),
        new GymPokemon('Venusaur', 989472, 40),
        new GymPokemon('Electabuzz', 989472, 41),
        new GymPokemon('Dragonite', 1236840, 37),
    ],
...
GymList['Cipher Admin Ein'] = new Gym (
    ...
    'Cipher Admin Ein',
    [
        new GymPokemon('Crobat', 13309472, 48),
        new GymPokemon('Pelipper', 13309472, 49),
        new GymPokemon('Rhydon', 13309472, 50),
        new GymPokemon('Starmie', 13309472, 49),
        new GymPokemon('Manectric', 13309472, 50),
    ],
...
GymList['Cipher Admin Miror B.'] = new Gym (
    ...
    'Cipher Admin Miror B.',
    [
        new GymPokemon('Ludicolo', 12759472, 44),
        new GymPokemon('Ludicolo', 12759472, 45),
        new GymPokemon('Loudred', 12759472, 46),
        new GymPokemon('Golduck', 12759472, 45),
        new GymPokemon('Armaldo', 12759472, 43),
    ],
...
GymList['Cipher Admin Dakim'] = new Gym (
    ...
    'Cipher Admin Dakim',
    [
        new GymPokemon('Claydol', 13199472, 46),
        new GymPokemon('Forretress', 13199472, 45),
        new GymPokemon('Flygon', 13199472, 46),
        new GymPokemon('Whiscash', 13199472, 46),
        new GymPokemon('Houndoom', 13199472, 47),
    ],
...
GymList['Cipher Admin Venus'] = new Gym (
    ...
    'Cipher Admin Venus',
    [
        new GymPokemon('Bellossom', 13529472, 47),
        new GymPokemon('Misdreavus', 13529472, 47),
        new GymPokemon('Raichu', 13529472, 48),
        new GymPokemon('Wigglytuff', 13529472, 48),
        new GymPokemon('Milotic', 13529472, 48),
    ],
