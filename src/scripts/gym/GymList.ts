...
GymList['Exeggutor Island'] = new Gym(
    ...
    'Exeggutor Island',
    [
        new GymPokemon('Alolan Dugtrio', 76658268, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Gastrodon (East)', 76658268, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Flygon', 76658268, 47, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Mudsdale', 77747374, 48, new QuestLineStepCompletedRequirement('Emissary of Light', 4, GameConstants.AchievementOption.less)),
        new GymPokemon('Golurk', 76658268, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 3)),
        new GymPokemon('Gastrodon (East)', 76658268, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 3)),
        new GymPokemon('Flygon', 76658268, 53, new QuestLineStepCompletedRequirement('Emissary of Light', 3)),
        new GymPokemon('Mudsdale', 77747374, 54, new QuestLineStepCompletedRequirement('Emissary of Light', 3)),
    ],
