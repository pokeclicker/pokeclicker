...
GymList['Celadon City'] = new Gym(
    ...
    'Celadon City',
    [
        new GymPokemon('Victreebel', 36400, 29),
        new GymPokemon('Tangela', 30340, 24),
        new GymPokemon('Vileplume', 38810, 29),
    ],
    BadgeEnums.Rainbow,
    1500,
...
GymList['Champion Wallace'] = new Gym(
    ...
    'Champion Wallace',
    [
        new GymPokemon('Wailord', 1182000, 57),
        ...
        new GymPokemon('Milotic', 1202000, 58),
    ],
...
GymList['Snowpoint City'] = new Gym(
    ...
    'Snowpoint City',
    [
        new GymPokemon('Sneasel', 1870000, 40),
        new GymPokemon('Piloswine', 1870000, 40),
        new GymPokemon('Abomasnow', 1872500, 42),
        new GymPokemon('Froslass', 1876000, 44),
    ],
    BadgeEnums.Icicle,
    8000,
