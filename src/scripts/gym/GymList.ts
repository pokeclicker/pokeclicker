...
GymList['Celadon City'] = new Gym(
    ...
    'Celadon City',
    [
        new GymPokemon('Tangela', 28330, 30),
        new GymPokemon('Weepinbell', 22140, 32),
        new GymPokemon('Gloom', 26570, 32),
    ],
    BadgeEnums.Rainbow,
    1500,
...
GymList['Saffron City'] = new Gym(
    ...
    'Saffron City',
    [
        new GymPokemon('Abra', 31570, 50),
        new GymPokemon('Kadabra', 35070, 50),
        new GymPokemon('Alakazam', 38910, 50),
    ],
    BadgeEnums.Marsh,
    2500,
