...
GymList['Violet City'] = new Gym(
    ...
    'Violet City',
    [
        new GymPokemon('Pidgey', 183600, 7),
        new GymPokemon('Pidgeotto', 190400, 9),
    ],
    BadgeEnums.Zephyr,
    500,
...
GymList['Azalea Town'] = new Gym(
    ...
    'Azalea Town',
    [
        new GymPokemon('Metapod', 175100, 14),
        new GymPokemon('Kakuna', 172550, 14),
        new GymPokemon('Scyther', 202300, 16),
    ],
    BadgeEnums.Hive,
    1000,
...
GymList['Goldenrod City'] = new Gym(
    ...
    'Goldenrod City',
    [
        new GymPokemon('Clefairy', 221000, 18),
        new GymPokemon('Miltank', 289000, 20),
    ],
    BadgeEnums.Plain,
    1500,
...
GymList['Ecruteak City'] = new Gym(
    ...
    'Ecruteak City',
    [
        new GymPokemon('Gastly', 215900, 21),
        new GymPokemon('Haunter', 217600, 21),
        new GymPokemon('Gengar', 224400, 25),
        new GymPokemon('Haunter', 221000, 23),
    ],
    BadgeEnums.Fog,
    2500,
...
GymList['Cianwood City'] = new Gym(
    ...
    'Cianwood City',
    [
        new GymPokemon('Primeape', 300900, 27),
        new GymPokemon('Poliwrath', 311100, 30),
    ],
    BadgeEnums.Storm,
    3500,
...
GymList['Olivine City'] = new Gym(
    ...
    'Olivine City',
    [
        new GymPokemon('Magnemite', 300900, 30),
        new GymPokemon('Magnemite', 302600, 30),
        new GymPokemon('Steelix', 309400, 35),
    ],
    BadgeEnums.Mineral,
    4000,
...
GymList['Mahogany Town'] = new Gym(
    ...
    'Mahogany Town',
    [
        new GymPokemon('Seel', 323000, 27),
        new GymPokemon('Dewgong', 327250, 29),
        new GymPokemon('Piloswine', 333200, 31),
    ],
    BadgeEnums.Glacier,
    5000,
...
GymList['Blackthorn City'] = new Gym(
    ...
    'Blackthorn City',
    [
        new GymPokemon('Dragonair', 348500, 37),
        new GymPokemon('Dragonair', 348500, 37),
        new GymPokemon('Dragonair', 370600, 37),
        new GymPokemon('Kingdra', 374000, 40),
    ],
    BadgeEnums.Rising,
    7500,
...
GymList['Elite Will'] = new Gym(
    ...
    'Elite Will',
    [
        new GymPokemon('Xatu', 417061, 40),
        new GymPokemon('Exeggutor', 422110, 41),
        new GymPokemon('Slowbro', 428400, 41),
        new GymPokemon('Jynx', 436900, 41),
        new GymPokemon('Xatu', 442425, 42),
    ],
    ...
    undefined,
    undefined,
    { battleBackground: 'Space' }
);
GymList['Elite Koga'] = new Gym(
    'Koga2',
    'Elite Koga',
    [
        new GymPokemon('Ariados', 417061, 40),
        new GymPokemon('Venomoth', 422110, 41),
        new GymPokemon('Forretress', 428400, 43),
        new GymPokemon('Muk', 436900, 42),
        new GymPokemon('Crobat', 442425, 44),
    ],
    ...
    undefined,
    undefined,
    { displayName: 'Elite Koga', battleBackground: 'forest' }
);
GymList['Elite Bruno2'] = new Gym(
    'Bruno2',
    'Elite Bruno2',
    [
        new GymPokemon('Hitmontop', 417061, 42),
        new GymPokemon('Hitmonlee', 422110, 42),
        new GymPokemon('Hitmonchan', 428400, 42),
        new GymPokemon('Onix', 436900, 43),
        new GymPokemon('Machamp', 442425, 46),
    ],
    ...
    undefined,
    undefined,
    { displayName: 'Elite Bruno', battleBackground: 'Cave' }
);
GymList['Elite Karen'] = new Gym(
    'Karen',
    'Elite Karen',
    [
        new GymPokemon('Umbreon', 422110, 42),
        new GymPokemon('Vileplume', 428400, 42),
        new GymPokemon('Murkrow', 436900, 44),
        new GymPokemon('Gengar', 442425, 45),
        new GymPokemon('Houndoom', 452200, 47),
    ],
...
GymList['Champion Lance'] = new Gym(
    ...
    'Champion Lance',
    [
        new GymPokemon('Gyarados', 439110, 44),
        new GymPokemon('Dragonite', 445400, 47),
        new GymPokemon('Charizard', 448800, 46),
        new GymPokemon('Aerodactyl', 442425, 46),
        new GymPokemon('Dragonite', 459000, 47),
        new GymPokemon('Dragonite', 459000, 50),
    ],
...
GymList['Rustboro City'] = new Gym(
    ...
    'Rustboro City',
    [
        new GymPokemon('Geodude', 459480, 12),
        new GymPokemon('Geodude', 459480, 12),
        new GymPokemon('Nosepass', 492240, 15),
    ],
    BadgeEnums.Stone,
    1000,
...
GymList['Dewford Town'] = new Gym(
    ...
    'Dewford Town',
    [
        new GymPokemon('Machop', 508800, 16),
        new GymPokemon('Meditite', 508800, 16),
        new GymPokemon('Makuhita', 532800, 19),
    ],
    BadgeEnums.Knuckle,
    2000,
...
GymList['Mauville City'] = new Gym(
    ...
    'Mauville City',
    [
        new GymPokemon('Voltorb', 542400, 20),
        new GymPokemon('Electrike', 537600, 20),
        new GymPokemon('Magneton', 579600, 22),
        new GymPokemon('Manectric', 537600, 24),
    ],
    BadgeEnums.Dynamo,
    3000,
...
GymList['Lavaridge Town'] = new Gym(
    ...
    'Lavaridge Town',
    [
        new GymPokemon('Numel', 566400, 24),
        new GymPokemon('Slugma', 566400, 24),
        new GymPokemon('Camerupt', 590400, 26),
        new GymPokemon('Torkoal', 628800, 29),
    ],
    BadgeEnums.Heat,
    4000,
...
GymList['Petalburg City'] = new Gym(
    ...
    'Petalburg City',
    [
        new GymPokemon('Spinda', 588000, 27),
        new GymPokemon('Vigoroth', 636000, 27),
        new GymPokemon('Linoone', 672000, 29),
        new GymPokemon('Slaking', 715200, 31),
    ],
    BadgeEnums.Balance,
    5000,
...
GymList['Fortree City'] = new Gym(
    ...
    'Fortree City',
    [
        new GymPokemon('Swablu', 726000, 29),
        new GymPokemon('Tropius', 780000, 29),
        new GymPokemon('Pelipper', 756000, 30),
        new GymPokemon('Skarmory', 800400, 31),
        new GymPokemon('Altaria', 802800, 33),
    ],
    BadgeEnums.Feather,
    6000,
...
GymList['Mossdeep City'] = new Gym(
    ...
    'Mossdeep City',
    [
        new GymPokemon('Claydol', 842400, 41),
        new GymPokemon('Xatu', 843600, 41),
        new GymPokemon('Lunatone', 842400, 42),
        new GymPokemon('Solrock', 843600, 42),
    ],
    BadgeEnums.Mind,
    8000,
...
GymList['Sootopolis City'] = new Gym(
    ...
    'Sootopolis City',
    [
        new GymPokemon('Luvdisc', 957600, 41),
        new GymPokemon('Whiscash', 975600, 41),
        new GymPokemon('Sealeo', 988080, 43),
        new GymPokemon('Crawdaunt', 1010400, 43),
        new GymPokemon('Kingdra', 1038000, 46),
    ],
    BadgeEnums.Rain,
    10000,
...
GymList['Elite Sidney'] = new Gym(
    ...
    'Elite Sidney',
    [
        new GymPokemon('Mightyena', 1166400, 46),
        new GymPokemon('Shiftry', 1176000, 48),
        new GymPokemon('Cacturne', 1202400, 46),
        new GymPokemon('Crawdaunt', 1218000, 48),
        new GymPokemon('Absol', 1224000, 49),
    ],
...
GymList['Elite Phoebe'] = new Gym(
    ...
    'Elite Phoebe',
    [
        new GymPokemon('Dusclops', 1244040, 48),
        new GymPokemon('Banette', 1245600, 49),
        new GymPokemon('Sableye', 1262400, 50),
        new GymPokemon('Banette', 1245600, 49),
        new GymPokemon('Dusclops', 1275600, 51),
    ],
...
GymList['Elite Glacia'] = new Gym(
    ...
    'Elite Glacia',
    [
        new GymPokemon('Sealeo', 1298400, 50),
        new GymPokemon('Glalie', 1286400, 50),
        new GymPokemon('Sealeo', 1303200, 52),
        new GymPokemon('Glalie', 1291200, 52),
        new GymPokemon('Walrein', 1320000, 53),
    ],
...
GymList['Elite Drake'] = new Gym(
    ...
    'Elite Drake',
    [
        new GymPokemon('Shelgon', 1276800, 52),
        new GymPokemon('Altaria', 1286400, 54),
        new GymPokemon('Kingdra', 1291200, 53),
        new GymPokemon('Flygon', 1291200, 53),
        new GymPokemon('Salamence', 1388400, 55),
    ],
...
GymList['Champion Wallace'] = new Gym(
    ...
    'Champion Wallace',
    [
        new GymPokemon('Wailord', 1442400, 57),
        new GymPokemon('Tentacruel', 1396800, 55),
        new GymPokemon('Ludicolo', 1420800, 56),
        new GymPokemon('Whiscash', 1406400, 56),
        new GymPokemon('Gyarados', 1395600, 56),
        new GymPokemon('Milotic', 1418400, 58),
    ],
...
GymList['Mikan Island'] = new Gym(
    ...
    'Mikan Island',
    [
        new GymPokemon('Seadra', 2769000, 24),
        new GymPokemon('Blastoise', 2769000, 24),
    ],
...
GymList['Navel Island'] = new Gym(
    ...
    'Navel Island',
    [
        new GymPokemon('Geodude', 1107600, 24),
        new GymPokemon('Nidoqueen', 1107600, 24),
        new GymPokemon('Machoke', 1107600, 24),
        new GymPokemon('Scyther', 1107600, 24),
        new GymPokemon('Electrode', 1107600, 24),
    ],
    BadgeEnums.Sea_Ruby,
    10000,
...
GymList['Trovita Island'] = new Gym(
    ...
    'Trovita Island',
    [
        new GymPokemon('Electabuzz', 1845999, 24),
        new GymPokemon('Exeggutor', 1845999, 24),
        new GymPokemon('Starmie', 1845999, 24),
    ],
...
GymList['Kumquat Island'] = new Gym(
    ...
    'Kumquat Island',
    [
        new GymPokemon('Alakazam', 2769000, 24),
        new GymPokemon('Marowak', 2769000, 24),
    ],
...
GymList['Supreme Gym Leader Drake'] = new Gym(
    ...
    'Supreme Gym Leader Drake',
    [
        new GymPokemon('Ditto', 1079424, 38),
        new GymPokemon('Onix', 1079424, 39),
        new GymPokemon('Gengar', 1079424, 40),
        new GymPokemon('Venusaur', 1079424, 40),
        new GymPokemon('Electabuzz', 1079424, 41),
        new GymPokemon('Dragonite', 1349280, 37),
    ],
...
GymList['Cipher Admin Ein'] = new Gym (
    ...
    'Cipher Admin Ein',
    [
        new GymPokemon('Crobat', 14519424, 48),
        new GymPokemon('Pelipper', 14519424, 49),
        new GymPokemon('Rhydon', 14519424, 50),
        new GymPokemon('Starmie', 14519424, 49),
        new GymPokemon('Manectric', 14519424, 50),
    ],
...
GymList['Cipher Admin Miror B.'] = new Gym (
    ...
    'Cipher Admin Miror B.',
    [
        new GymPokemon('Ludicolo', 13919424, 44),
        new GymPokemon('Ludicolo', 13919424, 45),
        new GymPokemon('Loudred', 13919424, 46),
        new GymPokemon('Golduck', 13919424, 45),
        new GymPokemon('Armaldo', 13919424, 43),
    ],
...
GymList['Cipher Admin Dakim'] = new Gym (
    ...
    'Cipher Admin Dakim',
    [
        new GymPokemon('Claydol', 14399424, 46),
        new GymPokemon('Forretress', 14399424, 45),
        new GymPokemon('Flygon', 14399424, 46),
        new GymPokemon('Whiscash', 14399424, 46),
        new GymPokemon('Houndoom', 14399424, 47),
    ],
...
GymList['Cipher Admin Venus'] = new Gym (
    ...
    'Cipher Admin Venus',
    [
        new GymPokemon('Bellossom', 14759424, 47),
        new GymPokemon('Misdreavus', 14759424, 47),
        new GymPokemon('Raichu', 14759424, 48),
        new GymPokemon('Wigglytuff', 14759424, 48),
        new GymPokemon('Milotic', 14759424, 48),
    ],
