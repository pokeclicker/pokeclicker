...
GymList.Turffield = new Gym(
    ...
    'Turffield',
    [
        new GymPokemon('Gossifleur', 117415945, 19),
        new GymPokemon('Eldegoss', 130462162, 20),
    ],
...
GymList.Hulbury = new Gym(
    ...
    'Hulbury',
    [
        new GymPokemon('Goldeen', 126046814, 22),
        new GymPokemon('Arrokuda', 126046814, 23),
        new GymPokemon('Gigantamax Drednaw', 129866414, 24),
    ],
...
GymList.Motostoke = new Gym(
    ...
    'Motostoke',
    [
        new GymPokemon('Ninetales', 132366538, 25),
        new GymPokemon('Arcanine', 132366538, 25),
        new GymPokemon('Gigantamax Centiskorch', 140639447, 27),
    ],
...
GymList['Stow-on-Side1'] = new Gym(
    ...
    'Stow-on-Side1',
    [
        new GymPokemon('Hitmontop', 139079014, 34),
        new GymPokemon('Pangoro', 139079014, 34),
        new GymPokemon('Sirfetch\'d', 139079014, 35),
        new GymPokemon('Gigantamax Machamp', 150432419, 36),
    ],
...
GymList['Stow-on-Side2'] = new Gym(
    ...
    'Stow-on-Side2',
    [
        new GymPokemon('Galarian Yamask', 139079014, 34),
        new GymPokemon('Mimikyu', 139079014, 34),
        new GymPokemon('Cursola', 139079014, 35),
        new GymPokemon('Gigantamax Gengar', 150432419, 36),
    ],
...
GymList.Ballonlea = new Gym(
    ...
    'Ballonlea',
    [
        new GymPokemon('Galarian Weezing', 143999999, 36),
        new GymPokemon('Mawile', 143999999, 36),
        new GymPokemon('Togekiss', 143999999, 37),
        new GymPokemon('Gigantamax Alcremie', 155750736, 38),
    ],
...
GymList.Circhester2 = new Gym(
    ...
    'Circhester2',
    [
        new GymPokemon('Frosmoth', 148495838, 40),
        new GymPokemon('Galarian Darmanitan', 148495838, 40),
        new GymPokemon('Eiscue (Ice Face)', 148495838, 41, new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Hail, WeatherType.Blizzard, WeatherType.Sandstorm, WeatherType.Fog, WeatherType.Windy])),
        new GymPokemon('Eiscue (Noice Face)', 148495838, 41, new WeatherRequirement([WeatherType.Sunny])),
        new GymPokemon('Gigantamax Lapras', 160617947, 42),
    ],
...
GymList.Spikemuth = new Gym(
    ...
    'Spikemuth',
    [
        new GymPokemon('Scrafty', 154114598, 44),
        new GymPokemon('Malamar', 154114598, 45),
        new GymPokemon('Skuntank', 154114598, 45),
        new GymPokemon('Obstagoon', 166695383, 46),
    ],
...
GymList.Hammerlocke = new Gym(
    ...
    'Hammerlocke',
    [
        new GymPokemon('Gigalith', 160175238, 46),
        new GymPokemon('Flygon', 160175238, 47),
        new GymPokemon('Sandaconda', 160175238, 46),
        new GymPokemon('Gigantamax Duraludon', 173250819, 48),
    ],
...
GymList['Elite Trainer Marnie'] = new Gym(
    ...
    [
        new GymPokemon('Liepard', 169461576, 47),
        new GymPokemon('Toxicroak', 169461576, 47),
        new GymPokemon('Scrafty', 169461576, 47),
        new GymPokemon('Morpeko', 175212802, 48),
        new GymPokemon('Gigantamax Grimmsnarl', 181660711, 49),
    ],
...
GymList['Elite Gym Leader Bede'] = new Gym(
    ...
    [
        new GymPokemon('Mawile', 169461576, 51),
        new GymPokemon('Sylveon', 169461576, 51),
        new GymPokemon('Gardevoir', 169461576, 51),
        new GymPokemon('Galarian Rapidash', 175212802, 52),
        new GymPokemon('Gigantamax Hatterene', 181660711, 53),
    ],
...
GymList['Elite Trainer Hop'] = new Gym(
    ...
    'Elite Trainer Hop',
    [
        new GymPokemon('Dubwool', 183712551, 59),
        new GymPokemon('Pincurchin', 178747865, 58),
        new GymPokemon('Snorlax', 178747865, 58),
        new GymPokemon('Corviknight', 190070604, 60),
        new GymPokemon('Gigantamax Inteleon', 200472376, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Gigantamax Rillaboom', 200472376, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Gigantamax Cinderace', 200472376, 59, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
    ],
...
GymList['Champion Leon'] = new Gym(
    ...
    'Champion Leon',
    [
        new GymPokemon('Aegislash (Shield)', 188034154, 62),
        new GymPokemon('Dragapult', 188034154, 62),
        new GymPokemon('Haxorus', 188034154, 63),
        new GymPokemon('Seismitoad', 192212691, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Cinderace', 198480496, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Grass)),
        new GymPokemon('Mr. Rime', 192212691, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Inteleon', 198480496, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Fire)),
        new GymPokemon('Rhyperior', 192212691, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
        new GymPokemon('Rillaboom', 198480496, 64, new StarterRequirement(GameConstants.Region.galar, GameConstants.Starter.Water)),
        new GymPokemon('Gigantamax Charizard', 208927006, 65),
    ],
...
GymList['Elite Gym Leader Klara'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Slowking', 297663774, 68),
        new GymPokemon('Galarian Weezing', 297663774, 68),
        new GymPokemon('Drapion', 297663774, 68),
        new GymPokemon('Scolipede', 303930173, 69),
        new GymPokemon('Galarian Slowbro', 313330288, 70),
    ],
...
GymList['Elite Gym Leader Avery'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Slowbro', 297663774, 68),
        new GymPokemon('Swoobat', 297663774, 68),
        new GymPokemon('Galarian Rapidash', 297663774, 68),
        new GymPokemon('Alakazam', 303930173, 69),
        new GymPokemon('Galarian Slowking', 313330288, 70),
    ],
...
GymList['Elite Dojo Matron Honey'] = new Gym(
    ...
    [
        new GymPokemon('Galarian Darmanitan', 252070230, 73),
        new GymPokemon('Gallade', 252070230, 74),
        new GymPokemon('Salazzle', 257376972, 73),
        new GymPokemon('Togekiss', 257376972, 75),
        new GymPokemon('Gigantamax Venusaur', 265337085, 75),
        new GymPokemon('Gigantamax Blastoise', 265337085, 75),
    ],
...
GymList['Elite Dojo Master Mustard'] = new Gym(
    ...
    [
        new GymPokemon('Mienshao', 258024645, 73),
        new GymPokemon('Luxray', 258024645, 73),
        new GymPokemon('Lycanroc (Midday)', 263456789, 75),
        new GymPokemon('Kommo-o', 263456789, 75),
        new GymPokemon('Gigantamax Urshifu (Single Strike)', 271604890, 75),
        new GymPokemon('Gigantamax Urshifu (Rapid Strike)', 271604890, 75),
    ],
...
GymList['Elite Trainer Peony'] = new Gym(
    ...
    'Elite Trainer Peony',
    [
        new GymPokemon('Perrserker', 323351431, 74),
        new GymPokemon('Bronzong', 316684392, 73),
        new GymPokemon('Scizor', 316684392, 73),
        new GymPokemon('Aggron', 323351431, 74),
        new GymPokemon('Copperajah', 333351992, 74),
    ],
