...
GymList['Champion Leon'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Charizard', 145088083, 65, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Grass)),
        ...
        new GymPokemon('Charizard', 145088083, 65, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Fire)),
        ...
        new GymPokemon('Charizard', 145088083, 65, new StarterRequirement(GameConstants.Region.alola, GameConstants.Starter.Water)),
    ],
