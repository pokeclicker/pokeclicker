...
gymList['Iki Town'] = new Gym(
    ...
    'Iki Town',
    [
        new GymPokemon('Machop', 19515450, 15),
        new GymPokemon('Makuhita', 19515450, 15),
        new GymPokemon('Crabrawler', 19815450, 16),
    ],
...
gymList['Konikoni City'] = new Gym(
    ...
    'Konikoni City',
    [
        new GymPokemon('Anorith', 22043374, 27),
        new GymPokemon('Lileep', 22043374, 27),
        new GymPokemon('Lycanroc (Midnight)', 22343374, 28),
    ],
    BadgeEnums.RockiumZ,
    128000,
    'How lovely.',
...
gymList['Malie City'] = new Gym(
    ...
    'Malie City',
    [
        new GymPokemon('Sableye', 25467627, 43),
        new GymPokemon('Krokorok', 25467627, 43),
        new GymPokemon('Alolan Persian', 25767627, 44),
    ],
...
gymList['Seafolk Village'] = new Gym(
    ...
    'Seafolk Village',
    [
        new GymPokemon('Mawile', 26653407, 51),
        new GymPokemon('Granbull', 26653407, 51),
        new GymPokemon('Ribombee', 26653407, 51),
    ],
    BadgeEnums.FairiumZ,
    128000,
...
gymList['Exeggutor Island'] = new Gym(
    ...
    'Exeggutor Island',
    [
        new GymPokemon('Golurk', 20166063, 53),
        new GymPokemon('Gastrodon (east)', 20166063, 53),
        new GymPokemon('Flygon', 20166063, 53),
        new GymPokemon('Mudsdale', 20566063, 54),
    ],
