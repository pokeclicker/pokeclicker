...
gymList['Celadon City'] = new Gym(
    ...
    'Celadon City',
    [
        new GymPokemon('Tangela', 40810, 30),
        new GymPokemon('Weepinbell', 40340, 32),
        new GymPokemon('Gloom', 45400, 32),
    ],
    BadgeEnums.Rainbow,
    1500,
...
gymList['Saffron City'] = new Gym(
    ...
    'Saffron City',
    [
        new GymPokemon('Abra', 46040, 50),
        new GymPokemon('Kadabra', 50600, 50),
        new GymPokemon('Alakazam', 55400, 50),
    ],
    BadgeEnums.Marsh,
    2500,
...
gymList['Fuchsia City'] = new Gym(
    ...
    'Fuchsia City',
    [
        new GymPokemon('Venonat', 60780, 44),
        new GymPokemon('Venonat', 64460, 46),
        new GymPokemon('Venonat', 70540, 48),
        new GymPokemon('Venomoth', 75430, 50),
    ],
    BadgeEnums.Soul,
    3500,
...
gymList['Cinnabar Island'] = new Gym(
    ...
    'Cinnabar Island',
    [
        new GymPokemon('Ninetales', 75430, 48),
        new GymPokemon('Rapidash', 90230, 50),
        new GymPokemon('Arcanine', 100290, 54),
    ],
    BadgeEnums.Volcano,
    5000,
...
gymList['Elite Lorelei'] = new Gym(
    ...
    'Elite Lorelei',
    [
        new GymPokemon('Dewgong', 90330, 54),
        new GymPokemon('Cloyster', 96300, 53),
        new GymPokemon('Slowbro', 104000, 54),
        new GymPokemon('Jynx', 114000, 56),
        new GymPokemon('Lapras', 120250, 56),
    ],
...
gymList['Elite Bruno'] = new Gym(
    ...
    'Elite Bruno',
    [
        new GymPokemon('Onix', 90330, 53),
        new GymPokemon('Hitmonchan', 96300, 55),
        new GymPokemon('Hitmonlee', 104000, 55),
        new GymPokemon('Onix', 114000, 56),
        new GymPokemon('Machamp', 120250, 58),
    ],
...
gymList['Elite Agatha'] = new Gym(
    ...
    'Elite Agatha',
    [
        new GymPokemon('Gengar', 90330, 56),
        new GymPokemon('Golbat', 96300, 56),
        new GymPokemon('Haunter', 104000, 55),
        new GymPokemon('Arbok', 114000, 58),
        new GymPokemon('Gengar', 120250, 60),
    ],
...
gymList['Elite Lance'] = new Gym(
    ...
    'Elite Lance',
    [
        new GymPokemon('Gyarados', 96300, 58),
        new GymPokemon('Dragonair', 104000, 56),
        new GymPokemon('Dragonair', 114000, 56),
        new GymPokemon('Aerodactyl', 120250, 60),
        new GymPokemon('Dragonite', 135000, 62),
    ],
...
gymList['Violet City'] = new Gym(
    ...
    'Violet City',
    [
        new GymPokemon('Pidgey', 92000, 7),
        new GymPokemon('Pidgeotto', 95000, 9),
    ],
    BadgeEnums.Zephyr,
    250,
...
gymList['Azalea Town'] = new Gym(
    ...
    'Azalea Town',
    [
        new GymPokemon('Metapod', 943000, 14),
        new GymPokemon('Kakuna', 961500, 14),
        new GymPokemon('Scyther', 109000, 16),
    ],
    BadgeEnums.Hive,
    500,
...
gymList['Goldenrod City'] = new Gym(
    ...
    'Goldenrod City',
    [
        new GymPokemon('Clefairy', 110000, 18),
        new GymPokemon('Miltank', 130000, 20),
    ],
    BadgeEnums.Plain,
    1000,
...
gymList['Ecruteak City'] = new Gym(
    ...
    'Ecruteak City',
    [
        new GymPokemon('Gastly', 227000, 21),
        new GymPokemon('Haunter', 228000, 21),
        new GymPokemon('Gengar', 232000, 25),
        new GymPokemon('Haunter', 230000, 23),
    ],
    BadgeEnums.Fog,
    1500,
...
gymList['Cianwood City'] = new Gym(
    ...
    'Cianwood City',
    [
        new GymPokemon('Primeape', 277000, 27),
        new GymPokemon('Poliwrath', 283000, 30),
    ],
    BadgeEnums.Storm,
    2500,
...
gymList['Olivine City'] = new Gym(
    ...
    'Olivine City',
    [
        new GymPokemon('Magnemite', 277000, 30),
        new GymPokemon('Magnemite', 278000, 30),
        new GymPokemon('Steelix', 282000, 35),
    ],
    BadgeEnums.Mineral,
    3500,
...
gymList['Mahogany Town'] = new Gym(
    ...
    'Mahogany Town',
    [
        new GymPokemon('Seel', 290000, 27),
        new GymPokemon('Dewgong', 292500, 29),
        new GymPokemon('Piloswine', 296000, 31),
    ],
    BadgeEnums.Glacier,
    4000,
...
gymList['Blackthorn City'] = new Gym(
    ...
    'Blackthorn City',
    [
        new GymPokemon('Dragonair', 305000, 37),
        new GymPokemon('Dragonair', 305000, 37),
        new GymPokemon('Dragonair', 318000, 37),
        new GymPokemon('Kingdra', 320000, 40),
    ],
    BadgeEnums.Rising,
    5000,
...
gymList['Elite Will'] = new Gym(
    ...
    'Elite Will',
    [
        new GymPokemon('Xatu', 345330, 40),
        new GymPokemon('Exeggutor', 348300, 41),
        new GymPokemon('Slowbro', 352000, 41),
        new GymPokemon('Jynx', 357000, 41),
        new GymPokemon('Xatu', 360250, 42),
    ],
...
gymList['Elite Koga'] = new Gym(
    ...
    'Elite Koga',
    [
        new GymPokemon('Ariados', 345330, 40),
        new GymPokemon('Venomoth', 348300, 41),
        new GymPokemon('Forretress', 352000, 43),
        new GymPokemon('Muk', 357000, 42),
        new GymPokemon('Crobat', 360250, 44),
    ],
...
gymList['Elite Bruno2'] = new Gym(
    ...
    'Elite Bruno2',
    [
        new GymPokemon('Hitmontop', 345330, 42),
        new GymPokemon('Hitmonlee', 348300, 42),
        new GymPokemon('Hitmonchan', 352000, 42),
        new GymPokemon('Onix', 357000, 43),
        new GymPokemon('Machamp', 360250, 46),
    ],
...
gymList['Elite Karen'] = new Gym(
    ...
    'Elite Karen',
    [
        new GymPokemon('Umbreon', 348300, 42),
        new GymPokemon('Vileplume', 352000, 42),
        new GymPokemon('Murkrow', 357000, 44),
        new GymPokemon('Gengar', 360250, 45),
        new GymPokemon('Houndoom', 366000, 47),
    ],
...
gymList['Champion Lance'] = new Gym(
    ...
    'Champion Lance',
    [
        new GymPokemon('Gyarados', 358300, 44),
        new GymPokemon('Dragonite', 362000, 47),
        new GymPokemon('Charizard', 364000, 46),
        new GymPokemon('Aerodactyl', 360250, 46),
        new GymPokemon('Dragonite', 370000, 47),
        new GymPokemon('Dragonite', 370000, 50),
    ],
