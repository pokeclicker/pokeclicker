...
gymList['Celadon City'] = new Gym(
    ...
    'Celadon City',
    [
        new GymPokemon('Tangela', 50810, 30),
        new GymPokemon('Weepinbell', 50340, 32),
        new GymPokemon('Gloom', 55400, 32),
    ],
    BadgeEnums.Rainbow,
    1500,
...
gymList['Saffron City'] = new Gym(
    ...
    'Saffron City',
    [
        new GymPokemon('Abra', 56040, 50),
        new GymPokemon('Kadabra', 60600, 50),
        new GymPokemon('Alakazam', 65400, 50),
    ],
    BadgeEnums.Marsh,
    2500,
...
gymList['Fuchsia City'] = new Gym(
    ...
    'Fuchsia City',
    [
        new GymPokemon('Venonat', 70780, 44),
        new GymPokemon('Venonat', 74460, 46),
        new GymPokemon('Venonat', 76540, 48),
        new GymPokemon('Venomoth', 76430, 50),
    ],
    BadgeEnums.Soul,
    3500,
...
gymList['Cinnabar Island'] = new Gym(
    ...
    'Cinnabar Island',
    [
        new GymPokemon('Ninetales', 85430, 48),
        new GymPokemon('Rapidash', 90230, 50),
        new GymPokemon('Arcanine', 97290, 54),
    ],
    BadgeEnums.Volcano,
    5000,
...
gymList['Viridian City'] = new Gym(
    ...
    'Viridian City',
    [
        new GymPokemon('Dugtrio', 90230, 50),
        new GymPokemon('Persian', 95530, 53),
        new GymPokemon('Nidoqueen', 96740, 53),
        new GymPokemon('Nidoking', 96350, 55),
        new GymPokemon('Rhydon', 110000, 55),
    ],
    BadgeEnums.Earth,
    6000,
...
gymList['Elite Lorelei'] = new Gym(
    ...
    'Elite Lorelei',
    [
        new GymPokemon('Dewgong', 160330, 54),
        new GymPokemon('Cloyster', 166300, 53),
        new GymPokemon('Slowbro', 204000, 54),
        new GymPokemon('Jynx', 204000, 56),
        new GymPokemon('Lapras', 220250, 56),
    ],
...
gymList['Elite Bruno'] = new Gym(
    ...
    'Elite Bruno',
    [
        new GymPokemon('Onix', 160330, 53),
        new GymPokemon('Hitmonchan', 166300, 55),
        new GymPokemon('Hitmonlee', 204000, 55),
        new GymPokemon('Onix', 204000, 56),
        new GymPokemon('Machamp', 220250, 58),
    ],
...
gymList['Elite Agatha'] = new Gym(
    ...
    'Elite Agatha',
    [
        new GymPokemon('Gengar', 160330, 56),
        new GymPokemon('Golbat', 166300, 56),
        new GymPokemon('Haunter', 204000, 55),
        new GymPokemon('Arbok', 204000, 58),
        new GymPokemon('Gengar', 220250, 60),
    ],
...
gymList['Elite Lance'] = new Gym(
    ...
    [
        ...
        new GymPokemon('Dragonair', 204000, 56),
        new GymPokemon('Aerodactyl', 220250, 60),
        new GymPokemon('Dragonite', 235000, 62),
    ],
...
gymList['Violet City'] = new Gym(
    ...
    'Violet City',
    [
        new GymPokemon('Pidgey', 172000, 7),
        new GymPokemon('Pidgeotto', 175000, 9),
    ],
    BadgeEnums.Zephyr,
    250,
...
gymList['Azalea Town'] = new Gym(
    ...
    'Azalea Town',
    [
        new GymPokemon('Metapod', 204300, 14),
        new GymPokemon('Kakuna', 206150, 14),
        new GymPokemon('Scyther', 239000, 16),
    ],
    BadgeEnums.Hive,
    500,
...
gymList['Goldenrod City'] = new Gym(
    ...
    'Goldenrod City',
    [
        new GymPokemon('Clefairy', 260000, 18),
        new GymPokemon('Miltank', 280000, 20),
    ],
    BadgeEnums.Plain,
    1000,
