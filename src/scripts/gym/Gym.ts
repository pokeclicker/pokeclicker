...
gymList['Pewter City'] = new Gym(
    ...
    'Pewter City',
    [
        new GymPokemon('Geodude', 1470, 10),
        new GymPokemon('Onix', 3054, 12),
    ],
    BadgeEnums.Boulder,
    250,
...
gymList['Cerulean City'] = new Gym(
    ...
    'Cerulean City',
    [
        new GymPokemon('Staryu', 8000, 18),
        new GymPokemon('Starmie', 12800, 21),
    ],
    BadgeEnums.Cascade,
    500,
...
gymList['Vermilion City'] = new Gym(
    'Lt. Surge',
    'Vermilion City',
    [new GymPokemon('Raichu', 75000, 28)],
    BadgeEnums.Thunder,
    1000,
...
gymList['Celadon City'] = new Gym(
    ...
    'Celadon City',
    [
        new GymPokemon('Tangela', 80810, 30),
        new GymPokemon('Weepinbell', 80340, 32),
        new GymPokemon('Gloom', 85400, 32),
    ],
    BadgeEnums.Rainbow,
    1500,
...
gymList['Saffron City'] = new Gym(
    ...
    'Saffron City',
    [
        new GymPokemon('Abra', 86040, 50),
        new GymPokemon('Kadabra', 90600, 50),
        new GymPokemon('Alakazam', 95400, 50),
    ],
    BadgeEnums.Marsh,
    2500,
...
gymList['Fuchsia City'] = new Gym(
    ...
    'Fuchsia City',
    [
        new GymPokemon('Venonat', 100780, 44),
        new GymPokemon('Venonat', 124460, 46),
        new GymPokemon('Venonat', 140540, 48),
        new GymPokemon('Venomoth', 145430, 50),
    ],
    BadgeEnums.Soul,
    3500,
...
gymList['Cinnabar Island'] = new Gym(
    ...
    'Cinnabar Island',
    [
        new GymPokemon('Ninetales', 145430, 48),
        new GymPokemon('Rapidash', 160230, 50),
        new GymPokemon('Arcanine', 170290, 54),
    ],
    BadgeEnums.Volcano,
    5000,
...
gymList['Viridian City'] = new Gym(
    ...
    'Viridian City',
    [
        new GymPokemon('Dugtrio', 180230, 50),
        new GymPokemon('Persian', 185530, 53),
        new GymPokemon('Nidoqueen', 186740, 53),
        new GymPokemon('Nidoking', 186350, 55),
        new GymPokemon('Rhydon', 220000, 55),
    ],
    BadgeEnums.Earth,
    6000,
...
gymList['Elite Lorelei'] = new Gym(
    ...
    'Elite Lorelei',
    [
        new GymPokemon('Dewgong', 180330, 54),
        new GymPokemon('Cloyster', 186300, 53),
        new GymPokemon('Slowbro', 204000, 54),
        new GymPokemon('Jynx', 224000, 56),
        new GymPokemon('Lapras', 240250, 56),
    ],
...
gymList['Elite Bruno'] = new Gym(
    ...
    'Elite Bruno',
    [
        new GymPokemon('Onix', 180330, 53),
        new GymPokemon('Hitmonchan', 186300, 55),
        new GymPokemon('Hitmonlee', 204000, 55),
        new GymPokemon('Onix', 224000, 56),
        new GymPokemon('Machamp', 240250, 58),
    ],
...
gymList['Elite Agatha'] = new Gym(
    ...
    'Elite Agatha',
    [
        new GymPokemon('Gengar', 180330, 56),
        new GymPokemon('Golbat', 186300, 56),
        new GymPokemon('Haunter', 204000, 55),
        new GymPokemon('Arbok', 224000, 58),
        new GymPokemon('Gengar', 240250, 60),
    ],
...
gymList['Elite Lance'] = new Gym(
    ...
    'Elite Lance',
    [
        new GymPokemon('Gyarados', 186300, 58),
        new GymPokemon('Dragonair', 204000, 56),
        new GymPokemon('Dragonair', 224000, 56),
        new GymPokemon('Aerodactyl', 240250, 60),
        new GymPokemon('Dragonite', 265000, 62),
    ],
...
gymList['Violet City'] = new Gym(
    ...
    'Violet City',
    [
        new GymPokemon('Pidgey', 192000, 7),
        new GymPokemon('Pidgeotto', 195000, 9),
    ],
    BadgeEnums.Zephyr,
    250,
...
gymList['Azalea Town'] = new Gym(
    ...
    'Azalea Town',
    [
        new GymPokemon('Metapod', 224300, 14),
        new GymPokemon('Kakuna', 226150, 14),
        new GymPokemon('Scyther', 259000, 16),
    ],
    BadgeEnums.Hive,
    500,
...
gymList['Goldenrod City'] = new Gym(
    ...
    'Goldenrod City',
    [
        new GymPokemon('Clefairy', 290000, 18),
        new GymPokemon('Miltank', 310000, 20),
    ],
    BadgeEnums.Plain,
    1000,
...
gymList['Ecruteak City'] = new Gym(
    ...
    'Ecruteak City',
    [
        new GymPokemon('Gastly', 427000, 21),
        new GymPokemon('Haunter', 428000, 21),
        new GymPokemon('Gengar', 432000, 25),
        new GymPokemon('Haunter', 430000, 23),
    ],
    BadgeEnums.Fog,
    1500,
...
gymList['Cianwood City'] = new Gym(
    ...
    'Cianwood City',
    [
        new GymPokemon('Primeape', 477000, 27),
        new GymPokemon('Poliwrath', 483000, 30),
    ],
    BadgeEnums.Storm,
    2500,
...
gymList['Olivine City'] = new Gym(
    ...
    'Olivine City',
    [
        new GymPokemon('Magnemite', 497000, 30),
        new GymPokemon('Magnemite', 498000, 30),
        new GymPokemon('Steelix', 502000, 35),
    ],
    BadgeEnums.Mineral,
    3500,
...
gymList['Mahogany Town'] = new Gym(
    ...
    'Mahogany Town',
    [
        new GymPokemon('Seel', 550000, 27),
        new GymPokemon('Dewgong', 552500, 29),
        new GymPokemon('Piloswine', 556000, 31),
    ],
    BadgeEnums.Glacier,
    4000,
...
gymList['Blackthorn City'] = new Gym(
    ...
    'Blackthorn City',
    [
        new GymPokemon('Dragonair', 605000, 37),
        new GymPokemon('Dragonair', 605000, 37),
        new GymPokemon('Dragonair', 618000, 37),
        new GymPokemon('Kingdra', 620000, 40),
    ],
    BadgeEnums.Rising,
    5000,
...
gymList['Elite Will'] = new Gym(
    ...
    'Elite Will',
    [
        new GymPokemon('Xatu', 645330, 40),
        new GymPokemon('Exeggutor', 648300, 41),
        new GymPokemon('Slowbro', 652000, 41),
        new GymPokemon('Jynx', 657000, 41),
        new GymPokemon('Xatu', 660250, 42),
    ],
...
gymList['Elite Koga'] = new Gym(
    ...
    'Elite Koga',
    [
        new GymPokemon('Ariados', 645330, 40),
        new GymPokemon('Venomoth', 648300, 41),
        new GymPokemon('Forretress', 652000, 43),
        new GymPokemon('Muk', 657000, 42),
        new GymPokemon('Crobat', 660250, 44),
    ],
...
gymList['Elite Bruno2'] = new Gym(
    ...
    'Elite Bruno2',
    [
        new GymPokemon('Hitmontop', 645330, 42),
        new GymPokemon('Hitmonlee', 648300, 42),
        new GymPokemon('Hitmonchan', 652000, 42),
        new GymPokemon('Onix', 657000, 43),
        new GymPokemon('Machamp', 660250, 46),
    ],
...
gymList['Elite Karen'] = new Gym(
    ...
    'Elite Karen',
    [
        new GymPokemon('Umbreon', 648300, 42),
        new GymPokemon('Vileplume', 652000, 42),
        new GymPokemon('Murkrow', 657000, 44),
        new GymPokemon('Gengar', 660250, 45),
        new GymPokemon('Houndoom', 666000, 47),
    ],
...
gymList['Champion Lance'] = new Gym(
    ...
    'Champion Lance',
    [
        new GymPokemon('Gyarados', 658300, 44),
        new GymPokemon('Dragonite', 662000, 47),
        new GymPokemon('Charizard', 664000, 46),
        new GymPokemon('Aerodactyl', 660250, 46),
        new GymPokemon('Dragonite', 670000, 47),
        new GymPokemon('Dragonite', 670000, 50),
    ],
...
gymList['Rustboro City'] = new Gym(
    ...
    'Rustboro City',
    [
        new GymPokemon('Geodude', 522900, 12),
        new GymPokemon('Geodude', 522900, 12),
        new GymPokemon('Nosepass', 630200, 15),
    ],
    BadgeEnums.Stone,
    1000,
...
gymList['Dewford Town'] = new Gym(
    ...
    'Dewford Town',
    [
        new GymPokemon('Machop', 654000, 16),
        new GymPokemon('Meditite', 654000, 16),
        new GymPokemon('Makuhita', 684000, 19),
    ],
    BadgeEnums.Knuckle,
    2000,
...
gymList['Mauville City'] = new Gym(
    ...
    'Mauville City',
    [
        new GymPokemon('Voltorb', 1252000, 20),
        new GymPokemon('Electrike', 1248000, 20),
        new GymPokemon('Magneton', 1283000, 22),
        new GymPokemon('Manectric', 1248000, 24),
    ],
    BadgeEnums.Dynamo,
    3000,
...
gymList['Lavaridge Town'] = new Gym(
    ...
    'Lavaridge Town',
    [
        new GymPokemon('Numel', 1372000, 24),
        new GymPokemon('Slugma', 1372000, 24),
        new GymPokemon('Camerupt', 1392000, 26),
        new GymPokemon('Torkoal', 1424000, 29),
    ],
    BadgeEnums.Heat,
    4000,
...
gymList['Petalburg City'] = new Gym(
    ...
    'Petalburg City',
    [
        new GymPokemon('Spinda', 1390000, 27),
        new GymPokemon('Vigoroth', 1430000, 27),
        new GymPokemon('Linoone', 1460000, 29),
        new GymPokemon('Slaking', 1596000, 31),
    ],
    BadgeEnums.Balance,
    5000,
...
gymList['Fortree City'] = new Gym(
    ...
    'Fortree City',
    [
        new GymPokemon('Swablu', 1405000, 29),
        new GymPokemon('Tropius', 1450000, 29),
        new GymPokemon('Pelipper', 1430000, 30),
        new GymPokemon('Skarmory', 1467000, 31),
        new GymPokemon('Altaria', 1669000, 33),
    ],
    BadgeEnums.Feather,
    6000,
...
gymList['Mossdeep City'] = new Gym(
    ...
    'Mossdeep City',
    [
        new GymPokemon('Claydol', 1502000, 41),
        new GymPokemon('Xatu', 1503000, 41),
        new GymPokemon('Lunatone', 1602000, 42),
        new GymPokemon('Solrock', 1603000, 42),
    ],
    BadgeEnums.Mind,
    8000,
...
gymList['Sootopolis City'] = new Gym(
    ...
    'Sootopolis City',
    [
        new GymPokemon('Luvdisc', 1498000, 41),
        new GymPokemon('Whiscash', 1513000, 41),
        new GymPokemon('Sealeo', 1523400, 43),
        new GymPokemon('Crawdaunt', 1642000, 43),
        new GymPokemon('Kingdra', 1665000, 46),
    ],
    BadgeEnums.Rain,
    10000,
...
gymList['Elite Sidney'] = new Gym(
    ...
    'Elite Sidney',
    [
        new GymPokemon('Mightyena', 1772000, 46),
        new GymPokemon('Shiftry', 1780000, 48),
        new GymPokemon('Cacturne', 1802000, 46),
        new GymPokemon('Crawdaunt', 1815000, 48),
        new GymPokemon('Absol', 1820000, 49),
    ],
...
gymList['Elite Phoebe'] = new Gym(
    ...
    'Elite Phoebe',
    [
        new GymPokemon('Dusclops', 1836700, 48),
        new GymPokemon('Banette', 1838000, 49),
        new GymPokemon('Sableye', 1852000, 50),
        new GymPokemon('Banette', 1838000, 49),
        new GymPokemon('Dusclops', 1963000, 51),
    ],
...
gymList['Elite Glacia'] = new Gym(
    ...
    'Elite Glacia',
    [
        new GymPokemon('Sealeo', 1882000, 50),
        new GymPokemon('Glalie', 1872000, 50),
        new GymPokemon('Sealeo', 1886000, 52),
        new GymPokemon('Glalie', 1876000, 52),
        new GymPokemon('Walrein', 1900000, 53),
    ],
...
gymList['Elite Drake'] = new Gym(
    ...
    'Elite Drake',
    [
        new GymPokemon('Shelgon', 1864000, 52),
        new GymPokemon('Altaria', 1872000, 54),
        new GymPokemon('Flygon', 1876000, 53),
        new GymPokemon('Flygon', 1876000, 53),
        new GymPokemon('Salamence', 1957000, 55),
    ],
...
gymList['Champion Wallace'] = new Gym(
    ...
    'Champion Wallace',
    [
        new GymPokemon('Wailord', 2302000, 57),
        new GymPokemon('Tentacruel', 2164000, 55),
        new GymPokemon('Ludicolo', 2184000, 56),
        new GymPokemon('Whiscash', 2172000, 56),
        new GymPokemon('Gyarados', 2163000, 56),
        new GymPokemon('Milotic', 2482000, 58),
    ],
