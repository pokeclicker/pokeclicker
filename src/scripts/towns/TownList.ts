...
const Peonia2 = new NPC ('Peonia', [
    ...
    'Every day some of them glow red and emit a purple beam. Here, download this app, and they\'ll show up on your map! Anyway, in each of these Raid Dens, there\'s a Gigantamax Pokémon! You can\'t catch \'em though, they\'ll turn back to their regular form and run before you get the chance.',
