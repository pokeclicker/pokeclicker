...
const VivillonPhotobook = new NPC('Vivillon Photobook', [
    ...
    '<i>You see both a Meadow and a Fancy Vivillon flying together in the skies above Kalos. Strangely, the Meadow Vivillon is wearing a necklace of exotic flowers, and the Fancy has a tiny tea cup in it\'s grip.</i>',
    ...
    '<i>You see a Monsoon Vivillon. It\'s been startled by a light shone in it\'s face. As far as you can see, the area around the spotlight is darker than pitch.</i>',
    '<img src="assets/images/npcs/textbody/VivillonPhotobookTundra.png" style="max-width:100%; height:auto"/>',
    '<i>You see a Tundra Vivillon riding a factory\'s conveyor belt. A worker in the background looks mildly perplexed, as if he was expecting a different Pokémon there.</i>',
    ...
    '<i>You see a Savanna Vivillon running for it\'s life through a ruined tower. Several dragon-type Pokémon are chasing it relentlessly.</i>',
    '<img src="assets/images/npcs/textbody/VivillonPhotobookIcySnow.png" style="max-width:100%; height:auto"/>',
    '<i>You see an Icy Snow Vivillon bundled up with it\'s trainer. It\'s enjoying a much-needed warm cup of cocoa to counteract the icy cave around it.</i>',
