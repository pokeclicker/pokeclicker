...
class DreamOrbController implements Saveable {
    ...
    public orbs = [
        ...
        new DreamOrb('Orange', new ObtainedPokemonRequirement('Thundurus (Therian)'), [
            ...
            new DreamOrbLoot({type: ItemType.item, id: 'Protein'}, 0.08125),
            new DreamOrbLoot({type: ItemType.item, id: 'Calcium'}, 0.08125),
            new DreamOrbLoot({type: ItemType.item, id: 'Carbos'}, 0.08125),
            new DreamOrbLoot({type: ItemType.item, id: 'RareCandy'}, 0.08125),
        ]),
