...
class DreamOrbController implements Saveable {
    ...
    public orbs = [
        new DreamOrb('Pink', undefined, [
            ...
            new DreamOrbLoot({type: ItemType.underground, id: 'Sun_stone'}, 0.15),
            new DreamOrbLoot({type: ItemType.underground, id: 'Water_stone'}, 0.15),
        ...
        new DreamOrb('Green', new ObtainedPokemonRequirement('Tornadus (Therian)'), [
            ...
            new DreamOrbLoot({type: ItemType.underground, id: 'Red_shard'}, 0.125),
            new DreamOrbLoot({type: ItemType.underground, id: 'Blue_shard'}, 0.125),
            new DreamOrbLoot({type: ItemType.underground, id: 'Yellow_shard'}, 0.125),
        ...
        new DreamOrb('Orange', new ObtainedPokemonRequirement('Thundurus (Therian)'), [
            ...
            new DreamOrbLoot({type: ItemType.underground, id: 'Fire_stone'}, 0.2),
        ...
        new DreamOrb('Blue', new MultiRequirement([new ObtainedPokemonRequirement('Landorus (Therian)'), new ObtainedPokemonRequirement('Enamorus')]), [
            ...
            new DreamOrbLoot({type: ItemType.underground, id: 'Moon_Stone'}, 0.1),
            new DreamOrbLoot({type: ItemType.underground, id: 'Leaf_stone'}, 0.1),
            new DreamOrbLoot({type: ItemType.underground, id: 'Thunder_stone'}, 0.1),
            new DreamOrbLoot({type: ItemType.underground, id: 'Heart_scale'}, 0.125),
            new DreamOrbLoot({type: ItemType.underground, id: 'Max_revive'}, 0.1),
        ]),
    ]
