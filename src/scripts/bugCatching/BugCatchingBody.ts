abstract class BugCatchingBody {
...
class BCSandBody extends BugCatchingBody {
    edgeDetectCheck = 15;

    constructor(
        x: number = BCSandBody.randomInt(),
        y: number = BCSandBody.randomInt(),
        type = 'sand'
    ) {
        super();
        this.type = type;
    ...
    private generateCube(sizeX: number, sizeY: number): Array<Array<number>> {
        ...
        for (let i = 0; i < amount; i++) {
            ...
            body = BCSandBody.addCube(x,y,body);
        }
        return body;
    }
...
class BCFenceBody extends BCSandBody {
    edgeDetectCheck = 0;
...
class BCWaterBody extends BugCatchingBody {
    constructor() {
        super();
...
class BCGrassBody extends BugCatchingBody {
    constructor() {
        super();
...
class BCTreeBody extends BugCatchingBody {
    constructor() {
        super();
