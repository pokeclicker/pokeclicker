class BattlePokemon implements enemyPokemonInterface {
     ...
     * @param shiny
     */
    constructor(name: string, id: number, type1: PokemonType, type2: PokemonType, maxHealth: number, level: number, catchRate: number, exp: number, money: number, shiny: boolean, shardReward: number = 1) {
        this.name = name;
        this.id = id;
        this.type1 = type1;
        this.type2 = type2;
