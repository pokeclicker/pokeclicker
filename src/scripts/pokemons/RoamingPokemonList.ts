...
RoamingPokemonList.add(GameConstants.Region.unova, new RoamingPokemon(pokemonMap.Meloetta, undefined, new GymBadgeRequirement(BadgeTypes.Elite_UnovaChampion)));
