...
const pokemonList = createPokemonArray(
    ...
    },
    {
        ...
        'catchRate': 200,
        'evolutions': [
            new StoneEvolution('Milcery', 'Alcremie (Strawberry)', GameConstants.StoneType.Strawberry_sweet),
            new StoneEvolution('Milcery', 'Alcremie (Berry)', GameConstants.StoneType.Berry_sweet),
            new StoneEvolution('Milcery', 'Alcremie (Love)', GameConstants.StoneType.Love_sweet),
            new StoneEvolution('Milcery', 'Alcremie (Star)', GameConstants.StoneType.Star_sweet),
            new StoneEvolution('Milcery', 'Alcremie (Clover)', GameConstants.StoneType.Clover_sweet),
            new StoneEvolution('Milcery', 'Alcremie (Flower)', GameConstants.StoneType.Flower_sweet),
            new StoneEvolution('Milcery', 'Alcremie (Ribbon)', GameConstants.StoneType.Ribbon_sweet),
        ],
    },
    {
        'id': 869,
