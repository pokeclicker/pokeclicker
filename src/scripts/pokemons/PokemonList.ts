...
pokemonList.forEach(p => {
    ...
    (p as PokemonListData).attack = Math.max(10, Math.floor(Math.sqrt(baseDefense * baseStamina) * baseOffense * 1.001 ** (baseOffense * Math.sqrt(baseDefense * baseStamina)) / 325));
