...
const pokemonList = createPokemonArray(
    ...
    //     'catchRate': 190,
    //     'nativeRegion': GameConstants.Region.hisui,
    ...
    },
    {
        ...
        'eggCycles': 25,
        'evolutions': [
            new StoneEvolution('Scyther', 'Scizor', GameConstants.StoneType.Metal_coat),
            //new StoneEvolution('Scyther', 'Kleavor', GameConstants.StoneType.Obsidian_stone),
        ],
        'base': {
            'hitpoints': 70,
            'attack': 110,
    ...
    },
    {
        ...
        'eggCycles': 20,
        'evolutions': [
            new LevelEvolution('Quilava', 'Typhlosion', 36),
            // new RegionLevelEvolution(GameConstants.Region.hisui, 'Quilava', 'Hisuian Typhlosion', 36),
        ],
        'base': {
            'hitpoints': 58,
            'attack': 64,
    ...
    //     'levelType': LevelType.mediumfast,
    //     'evolutions': [ new LevelEvolution('Hisuian Qwilfish', 'Overqwil', 20)],
    //     'exp': 88,
    //     'eggCycles': 20,
    //     'base': {
    //         'hitpoints': 65,
    ...
    },
    {
        ...
        'type': [PokemonType.Normal],
        'levelType': LevelType.mediumfast,
        // 'evolutions': [new RegionLevelEvolution(GameConstants.Region.hisui, 'Ursaring', 'Ursaluna', 30)],
        'exp': 175,
        'eggCycles': 20,
        'base': {
            'hitpoints': 90,
    ...
    },
    {
        ...
        'type': [PokemonType.Normal],
        'levelType': LevelType.slow,
        // 'evolutions': [new RegionLevelEvolution(GameConstants.Region.hisui, 'Stantler', 'Wyrdeer', 30)],
        'exp': 163,
        'eggCycles': 20,
        'base': {
            'hitpoints': 73,
    ...
    },
    {
        ...
        'catchRate': 45,
        'evolutions': [
            new LevelEvolution('Dewott', 'Samurott', 36),
            // new RegionLevelEvolution(GameConstants.Region.hisui, 'Dewott', 'Hisuian Samurott', 36)
        ],
        'base': {
            'hitpoints': 75,
            'attack': 75,
    ...
    },
    {
        ...
        'catchRate': 190,
        'evolutions': [
            new StoneEvolution('Petilil', 'Lilligant', GameConstants.StoneType.Sun_stone),
            // new RegionStoneEvolution(GameConstants.Region.hisui, 'Petilil', 'Hisuian Lilligant', GameConstants.StoneType.Sun_stone)
        ],
        'base': {
            'hitpoints': 45,
            'attack': 35,
    ...
    //     'eggCycles': 40,
    //     'levelType': LevelType.mediumfast,
    //     'evolutions': [new RegionLevelEvolution(GameConstants.Region.hisui, 'Basculin (White-Striped)', 'Basculegion', 20)],
    //     'exp': 161,
    //     'catchRate': 25,
    //     'base': {
    //         'hitpoints': 70,
    ...
    },
    {
        ...
        'catchRate': 190,
        'evolutions': [
            new LevelEvolution('Rufflet', 'Braviary', 54),
            // new RegionLevelEvolution(GameConstants.Region.hisui, 'Rufflet', 'Hisuian Braviary', 54),
        ],
        'base': {
            'hitpoints': 70,
            'attack': 83,
    ...
    },
    {
        ...
        'catchRate': 45,
        'evolutions': [
            new LevelEvolution('Goomy', 'Sliggoo', 40),
            // new RegionLevelEvolution(GameConstants.Region.hisui, 'Goomy', 'Hisuian Sliggoo', 40)
        ],
        'base': {
            'hitpoints': 45,
            'attack': 50,
    ...
    //     'exp': 158,
    //     'catchRate': 45,
    //     'evolutions': [new WeatherRestrictedLevelEvolution('Hisuian Sliggoo', 'Hisuian Goodra', 50, [WeatherType.Rain, WeatherType.Fog])],
    //     'base': {
    //         'hitpoints': 68,
    //         'attack': 75,
    //         'specialAttack': 83,
    ...
    },
    {
        ...
        'catchRate': 190,
        'evolutions': [
            new LevelEvolution('Bergmite', 'Avalugg', 37),
            // new RegionLevelEvolution(GameConstants.Region.hisui, 'Bergmite', 'Hisuian Avalugg', 37)
        ],
        'base': {
            'hitpoints': 55,
            'attack': 69,
    ...
    },
    {
        ...
        'catchRate': 45,
        'evolutions': [
            new LevelEvolution('Dartrix', 'Decidueye', 34),
            // new RegionLevelEvolution(GameConstants.Region.hisui, 'Dartrix', 'Hisuian Decidueye', 36)
        ],
        'base': {
            'hitpoints': 78,
            'attack': 75,
    ...
    //     'name': 'Snealer',
    //     'nativeRegion': GameConstants.Region.hisui,
    //     'type': [PokemonType.Figthing, PokemonType.Poison],
    //     'eggCycles': 0,
    //     'levelType': LevelType.slow,
    //     'exp': 0,
    //     'catchRate': 135,
