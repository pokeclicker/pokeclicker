...
pokemonList.forEach(p => {
    ...
    (p as PokemonListData).gender = (p as PokemonListData).gender === undefined ? {'type': GameConstants.Genders.MaleFemale, 'ratio': 0.5, 'visualDifference': false} : (p as PokemonListData).gender;
    ...
    (p as PokemonListData).gender.ratio = (p as PokemonListData).gender.ratio === undefined ? 0.5 : (p as PokemonListData).gender.ratio;
