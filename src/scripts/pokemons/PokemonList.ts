...
const pokemonList = createPokemonArray(
    ...
    },
    {
        ...
        'evolutions': [
            ...
            new DungeonRestrictedLevelEvolution('Mt. Moon', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Rock Tunnel', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Digletts Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Seafoam Islands', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Victory Road', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Cerulean Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Union Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Slowpoke Well', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Whirl Islands', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Mt Mortar', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Ice Path', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Dark Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Mt Silver', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Rusturf Tunnel', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Granite Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Fiery Path', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Meteor Falls', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Shoal Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Cave of Origin', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Seafloor Cavern', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Victory Road Hoenn', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Sealed Chamber', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Oreburgh Gate', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Ravaged Path', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Wayward Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Mt. Coronet South', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Iron Island', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Mt. Coronet North', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Victory Road Sinnoh', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Stark Mountain', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Relic Passage', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Chargestone Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Mistralton Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Reversal Mountain', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Seaside Cave', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Giant Chasm', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Cave of Being', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Victory Road Unova', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Twist Mountain', 'Burmy (plant)', 'Burmy (sand)', 2),
            new DungeonRestrictedLevelEvolution('Power Plant', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Pokemon Tower', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Pokemon Mansion', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Sprout Tower', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Tin Tower', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Mt. Pyre', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Old Chateau', 'Burmy (plant)', 'Burmy (trash)', 2),
            new DungeonRestrictedLevelEvolution('Snowpoint Temple', 'Burmy (plant)', 'Burmy (trash)', 2),
        ],
        'base': {
            'hitpoints': 40,
            'attack': 29,
