...
SpecialEvents.newEvent('Lunar New Year', 'Encounter Fancy Pattern Vivillon for a limited time roaming Kalos.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.January, 24, 1), () => {
        RoamingPokemonList.add(GameConstants.Region.kalos, 0, new RoamingPokemon('Vivillon (Fancy)'));
    },
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.February, 7, 23), () => {
...
SpecialEvents.newEvent('Hoopa Day', 'The Mischief Pokémon unleashes his tricks upon the world.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.April, 1, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.April, 2, 1), () => {
...
SpecialEvents.newEvent('Easter', 'Encounter Surprise Togepi for a limited time with a dedicated Quest Line.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.April, 8, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.April, 29, 23), () => {
        // do not end questline, so ppl can finish it
    }
);
// First Event
SpecialEvents.newEvent('Flying Pikachu', 'Encounter Flying Pikachu and Red Spearow for a limited time roaming Kanto.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.July, 6, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.July, 12, 23), () => {
...
SpecialEvents.newEvent('Mewtwo strikes back!', 'Encounter Armored Mewtwo for a limited time in Cerulean Cave.<br/>Encounter clone Pokémon roaming in Kanto.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.July, 18, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.July, 24, 23), () => {
...
SpecialEvents.newEvent('Halloween!', 'Encounter Spooky Pokémon for a limited time around Kanto, Johto and Hoenn.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.October, 30, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.November, 5, 23), () => {
...
SpecialEvents.newEvent('Let\'s GO!', 'Encounter special Eevee and Pikachu roaming in the Kanto region.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.November, 16, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.November, 23, 23), () => {
...
SpecialEvents.newEvent('Merry Christmas!', 'Encounter Santa Snorlax roaming the regions and discover the Grinch of Ilex Forest.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.December, 24, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.December, 30, 23), () => {
...
SpecialEvents.newEvent('Golden Week', 'Enjoy your time off in the "Golden Week"! Travel tip: Visit the Flower Paradise in Sinnoh on your well earned vacation and enjoy the bloom of roses.',
    // Start
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.April, 29, 1), () => {
    ...
    // End
    new Date(new Date().getFullYear(), GameConstants.MonthOfYear.May, 6, 23), () => {
