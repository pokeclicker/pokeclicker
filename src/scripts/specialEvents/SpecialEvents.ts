    ...
    addEvents(): void {
        ...
        */
        ...
        RouteData.ts:
            Santa Jynx
        */
        this.newEvent('Merry Christmas!', 'Encounter Santa Snorlax roaming the regions, discover the Grinch of Ilex Forest and the Snowman of Seafoam Islands or enjoy presents at Bill\'s House.',
            // Start
