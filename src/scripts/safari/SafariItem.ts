...
class SafariItemController {
    private static list: Record<GameConstants.Region, Array<SafariItemWeighed>> = {
        [GameConstants.Region.kanto]: [
            {item: {id: 'Razz', type: ItemType.berry}, weight: 1.95},
            {item: {id: 'Nanab', type: ItemType.berry}, weight: 1.95},
            {item: {id: 'Pinap', type: ItemType.berry}, weight: 1.95},
            {item: {id: 'Sitrus', type: ItemType.berry}, weight: 1.95},
            {item: {id: 'Oran', type: ItemType.berry}, weight: 1.95},
            ...
            {item: {id: 'RareCandy', type : ItemType.item}, weight : 0.25},
        ...
        [GameConstants.Region.kalos]: [
            {item: {id: 'Mago', type: ItemType.berry}, weight: 2.1},
            {item: {id: 'Iapapa', type: ItemType.berry}, weight: 2.1},
            {item: {id: 'Hondew', type: ItemType.berry}, weight: 2.1},
            {item: {id: 'Tamato', type: ItemType.berry}, weight: 2.1},
            {item: {id: 'Durin', type: ItemType.berry}, weight: 2.1},
