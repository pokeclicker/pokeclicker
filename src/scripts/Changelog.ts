...
const changelogItems = [
    ...
    new Changelog(changelogType.NEW, 'Can now sort Pokemon list by Breeding Efficiency'),
    new Changelog(changelogType.NEW, 'Can now sort Pokemon list by Egg Steps'),
