...
class Party implements Feature {
    ...
    gainPokemon(pokemon: PartyPokemon, shiny = false) {
        ...
        if (shiny) {
            ...
            App.game.logbook.newEntry(logBookType.CAUGHT, `You have captured a shiny ${pokemon.name}!`);
        }
        ...
        App.game.logbook.newEntry(logBookType.CAUGHT, `You have captured ${GameHelper.anOrA(pokemon.name)} ${pokemon.name}!`);
