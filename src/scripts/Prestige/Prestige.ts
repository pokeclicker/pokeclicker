class Prestige {
    ...
    public static initialize() {
        ...
        this.addUpgrade(new PrestigeUpgrade(1, '[Farm]<br/>Harvest time decreased by 33%', 2, GameConstants.PrestigeType.Easy, 0.77));
        ...
        this.addUpgrade(new PrestigeUpgrade(17, '[General]<br/>Seed droprate + 20%', 2, GameConstants.PrestigeType.Easy, 1.2));
        this.addUpgrade(new PrestigeUpgrade(18, '[Dungeons]<br/>Dungeons contain +1 treasure', 3, GameConstants.PrestigeType.Easy, 1));
        this.addUpgrade(new PrestigeUpgrade(19, '[General]<br/>Catch time -250ms', 7, GameConstants.PrestigeType.Medium, -250));
        this.addUpgrade(new PrestigeUpgrade(20, '[Breeding]<br/>Egg slot cost halved', 3, GameConstants.PrestigeType.Easy, 0.5));
        this.addUpgrade(new PrestigeUpgrade(21, '[Oak Items]<br/>Oak item xp gain increased by 30%', 2, GameConstants.PrestigeType.Easy, 1.3));
        this.addUpgrade(new PrestigeUpgrade(22, '[General]<br/>Gain 20% more money', 1, GameConstants.PrestigeType.Easy, 1.2));
        this.addUpgrade(new PrestigeUpgrade(23, '[Dungeons]<br/>Dungeon enemies drop 3 more shards', 2, GameConstants.PrestigeType.Easy, 3));
        this.addUpgrade(new PrestigeUpgrade(24, '[Gyms]<br/>Gym time limit is +10s', 5, GameConstants.PrestigeType.Medium, 1e4));
