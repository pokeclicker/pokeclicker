class Prestige {
    ...
    public static initialize() {
        ...
        this.addUpgrade(new PrestigeUpgrade(7, '______', 2, GameConstants.PrestigeType.Hard, -0.33));
        this.addUpgrade(new PrestigeUpgrade(8, '______', 2, GameConstants.PrestigeType.Easy, -0.33));
        this.addUpgrade(new PrestigeUpgrade(9, '[Farm]<br/>Fertilizer effect +20%', 2, GameConstants.PrestigeType.Easy, -0.33));
        this.addUpgrade(new PrestigeUpgrade(10, '______', 6, GameConstants.PrestigeType.Hard, -0.33));
        ...
        this.addUpgrade(new PrestigeUpgrade(13, '______', 3, GameConstants.PrestigeType.Hard, -0.33));
        ...
        this.addUpgrade(new PrestigeUpgrade(28, '______', 5, GameConstants.PrestigeType.Medium, -0.33));
        this.addUpgrade(new PrestigeUpgrade(29, '______', 2, GameConstants.PrestigeType.Easy, -0.33));
        this.addUpgrade(new PrestigeUpgrade(30, '______', 2, GameConstants.PrestigeType.Easy, -0.33));
        ...
        this.addUpgrade(new PrestigeUpgrade(34, '______', 2, GameConstants.PrestigeType.Easy, -0.33));
