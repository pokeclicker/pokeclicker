...
class BattleFrontierBattle extends Battle {
    ...
    public static pokemonAttack() {
        ...
        this.enemyPokemon().damage(App.game.party.calculatePokemonAttack(this.enemyPokemon().type1, this.enemyPokemon().type2, true, undefined, undefined, undefined, true));
        if (!this.enemyPokemon().isAlive()) {
            this.defeatPokemon();
        }
    }
