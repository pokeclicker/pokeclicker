...
BattleFrontierMilestones.addMilestone(new BattleFrontierMilestonePokemon(666, 'Vivillon (Poké Ball)', new MultiRequirement([
    new QuestLineStepCompletedRequirement('The Great Vivillon Hunt!', 34),
    new QuestLineCompletedRequirement('The Great Vivillon Hunt!', GameConstants.AchievementOption.less),
])));
