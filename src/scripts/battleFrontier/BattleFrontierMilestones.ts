...
BattleFrontierMilestones.addMilestone(new BattleFrontierMilestonePokemon(2000, 'Mismagius (Illusion)', new MultiRequirement([new MaxRegionRequirement(GameConstants.Region.sinnoh), new ObtainedPokemonRequirement('Mismagius')])));
