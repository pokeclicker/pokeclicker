...
class Farming implements Feature {
    ...
    initialize(): void {
        ...
        // Lum
        this.mutations.push(
            new GrowNearBerryMutation(0.001, BerryType.Lum, [BerryType.Cheri, BerryType.Chesto, BerryType.Pecha, BerryType.Rawst, BerryType.Aspear, BerryType.Leppa, BerryType.Oran, BerryType.Sitrus], {
        ...
        // Yache
        this.mutations.push(
            new EvolveNearBerryStrictMutation(0.0001, BerryType.Yache, BerryType.Passho, {}, PlotStage.Seed, {
        ...
        this.mutations.push(
            new GrowNearBerryStrictMutation(0.0001, BerryType.Tanga, berryReqs, {
        ...
        this.mutations.push(
            new GrowNearBerryStrictMutation(0.0001, BerryType.Babiri, berryReqs, {
        ...
        this.mutations.push(
            new EvolveNearBerryMinMutation(0.0001, BerryType.Chilan, BerryType.Chople, berryReqs, {
        ...
        // Micle
        this.mutations.push(
            new FieldFlavorMutation(0.0003, BerryType.Micle, [0, 600, 0, 0, 0], {
        ...
        // Custap
        this.mutations.push(
            new FieldFlavorMutation(0.0003, BerryType.Custap, [0, 0, 600, 0, 0], {
        ...
        // Jaboca
        this.mutations.push(
            new FieldFlavorMutation(0.0003, BerryType.Jaboca, [0, 0, 0, 600, 0], {
        ...
        // Rowap
        this.mutations.push(
            new FieldFlavorMutation(0.0003, BerryType.Rowap, [0, 0, 0, 0, 600], {
        ...
        // Liechi
        this.mutations.push(
            new FieldMutation(0.00001, BerryType.Liechi, BerryType.Passho, undefined, {
                unlockReq: () => App.game?.statistics?.pokemonCaptured[PokemonHelper.getPokemonByName('Kyogre').id](),
            })
        );
        // Ganlon
        this.mutations.push(
            new FieldMutation(0.00001, BerryType.Ganlon, BerryType.Shuca, undefined, {
                unlockReq: () => App.game?.statistics?.pokemonCaptured[PokemonHelper.getPokemonByName('Groudon').id](),
            })
        );
        // Salac
        this.mutations.push(
            new FieldMutation(0.00001, BerryType.Salac, BerryType.Coba, undefined, {
        ...
        // Enigma Mutations
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Liechi, BerryType.Passho, [BerryType.Enigma], {
                showHint: false,
                unlockReq: () => App.game.farming.unlockedBerries[BerryType.Liechi](),
            })
        );
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Ganlon, BerryType.Shuca, [BerryType.Enigma], {
                showHint: false,
                unlockReq: () => App.game.farming.unlockedBerries[BerryType.Ganlon](),
            })
        );
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Salac, BerryType.Coba, [BerryType.Enigma], {
                showHint: false,
                unlockReq: () => App.game.farming.unlockedBerries[BerryType.Salac](),
            })
        );
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Petaya, BerryType.Payapa, [BerryType.Enigma], {
                showHint: false,
                unlockReq: () => App.game.farming.unlockedBerries[BerryType.Petaya](),
            })
        );
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Apicot, BerryType.Chilan, [BerryType.Enigma], {
                showHint: false,
                unlockReq: () => App.game.farming.unlockedBerries[BerryType.Apicot](),
            })
        );
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Lansat, BerryType.Roseli, [BerryType.Enigma], {
                showHint: false,
                unlockReq: () => App.game.farming.unlockedBerries[BerryType.Lansat](),
            })
        );
        this.mutations.push(
            new EvolveNearBerryMutation(0.0004, BerryType.Starf, BerryType.Haban, [BerryType.Enigma], {
                showHint: false,
        ...
        // Kasib
        this.mutations.push(
            new BlankMutation(0, BerryType.Kasib, {
        ...
        // Starf
        this.mutations.push(
            new BlankMutation(0, BerryType.Starf, {
    ...
    harvestPlot(plot: Plot, suppressResetAura = false): void {
