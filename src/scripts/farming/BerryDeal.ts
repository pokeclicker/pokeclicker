class BerryDeal {
    ...
    private static randomEvoItem(): Item {
        const evoItem = SeededRand.fromArray(GameHelper.enumStrings(GameConstants.StoneType).filter(name => !(['None', 'Black_DNA', 'White_DNA', 'Black_mane_hair', 'White_mane_hair']).includes(name)));
