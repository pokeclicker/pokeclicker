...
class ZMoves implements Feature {
    ...
    static requirement = App.game.keyItems.hasKeyItem(KeyItemType['Z-Power_Ring']);
    ...
    canAccess(): boolean {
        return ZMoves.requirement || GameConstants.zCrystalItemType.some(crystal => player.itemList[crystal]() > 0);
    }
