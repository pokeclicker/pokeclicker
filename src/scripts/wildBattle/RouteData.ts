...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Carracosta'], new ObtainedPokemonRequirement(pokemonMap.Carracosta), new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Thunderstorm])),
      ],
    }),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Armaldo'], new ObtainedPokemonRequirement(pokemonMap.Armaldo), new WeatherRequirement([WeatherType.Rain, WeatherType.Thunderstorm])),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Amaura'], new ObtainedPokemonRequirement(pokemonMap.Amaura)),
          new SpecialRoutePokemon(['Aurorus'], new ObtainedPokemonRequirement(pokemonMap.Aurorus), new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Fog])),
      ],
    }),
    [new RouteKillRequirement(10, GameConstants.Region.galar, 48)],
    undefined,
