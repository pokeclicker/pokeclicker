...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        land: ['Yamper', 'Wooloo', 'Milcery', 'Meowth (Galar)', 'Budew', 'Cutiefly', 'Ferroseed', 'Joltik', 'Pikachu', 'Eevee', 'Elecktrike', 'Pumpkaboo', 'Diglett'],
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        land: ['Dottler', 'Applin', 'Eldegoss', "Farfetch'd (Galar)", 'Wobuffet', 'Drifloon', 'Minccino', 'Spritzee', 'Swirlix', 'Stufful', 'Espurr', 'Nincada', 'Dewpider', 'Nuzleaf', 'Lombre'],
