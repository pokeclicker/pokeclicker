...
dungeonList['Max Lair'] = new Dungeon('Max Lair',
    ...
    [
        ...
        new DungeonBossPokemon('Gigantamax Melmetal', 164353300, 70, { hide: true, weight: 2, requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', () => maxLairQuestStepRandomIndex(10)), new ObtainedPokemonRequirement('Gigantamax Melmetal', true)]) }),
        new DungeonBossPokemon('Gigantamax Melmetal', 164353300, 70, { hide: true, requirement: new ObtainedPokemonRequirement('Gigantamax Melmetal') }),
        ...
        new DungeonBossPokemon('Gigantamax Urshifu (Single Strike)', 164353300, 70, { hide: true, weight: 2, requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', () => maxLairQuestStepRandomIndex(28)), new ObtainedPokemonRequirement('Gigantamax Urshifu (Single Strike)', true)]) }),
        new DungeonBossPokemon('Gigantamax Urshifu (Single Strike)', 164353300, 70, { hide: true, requirement: new ObtainedPokemonRequirement('Gigantamax Urshifu (Single Strike)') }),
        new DungeonBossPokemon('Gigantamax Urshifu (Rapid Strike)', 164353300, 70, { hide: true, weight: 2, requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', () => maxLairQuestStepRandomIndex(29)), new ObtainedPokemonRequirement('Gigantamax Urshifu (Rapid Strike)', true)]) }),
        new DungeonBossPokemon('Gigantamax Urshifu (Rapid Strike)', 164353300, 70, { hide: true, requirement: new ObtainedPokemonRequirement('Gigantamax Urshifu (Rapid Strike)') }),
