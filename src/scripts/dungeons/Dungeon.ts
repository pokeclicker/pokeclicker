...
class Dungeon {
    ...
    get encounterList(): EncounterInfo[] {
        const encounterInfo: Array<EncounterInfo> = [];
...
dungeonList['Viridian Forest'] = new Dungeon(
    ...
    102,
    [new DungeonBossPokemon('Pikachu', 510, 7), new DungeonTrainer('Bug Catcher', [new GymPokemon('Weedle', 510, 9)], { weight: 1 }, 'Sammy')],
    50,
    1,
    5
);
...
dungeonList['Mt. Moon'] = new Dungeon(
    ...
    834,
    [new DungeonBossPokemon('Kabuto', 4170, 12, { requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Mt. Moon')) }), new DungeonBossPokemon('Omanyte', 4170, 12, { requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Mt. Moon')) }), new DungeonTrainer('Super Nerd', [new GymPokemon('Grimer', 2780, 12), new GymPokemon('Voltorb', 2780, 12), new GymPokemon('Koffing', 2780, 12)], { weight: 1 }, 'Miguel')],
    75,
    4,
    10
);
...
dungeonList['Rock Tunnel'] = new Dungeon(
    ...
    4117,
    [new DungeonBossPokemon('Onix', 20585, 17), new DungeonTrainer('Picnicker', [new GymPokemon('Pidgey', 13586, 19), new GymPokemon('Rattata', 13586, 19), new GymPokemon('Rattata', 13586, 19), new GymPokemon('Bellsprout', 13586, 19)], { weight: 1 }, 'Ariana')],
    500,
    5,
    15
);
...
dungeonList['Victory Road'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    24595,
    [new DungeonBossPokemon('Machoke', 122975, 42), new DungeonBossPokemon('Moltres', 184462, 50), new DungeonTrainer('Cool Couple', [new GymPokemon('Nidoking', 122975, 45), new GymPokemon('Nidoqueen', 122975, 45)], { weight: 1 }, 'Ray & Tyra')],
    2000,
    20,
    40
);
...
dungeonList['Ruins of Alph'] = new Dungeon(
    ...
    60600,
    [new DungeonBossPokemon('Unown (A)', 280000, 14), new DungeonBossPokemon('Unown (F)', 280000, 14), new DungeonBossPokemon('Unown (H)', 280000, 14), new DungeonBossPokemon('Unown (L)', 280000, 14), new DungeonBossPokemon('Unown (N)', 280000, 14), new DungeonBossPokemon('Unown (P)', 280000, 14), new DungeonBossPokemon('Unown (U)', 280000, 14)],
    3000,
    32,
    7
);
...
dungeonList['Ilex Forest'] = new Dungeon(
    ...
    82200,
    [new DungeonBossPokemon('Noctowl', 340000, 30), new DungeonBossPokemon('Beedrill', 340000, 30), new DungeonBossPokemon('Butterfree', 340000, 30), new DungeonBossPokemon('Celebi', 800000, 50, { requirement: new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion) })],
    4000,
    34,
    15
);
...
dungeonList['Petalburg Woods'] = new Dungeon(
    ...
    380000,
    [new DungeonBossPokemon('Slakoth', 860000, 10, { requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Petalburg Woods')) }), new DungeonTrainer('Team Aqua Grunt', [new GymPokemon('Poochyena', 860000, 9)], { weight: 1 }, undefined, '(male)')],
    12000,
    101,
    5
);
...
dungeonList['Rusturf Tunnel'] = new Dungeon(
    'Rusturf Tunnel',
    [{ pokemon: 'Whismur', options: { weight: 4 } }, new DungeonTrainer('Hiker', [new GymPokemon('Geodude', 14000, 16), new GymPokemon('Geodude', 14000, 16), new GymPokemon('Machop', 14000, 16)], { weight: 1 }, 'Mike')],
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    400000,
...
dungeonList['Meteor Falls'] = new Dungeon(
    'Meteor Falls',
    [{ pokemon: 'Zubat', options: { weight: 0.8 } }, { pokemon: 'Golbat', options: { weight: 0.8 } }, { pokemon: 'Goldeen', options: { weight: 0.8 } }, { pokemon: 'Magikarp', options: { weight: 0.8 } }, { pokemon: 'Barboach', options: { weight: 0.8 } }, new DungeonTrainer('Old Couple', [new GymPokemon('Medicham', 18000, 39), new GymPokemon('Hariyama', 18000, 39)], { weight: 1 }, 'John and Jay')],
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    443000,
    [new DungeonBossPokemon('Solrock', 1240000, 20), new DungeonBossPokemon('Lunatone', 1240000, 20), new DungeonTrainer('Dragon Tamer', [new GymPokemon('Altaria', 640000, 37), new GymPokemon('Altaria', 640000, 37)], { weight: 1 }, 'Nicolas')],
    18000,
    101,
    5
);
...
dungeonList['Mt. Chimney'] = new Dungeon(
    'Mt. Chimney',
    [new DungeonTrainer('Team Magma Grunt', [new GymPokemon('Numel', 20000, 20)], { weight: 1 }, undefined, '(female)'), new DungeonTrainer('Team Magma Grunt', [new GymPokemon('Zubat', 20000, 20)], { weight: 1 }, undefined, '(male)'), new DungeonTrainer('Magma Admin', [new GymPokemon('Numel', 18000, 18), new GymPokemon('Poochyena', 20000, 20), new GymPokemon('Numel', 22000, 22), new GymPokemon('Zubat', 22000, 22)], { weight: 1 }, 'Tabitha')],
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    460000,
    [new DungeonTrainer('Magma Leader', [new GymPokemon('Mightyena', 450000, 24), new GymPokemon('Zubat', 450000, 24), new GymPokemon('Camerupt', 470000, 25)], { weight: 1 }, 'Maxie')],
    20000,
    101,
    5
);
...
dungeonList['Weather Institute'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    470000,
    [new DungeonTrainer('Aqua Admin', [new GymPokemon('Carvanha', 910000, 28), new GymPokemon('Mightyena', 910000, 28)], { weight: 1 }, 'Shelly', '(shelly)')],
    26000,
    101,
    5
);
...
dungeonList['Magma Hideout'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    490000,
    [new DungeonTrainer('Magma Leader', [new GymPokemon('Mightyena', 630000, 37), new GymPokemon('Crobat', 640000, 38), new GymPokemon('Camerupt', 650000, 39)], { weight: 1 }, 'Maxie')],
    29000,
    101,
    5
);
...
dungeonList['Cave of Origin'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    590000,
    [new DungeonBossPokemon('Exploud', 2000000, 50), new DungeonBossPokemon('Kyogre', 4700000, 100, { requirement: new GymBadgeRequirement(BadgeEnums.Elite_HoennChampion) }), new DungeonBossPokemon('Groudon', 4700000, 100, { requirement: new GymBadgeRequirement(BadgeEnums.Elite_HoennChampion) })],
    34000,
    101,
    5
);
...
dungeonList['Seafloor Cavern'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    530000,
    [new DungeonTrainer('Aqua Leader', [new GymPokemon('Mightyena', 700000, 41), new GymPokemon('Crobat', 700000, 41), new GymPokemon('Sharpedo', 900000, 43)], { weight: 1 }, 'Archie')],
    32000,
    101,
    5
);
...
dungeonList['Victory Road Hoenn'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
    560000,
    [new DungeonTrainer('PKMN Trainer', [new GymPokemon('Altaria', 680000, 44), new GymPokemon('Delcatty', 670000, 43), new GymPokemon('Roselia', 680000, 44), new GymPokemon('Magneton', 650000, 41), new GymPokemon('Gardevoir', 690000, 45)], { weight: 1 }, 'Wally', '(wally)')],
    37000,
    101,
    5
);
...
dungeonList['Mt. Coronet South'] = new Dungeon(
    ...
    951500,
    [new DungeonBossPokemon('Machoke', 4000000, 35), new DungeonBossPokemon('Bronzong', 4000000, 50), new DungeonBossPokemon('Absol', 4000000, 50)],
    60500,
    201,
    20
);
...
dungeonList['Solaceon Ruins'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Lucky_incense],
    960000,
    [new DungeonBossPokemon('Unown (A)', 4100000, 30), new DungeonBossPokemon('Unown (E)', 4100000, 30), new DungeonBossPokemon('Unown (L)', 4100000, 30), new DungeonBossPokemon('Unown (N)', 4100000, 30), new DungeonBossPokemon('Unown (U)', 4100000, 30)],
    62500,
    209,
    100
);
...
dungeonList['Mt. Coronet North'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Lucky_incense],
    1015000,
    [new DungeonBossPokemon('Graveler', 4600000, 35), new DungeonBossPokemon('Feebas', 4600000, 50), new DungeonBossPokemon('Medicham', 4600000, 50)],
    69500,
    201,
    20
);
...
dungeonList['Hall of Origin'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2653000,
    [new DungeonBossPokemon('Arceus (normal)', 13000000, 100), new DungeonBossPokemon('Slaking', 10000000, 100), new DungeonBossPokemon('Snorlax', 10000000, 100), new DungeonBossPokemon('Shuckle', 10000000, 100), new DungeonBossPokemon('Blissey', 10000000, 100)],
    106500,
    230,
    100
);
...
dungeonList['Castelia Sewers'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2603000,
    [new DungeonTrainer('Team Plasma Grunt', [new GymPokemon('Sandile', 15000000, 16)], { weight: 1 }, undefined, '(male)'), new DungeonTrainer('Team Plasma Grunt', [new GymPokemon('Scraggy', 15000000, 16)], { weight: 1 }, undefined, '(male)')],
    146500,
    4,
    100
);
...
dungeonList['Relic Passage'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2803000,
    [new DungeonBossPokemon('Onix', 16000000, 100), new DungeonBossPokemon('Drilbur', 16000000, 100)],
    156500,
    25,
    100
);
...
dungeonList['Relic Castle'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    3003000,
    [new DungeonTrainer('Psychic', [new GymPokemon('Sigilyph', 18000000, 23)], { weight: 1 }, 'Perry', '(male)'), new DungeonBossPokemon('Volcarona', 18000000, 100)],
    166500,
    25,
    100
);
...
dungeonList['Lostlorn Forest'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    3203000,
    [new DungeonBossPokemon('Heracross', 19000000, 100), new DungeonBossPokemon('Pinsir', 19000000, 100), new DungeonBossPokemon('Emolga', 21000000, 100)],
    176500,
    16,
    100
);
...
dungeonList['Mistralton Cave'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    3603000,
    [new DungeonBossPokemon('Drilbur', 23000000, 100), new DungeonBossPokemon('Axew', 24000000, 100), new DungeonBossPokemon('Cobalion', 25000000, 100)],
    196500,
    6,
    100
);
...
dungeonList['Celestial Tower'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    3803000,
    [new DungeonBossPokemon('Litwick', 25000000, 100), new DungeonTrainer('Psychic', [new GymPokemon('Elgyem', 14000000, 35), new GymPokemon('Duosion', 14000000, 35)], { weight: 1 }, 'Bryce', '(male)'), new DungeonTrainer('Psychic', [new GymPokemon('Yamask', 14000000, 35), new GymPokemon('Gothorita', 14000000, 35)], { weight: 1 }, 'Sarah', '(female)')],
    206500,
    7,
    100
);
...
dungeonList['Reversal Mountain'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    4003000,
    [new DungeonBossPokemon('Cacturne', 24000000, 100), new DungeonBossPokemon('Excadrill', 26000000, 100), new DungeonBossPokemon('Heatran', 30000000, 100, { requirement: new GymBadgeRequirement(BadgeEnums.Elite_UnovaChampion) })],
    226500,
    14,
    100
);

dungeonList['Team Plasma Assault'] = new Dungeon(
    'Team Plasma Assault',
    [
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    4603000,
    [new DungeonTrainer('Team Plasma', [new GymPokemon('Cryogonal', 11000000, 46), new GymPokemon('Cryogonal', 11000000, 46), new GymPokemon('Weavile', 12000000, 48)], { weight: 1 }, 'Zinzolin', '(zinzolin)')],
    241500,
    20,
    100
);
...
dungeonList['Seaside Cave'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    4203000,
    [new DungeonBossPokemon('Eelektrik', 28000000, 100), new DungeonBossPokemon('Crustle', 28000000, 100)],
    246500,
    21,
    100
);
...
dungeonList['Plasma Frigate'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    4603000,
    [new DungeonTrainer('Team Plasma', [new GymPokemon('Cryogonal', 12000000, 48), new GymPokemon('Cryogonal', 12000000, 48), new GymPokemon('Weavile', 13000000, 50)], { weight: 1 }, 'Zinzolin', '(zinzolin)')],
    257500,
    20,
    100
);
...
dungeonList['Victory Road Unova'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5003000,
    [new DungeonBossPokemon('Golurk', 44000000, 100), new DungeonBossPokemon('Terrakion', 45000000, 100), new DungeonBossPokemon('Audino', 45000000, 100), new DungeonBossPokemon('Druddigon', 44000000, 100)],
    326500,
    23,
    100
);
...
dungeonList['Twist Mountain'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5203000,
    [new DungeonBossPokemon('Durant', 48000000, 100), new DungeonBossPokemon('Cryogonal', 48000000, 100), new DungeonBossPokemon('Heatmor', 48000000, 100), new DungeonBossPokemon('Regigigas', 50000000, 100)],
    356500,
    7,
    100
);
...
dungeonList['Dragonspiral Tower'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5203000,
    [new DungeonBossPokemon('Dragonite', 48000000, 100), new DungeonBossPokemon('Reshiram', 48000000, 100), new DungeonBossPokemon('Druddigon', 48000000, 100), new DungeonBossPokemon('Zekrom', 50000000, 100)],
    356500,
    7,
    100
);
...
dungeonList['Moor of Icirrus'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5203000,
    [new DungeonBossPokemon('Keldeo', 50000000, 100), new DungeonBossPokemon('Seismitoad', 48000000, 100), new DungeonBossPokemon('Whiscash', 48000000, 100)],
    356500,
    8,
    100
);
...
dungeonList['Pinwheel Forest'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5203000,
    [new DungeonBossPokemon('Scolipede', 48000000, 100), new DungeonBossPokemon('Seismitoad', 48000000, 100), new DungeonBossPokemon('Virizion', 48000000, 100)],
    356500,
    3,
    100
);
dungeonList['Dreamyard'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5203000,
    [new DungeonBossPokemon('Audino', 48000000, 100), new DungeonBossPokemon('Dunsparce', 48000000, 100), new DungeonBossPokemon('Latias', 48000000, 100), new DungeonBossPokemon('Latios', 48000000, 100)],
    356500,
    3,
    100
);
...
dungeonList['Connecting Cave'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    6503370,
    [new DungeonTrainer('Pokémon Breeder', [new GymPokemon('Ducklett', 13374965, 12), new GymPokemon('Pikachu', 14465837, 12), new GymPokemon('Litleo', 17438602, 12), new GymPokemon('Oddish', 19365784, 12)], { weight: 1 }, 'Mercy', '(female)'), new DungeonBossPokemon('Axew', 59867590, 20)],
    475000,
    7,
    15
);
...
dungeonList['Glittering Cave'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    7037500,
    [new DungeonTrainer('Team Flare Grunt Duo', [new GymPokemon('Scraggy', 33084827, 20), new GymPokemon('Croagunk', 31937395, 20)], { weight: 1 }, undefined), new DungeonBossPokemon('Kangaskhan', 63749659, 20), new DungeonBossPokemon('Mawile', 61285398, 20)],
    505000,
    9,
    16
);
...
dungeonList['Kalos Power Plant'] = new Dungeon(
    'Kalos Power Plant', //keep going from here down
    [
...
dungeonList['Pokéball Factory'] = new Dungeon(
    'Pokéball Factory',
    [
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8173950,
    [new DungeonTrainer('Team Flare', [new GymPokemon('Manectric', 79385030, 41)], { weight: 1 }, 'Celosia'), new DungeonTrainer('Team Flare', [new GymPokemon('Liepard', 79284730, 41)], { weight: 1 }, 'Bryony')],
    615000,
    14,
    37
);
...
dungeonList['Lost Hotel'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8375300,
    [new DungeonTrainer('Punk Couple', [new GymPokemon('Garbodor', 42664500, 42), new GymPokemon('Pangoro', 42765500, 42)], { weight: 2 }, 'Zoya & Asa'), new DungeonBossPokemon('Rotom', 82376500, 38)],
    635000,
    15,
    37
);
...
dungeonList['Frost Cavern'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8537490,
    [new DungeonTrainer('Team Flare', [new GymPokemon('Houndoom', 87365830, 48)], { weight: 1 }, 'Mable'), new DungeonBossPokemon('Abomasnow', 85376500, 50)],
    665500,
    15,
    40
);
...
dungeonList['Terminus Cave'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8924330,
    [new DungeonTrainer('Pokémon Rangers', [new GymPokemon('Nidoqueen', 46659450, 51), new GymPokemon('Nidoking', 46654990, 51)], { weight: 3 }, 'Fern & Lee'), new DungeonBossPokemon('Zygarde', 92485360, 70, { requirement: new GymBadgeRequirement(BadgeEnums.Elite_KalosChampion) })],
    700000,
    18,
    45
);
...
dungeonList['Po Town'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2203000,
    [new DungeonBossPokemon('Pawniard', 8000000, 70), new DungeonBossPokemon('Masquerain', 8000000, 70), new DungeonBossPokemon('Pinsir', 8000000, 70), new DungeonBossPokemon('Haunter', 8000000, 70)],
    96500,
    201,
    35
);
...
dungeonList['Vast Poni Canyon'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2203000,
    [new DungeonBossPokemon('Kommo-o', 8000000, 70), new DungeonBossPokemon('Totem Kommo-o', 8000000, 70, { requirement: new GymBadgeRequirement(BadgeEnums.Elite_AlolaChampion) })],
    96500,
    201,
    35
);
...
dungeonList['Lake of Outrage'] = new Dungeon(
    ...
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2203000,
    [new DungeonBossPokemon('Hatterene', 8000000, 70), new DungeonBossPokemon('Perrserker', 8000000, 70), new DungeonBossPokemon('Barraskewda', 8000000, 70), new DungeonBossPokemon('Drakloak', 8000000, 70)],
    96500,
    201,
    35
);
