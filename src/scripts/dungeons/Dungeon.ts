...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    [
        ...
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Persian', 59132, 42),
                new GymPokemon('Ponyta', 59132, 42),
                new GymPokemon('Rapidash', 59132, 42),
                new GymPokemon('Vulpix', 59132, 42),
                new GymPokemon('Ninetales', 59132, 42),
            ], { weight: 1 }, 'Naomi', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Raticate', 59132, 42),
                new GymPokemon('Ivysaur', 59132, 42),
                new GymPokemon('Wartortle', 59132, 42),
                new GymPokemon('Charmeleon', 59132, 42),
                new GymPokemon('Charizard', 59132, 42),
            ], { weight: 1 }, 'Rolando', '(male)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Machoke', 59132, 43),
                new GymPokemon('Machop', 59132, 43),
                new GymPokemon('Machoke', 59132, 43),
            ], { weight: 1 }, 'Daisuke'),
        new DungeonTrainer('Juggler',
            [
                new GymPokemon('Drowzee', 59132, 41),
                new GymPokemon('Hypno', 59132, 41),
                new GymPokemon('Kadabra', 59132, 41),
                new GymPokemon('Kadabra', 59132, 41),
            ], { weight: 1 }, 'Nelson'),
        new DungeonTrainer('Tamer',
            [
                new GymPokemon('Persian', 59132, 44),
                new GymPokemon('Golduck', 59132, 44),
            ], { weight: 1 }, 'Vincent'),
        new DungeonTrainer('Juggler',
            [new GymPokemon('Mr. Mime', 59132, 48)],
            { weight: 1 }, 'Gregory'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Exeggutor', 59132, 42),
                new GymPokemon('Sandslash', 59132, 42),
                new GymPokemon('Cloyster', 59132, 42),
                new GymPokemon('Electrode', 59132, 42),
                new GymPokemon('Arcanine', 59132, 42),
            ], { weight: 1 }, 'George', '(male)'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Charmeleon', 59132, 40),
                new GymPokemon('Lapras', 59132, 40),
                new GymPokemon('Lickitung', 59132, 40),
            ], { weight: 1 }, 'Dawson'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Clefairy', 59132, 42),
                new GymPokemon('Jigglypuff', 59132, 42),
                new GymPokemon('Persian', 59132, 42),
                new GymPokemon('Dewgong', 59132, 42),
                new GymPokemon('Chansey', 59132, 42),
            ], { weight: 1 }, 'Alexa', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Kingler', 59132, 41),
                new GymPokemon('Poliwhirl', 59132, 42),
                new GymPokemon('Tentacruel', 59132, 42),
                new GymPokemon('Seadra', 59132, 42),
                new GymPokemon('Blastoise', 59132, 42),
            ], { weight: 1 }, 'Colby', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Bellsprout', 59132, 42),
                new GymPokemon('Weepinbell', 59132, 42),
                new GymPokemon('Victreebel', 59132, 42),
                new GymPokemon('Paras', 59132, 42),
                new GymPokemon('Parasect', 59132, 42),
...
dungeonList['Sprout Tower'] = new Dungeon('Sprout Tower',
    [
        ...
        new DungeonTrainer('Sage',
            [
                new GymPokemon('Bellsprout', 90383, 3),
                new GymPokemon('Bellsprout', 90383, 3),
                new GymPokemon('Bellsprout', 90383, 3),
            ], { weight: 1 }, 'Nico'),
        new DungeonTrainer('Sage',
        ...
        new DungeonTrainer('Sage',
            [new GymPokemon('Bellsprout', 90383, 6)],
            { weight: 1 }, 'Jin'),
        new DungeonTrainer('Sage',
            [new GymPokemon('Bellsprout', 90383, 6)],
            { weight: 1 }, 'Neal'),
        new DungeonTrainer('Sage',
            [
                new GymPokemon('Bellsprout', 90383, 7),
                new GymPokemon('Hoothoot', 90383, 7),
            ], { weight: 1 }, 'Troy'),
    ],
    [
        {loot: 'xClick', weight: 4},
...
dungeonList['Ruins of Alph'] = new Dungeon('Ruins of Alph',
    [
        ...
        new DungeonTrainer('Psychic',
            [new GymPokemon('Girafarig', 94430, 26)],
...
dungeonList['Union Cave'] = new Dungeon('Union Cave',
    [
        ...
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 98477, 4),
                new GymPokemon('Geodude', 98477, 6),
                new GymPokemon('Geodude', 98477, 8),
            ], { weight: 1 }, 'Russell'),
        new DungeonTrainer('Firebreather',
            [
                new GymPokemon('Koffing', 98477, 6),
                new GymPokemon('Koffing', 98477, 6),
            ], { weight: 1 }, 'Bill'),
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Slowpoke', 98477, 10)],
            { weight: 1 }, 'Larry'),
    ],
    [
        {loot: 'xAttack', weight: 4},
...
dungeonList['Slowpoke Well'] = new Dungeon('Slowpoke Well',
    [
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 106995, 9),
                new GymPokemon('Rattata', 106995, 9),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 106995, 9),
                new GymPokemon('Ekans', 106995, 11),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 106995, 7),
                new GymPokemon('Zubat', 106995, 9),
                new GymPokemon('Zubat', 106995, 9),
            ], { weight: 1 }, undefined, '(male)'),
    ],
...
dungeonList['Ilex Forest'] = new Dungeon('Ilex Forest',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Ledyba', 111470, 8),
                new GymPokemon('Paras', 111470, 10),
            ], { weight: 1 }, 'Wayne'),
    ],
    [
        {loot: 'xAttack', weight: 4},
...
dungeonList['Mt Mortar'] = new Dungeon('Mt Mortar',
    [
        ...
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Nidoking', 156195, 17),
                new GymPokemon('Nidoqueen', 156195, 17),
            ], { weight: 1 }, 'Miller'),
        new DungeonTrainer('Super Nerd',
            [new GymPokemon('Slowpoke', 156195, 19)],
            { weight: 1 }, 'Markus'),
        new DungeonTrainer('Super Nerd',
            [new GymPokemon('Seadra', 156195, 39)],
            { weight: 1 }, 'Hugh'),
    ],
    [
        {loot: 'xAttack', weight: 4},
...
dungeonList['Team Rockets Hideout'] = new Dungeon('Team Rockets Hideout',
    [
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 217052, 16),
                new GymPokemon('Rattata', 217052, 16),
                new GymPokemon('Rattata', 217052, 16),
                new GymPokemon('Rattata', 217052, 16),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Magnemite', 217052, 20),
                new GymPokemon('Magnemite', 217052, 20),
                new GymPokemon('Magnemite', 217052, 20),
            ], { weight: 1 }, 'Jed', '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Drowzee', 217052, 17),
                new GymPokemon('Zubat', 217052, 19),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 217052, 16),
                new GymPokemon('Grimer', 217052, 17),
                new GymPokemon('Rattata', 217052, 18),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Venonat', 217052, 18),
                new GymPokemon('Venonat', 217052, 18),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 217052, 17),
                new GymPokemon('Zubat', 217052, 17),
                new GymPokemon('Rattata', 217052, 17),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Ekans', 217052, 18),
                new GymPokemon('Gloom', 217052, 18),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Rocket Grunt',
        ...
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Koffing', 217052, 22),
                new GymPokemon('Koffing', 217052, 22),
            ], { weight: 1 }, 'Ross', '(male)'),
        new DungeonTrainer('Scientist',
...
dungeonList['Radio Tower'] = new Dungeon('Radio Tower',
    [
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Muk', 221601, 23),
                new GymPokemon('Koffing', 221601, 23),
                new GymPokemon('Rattata', 221601, 25),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Koffing', 221601, 24),
                new GymPokemon('Muk', 221601, 24),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Burglar',
            [
                new GymPokemon('Growlithe', 221601, 26),
                new GymPokemon('Koffing', 221601, 24),
            ], { weight: 1 }, 'Eddie'),
        new DungeonTrainer('Burglar',
            [
                new GymPokemon('Koffing', 221601, 23),
                new GymPokemon('Magmar', 221601, 25),
                new GymPokemon('Koffing', 221601, 23),
            ], { weight: 1 }, 'Duncan'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Gloom', 221601, 25),
                new GymPokemon('Gloom', 221601, 25),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Raticate', 221601, 24),
                new GymPokemon('Golbat', 221601, 24),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Grimer', 221601, 26),
                new GymPokemon('Weezing', 221601, 23),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Koffing', 221601, 25),
                new GymPokemon('Koffing', 221601, 25),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 221601, 21),
                new GymPokemon('Rattata', 221601, 21),
                new GymPokemon('Rattata', 221601, 21),
                new GymPokemon('Rattata', 221601, 21),
                new GymPokemon('Rattata', 221601, 21),
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Grimer', 221601, 23),
                new GymPokemon('Grimer', 221601, 23),
                new GymPokemon('Muk', 221601, 25),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 221601, 26),
                new GymPokemon('Zubat', 221601, 26),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Koffing', 221601, 23),
                new GymPokemon('Zubat', 221601, 23),
                new GymPokemon('Rattata', 221601, 23),
                new GymPokemon('Grimer', 221601, 23),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Magnemite', 221601, 27),
                new GymPokemon('Magnemite', 221601, 27),
                new GymPokemon('Magnemite', 221601, 27),
            ], { weight: 1 }, 'Marc', '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Raticate', 221601, 24),
                new GymPokemon('Koffing', 221601, 26),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 221601, 22),
                new GymPokemon('Golbat', 221601, 24),
                new GymPokemon('Grimer', 221601, 22),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Scientist',
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Ekans', 221601, 21),
                new GymPokemon('Oddish', 221601, 23),
                new GymPokemon('Ekans', 221601, 21),
                new GymPokemon('Gloom', 221601, 24),
            ], { weight: 1 }, undefined, '(female)'),
    ],
    [
        {loot: 'xClick', weight: 3.75},
...
dungeonList['Petalburg Woods'] = new Dungeon('Petalburg Woods',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Wurmple', 414872, 3),
                new GymPokemon('Wurmple', 414872, 3),
                new GymPokemon('Wurmple', 414872, 3),
                new GymPokemon('Wurmple', 414872, 3),
            ], { weight: 1 }, 'Lyle'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Nincada', 414872, 6),
                new GymPokemon('Nincada', 414872, 6),
            ], { weight: 1 }, 'James'),
    ],
    [
...
dungeonList['Mt. Chimney'] = new Dungeon('Mt. Chimney',
    [
        ...
        new DungeonTrainer('Magma Admin',
            [
                new GymPokemon('Numel', 583463, 18),
                new GymPokemon('Poochyena', 583463, 20),
                new GymPokemon('Numel', 583463, 22),
                new GymPokemon('Zubat', 583463, 22),
            ], { weight: 1 }, 'Tabitha'),
    ],
    [
        {loot: 'xAttack', weight: 3.75},
...
dungeonList['Jagged Pass'] = new Dungeon('Jagged Pass',
    [
        ...
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 595865, 20),
                new GymPokemon('Baltoy', 595865, 20),
            ], { weight: 1 }, 'Eric'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Shroomish', 595865, 19),
                new GymPokemon('Oddish', 595865, 19),
                new GymPokemon('Swablu', 595865, 19),
            ], { weight: 1 }, 'Diana'),
        new DungeonTrainer('Picnicker',
            [new GymPokemon('Shroomish', 595865, 21)],
            { weight: 1 }, 'Autumn'),
        new DungeonTrainer('Triathlete',
            [new GymPokemon('Magnemite', 595865, 21)],
            { weight: 1 }, 'Julio', '(malecycling)'),
        new DungeonTrainer('Camper',
            [
                new GymPokemon('Zigzagoon', 595865, 20),
                new GymPokemon('Taillow', 595865, 20),
            ], { weight: 1 }, 'Ethan'),
    ],
    [
        {loot: 'xClick', weight: 3.5},
...
dungeonList['Weather Institute'] = new Dungeon('Weather Institute',
    [
        ...
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Zubat', 787761, 27),
                new GymPokemon('Poochyena', 787761, 27),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Poochyena', 787761, 27),
                new GymPokemon('Carvanha', 787761, 27),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Zubat', 787761, 27),
        ...
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Poochyena', 787761, 26),
                new GymPokemon('Zubat', 787761, 26),
                new GymPokemon('Carvanha', 787761, 26),
            ], { weight: 1 }, undefined, '(male)'),
    ],
    [
        {loot: 'xAttack', weight: 3.75},
...
dungeonList['Mt. Pyre'] = new Dungeon('Mt. Pyre',
    [
        ...
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Rhyhorn', 880082, 31)],
            { weight: 1 }, 'Mark'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Spoink', 880082, 31)],
            { weight: 1 }, 'Leah', '(hoenn)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 880082, 31)],
            { weight: 1 }, 'Zander'),
        new DungeonTrainer('Young Couple',
            [
                new GymPokemon('Delcatty', 880082, 31),
                new GymPokemon('Manectric', 880082, 31),
            ],
            { weight: 1 }, 'Dez & Luke'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Wobbuffet', 880082, 26),
                new GymPokemon('Natu', 880082, 26),
                new GymPokemon('Kadabra', 880082, 26),
            ],
            { weight: 1 }, 'Kayla', '(female)'),
        new DungeonTrainer('Pokémon Breeder',
            [
                new GymPokemon('Skitty', 880082, 26),
                new GymPokemon('Poochyena', 880082, 26),
                new GymPokemon('Zigzagoon', 880082, 26),
                new GymPokemon('Lotad', 880082, 26),
                new GymPokemon('Seedot', 880082, 26),
                new GymPokemon('Taillow', 880082, 26),
            ],
            { weight: 1 }, 'Gabrielle', '(female)'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Ralts', 880082, 26),
                new GymPokemon('Ralts', 880082, 26),
                new GymPokemon('Kirlia', 880082, 26),
            ],
            { weight: 1 }, 'William', '(male)'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Shuppet', 880082, 32)],
            { weight: 1 }, 'Tasha', '(hoenn)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 880082, 32)],
            { weight: 1 }, 'Atsushi'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Sableye', 880082, 32)],
            { weight: 1 }, 'Valerie', '(hoenn)'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Wobbuffet', 880082, 32)],
            { weight: 1 }, 'Cedric', '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Carvanha', 880082, 32)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Zubat', 880082, 32)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Poochyena', 880082, 30),
                new GymPokemon('Carvanha', 880082, 30),
            ],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Wailmer', 880082, 30),
                new GymPokemon('Zubat', 880082, 30),
            ],
            { weight: 1 }, undefined, '(female)'),
    ],
    [
...
dungeonList['Magma Hideout'] = new Dungeon('Magma Hideout',
    [
        ...
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Poochyena', 896162, 29)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Numel', 896162, 29)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Mightyena', 896162, 29)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Magma Grunt',
            [
            ...
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Zubat', 896162, 29)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Numel', 896162, 29)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Magma Grunt',
            ...
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Baltoy', 896162, 29)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Baltoy', 896162, 29)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Magma Admin',
            [
                new GymPokemon('Numel', 896162, 26),
                new GymPokemon('Mightyena', 896162, 28),
                new GymPokemon('Zubat', 896162, 30),
                new GymPokemon('Camerupt', 896162, 33),
            ],
            { weight: 1 }, 'Tabitha'),
    ],
    [
...
dungeonList['Aqua Hideout'] = new Dungeon('Aqua Hideout',
    [
        ...
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Zubat', 912240, 31),
                new GymPokemon('Carvanha', 912240, 31),
            ],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Poochyena', 912240, 31),
                new GymPokemon('Zubat', 912240, 31),
            ],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Aqua Grunt',
...
dungeonList['Seafloor Cavern'] = new Dungeon('Seafloor Cavern',
    [
        ...
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Poochyena', 1083636, 36)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Carvanha', 1083636, 36)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Zubat', 1083636, 36)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Carvanha', 1083636, 36)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Mightyena', 1083636, 35),
                new GymPokemon('Golbat', 1083636, 35),
            ],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aqua Admin',
            [
                new GymPokemon('Sharpedo', 1083636, 37),
                new GymPokemon('Mightyena', 1083636, 37),
            ], { weight: 1 }, 'Shelly', '(shelly)'),
    ],
    [
        {loot: 'Item_magnet', weight: 4},
...
dungeonList['Victory Road Hoenn'] = new Dungeon('Victory Road Hoenn',
    [
        ...
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Magneton', 1273188, 43),
                new GymPokemon('Muk', 1273188, 43),
            ], { weight: 1 }, 'Albert', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [new GymPokemon('Roselia', 1273188, 45)],
            { weight: 1 }, 'Hope', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [new GymPokemon('Claydol', 1273188, 45)],
            { weight: 1 }, 'Shannon', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Swellow', 1273188, 42),
                new GymPokemon('Mawile', 1273188, 42),
                new GymPokemon('Kadabra', 1273188, 42),
            ], { weight: 1 }, 'Samuel', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Sandslash', 1273188, 42),
                new GymPokemon('Ninetales', 1273188, 42),
                new GymPokemon('Tropius', 1273188, 42),
            ], { weight: 1 }, 'Julie', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Claydol', 1273188, 43),
                new GymPokemon('Lanturn', 1273188, 43),
            ], { weight: 1 }, 'Dianne', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Medicham', 1273188, 43),
                new GymPokemon('Claydol', 1273188, 43),
            ], { weight: 1 }, 'Felix', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Skarmory', 1273188, 43),
                new GymPokemon('Sableye', 1273188, 43),
            ], { weight: 1 }, 'Caroline', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Dodrio', 1273188, 42),
                new GymPokemon('Kadabra', 1273188, 42),
                new GymPokemon('Electrode', 1273188, 42),
                new GymPokemon('Shiftry', 1273188, 42),
            ], { weight: 1 }, 'Vito', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Torkoal', 1273188, 42),
                new GymPokemon('Medicham', 1273188, 42),
                new GymPokemon('Ludicolo', 1273188, 42),
            ], { weight: 1 }, 'Michelle', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Lunatone', 1273188, 43),
                new GymPokemon('Solrock', 1273188, 43),
            ], { weight: 1 }, 'Mitchell', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Sableye', 1273188, 43),
                new GymPokemon('Absol', 1273188, 43),
            ], { weight: 1 }, 'Halle', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Cacturne', 1273188, 43),
                new GymPokemon('Pelipper', 1273188, 43),
            ], { weight: 1 }, 'Edgar', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Gardevoir', 1273188, 43),
                new GymPokemon('Slaking', 1273188, 43),
            ], { weight: 1 }, 'Katelynn', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Slaking', 1273188, 43),
                new GymPokemon('Dusclops', 1273188, 43),
...
dungeonList['Oreburgh Gate'] = new Dungeon('Oreburgh Gate',
    [
        ...
        new DungeonTrainer('Camper',
            [
                new GymPokemon('Starly', 1503698, 7),
                new GymPokemon('Shinx', 1503698, 7),
            ], { weight: 1 }, 'Curtis'),
        new DungeonTrainer('Picnicker',
            [new GymPokemon('Bidoof', 1503698, 9)],
            { weight: 1 }, 'Diana'),
    ],
    [
        {loot: 'xAttack', weight: 3.75},
...
dungeonList['Valley Windworks'] = new Dungeon('Valley Windworks',
    [
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Glameow', 1548858, 11),
                new GymPokemon('Stunky', 1548858, 11),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Zubat', 1548858, 11),
                new GymPokemon('Zubat', 1548858, 11),
            ], { weight: 1 }, undefined, '(male)'),
    ],
    [
...
dungeonList['Eterna Forest'] = new Dungeon('Eterna Forest',
    [
        ...
        new DungeonTrainer('Bookworms',
            [
                new GymPokemon('Wurmple', 1641617, 9),
                new GymPokemon('Silcoon', 1641617, 11),
                new GymPokemon('Beautifly', 1641617, 13),
                new GymPokemon('Pachirisu', 1641617, 14),
            ], { weight: 1 }, 'Jack & Briana'),
        new DungeonTrainer('Melded Minds',
            [
                new GymPokemon('Abra', 1641617, 15),
                new GymPokemon('Abra', 1641617, 15),
            ], { weight: 1 }, 'Linsey & Elijah', '(both)'),
        new DungeonTrainer('Bug Buds',
            [
                new GymPokemon('Wurmple', 1641617, 9),
                new GymPokemon('Cascoon', 1641617, 11),
                new GymPokemon('Dustox', 1641617, 13),
                new GymPokemon('Burmy (plant)', 1641617, 12),
                new GymPokemon('Kricketune', 1641617, 12),
            ], { weight: 1 }, 'Philip & Donald'),
        new DungeonTrainer('Melded Minds',
            [
                new GymPokemon('Meditite', 1641617, 15),
                new GymPokemon('Psyduck', 1641617, 15),
...
dungeonList['Team Galactic Eterna Building'] = new Dungeon('Team Galactic Eterna Building',
    [
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Zubat', 1618223, 17),
                new GymPokemon('Stunky', 1618223, 17),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Zubat', 1618223, 16),
                new GymPokemon('Glameow', 1618223, 18),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Galactic Grunt',
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Stunky', 1618223, 16),
                new GymPokemon('Croagunk', 1618223, 16),
                new GymPokemon('Glameow', 1618223, 16),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Scientist',
...
dungeonList['Wayward Cave'] = new Dungeon('Wayward Cave',
    [
        ...
        new DungeonTrainer('Mountain Men',
            [
                new GymPokemon('Geodude', 1641617, 20),
                new GymPokemon('Geodude', 1641617, 20),
                new GymPokemon('Onix', 1641617, 22),
            ], { weight: 1 }, 'Reginald & Lorenzo'),
        new DungeonTrainer('Siblings',
            [
                new GymPokemon('Buneary', 1641617, 22),
                new GymPokemon('Staravia', 1641617, 17),
                new GymPokemon('Ponyta', 1641617, 20),
                new GymPokemon('Shellos (west)', 1641617, 20),
            ], { weight: 1 }, 'Cassidy & Wayne'),
        new DungeonTrainer('Nature Friends',
            [
                new GymPokemon('Psyduck', 1641617, 22),
                new GymPokemon('Aipom', 1641617, 22),
            ], { weight: 1 }, 'Tori & Diego'),
        new DungeonTrainer('Nature Friends',
            [
                new GymPokemon('Hoothoot', 1641617, 22),
                new GymPokemon('Buizel', 1641617, 20),
                new GymPokemon('Shinx', 1641617, 20),
            ], { weight: 1 }, 'Ana & Parker'),
        new DungeonTrainer('Amateur Archaeologists',
            [
                new GymPokemon('Gible', 1641617, 22),
                new GymPokemon('Geodude', 1641617, 19),
                new GymPokemon('Bronzor', 1641617, 21),
...
dungeonList['Solaceon Ruins'] = new Dungeon('Solaceon Ruins',
    [
        ...
        new DungeonTrainer('Ruin Maniac',
            [
                new GymPokemon('Geodude', 1786920, 19),
                new GymPokemon('Geodude', 1786920, 21),
                new GymPokemon('Bronzor', 1786920, 23),
            ], { weight: 1 }, 'Karl'),
    ],
    [
        {loot: 'Lucky_incense', weight: 3.75},
...
dungeonList['Lake Valor'] = new Dungeon('Lake Valor',
    [
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Glameow', 2155424, 35),
                new GymPokemon('Murkrow', 2155424, 35),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Galactic Grunt',
            [new GymPokemon('Golbat', 2155424, 37)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Croagunk', 2155424, 33),
                new GymPokemon('Houndour', 2155424, 33),
                new GymPokemon('Stunky', 2155424, 33),
                new GymPokemon('Glameow', 2155424, 33),
            ], { weight: 1 }, undefined, '(male)'),
    ],
    [
        {loot: 'Token_collector', weight: 4},
...
dungeonList['Team Galactic HQ'] = new Dungeon('Team Galactic HQ',
    [
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Glameow', 2326289, 37),
                new GymPokemon('Murkrow', 2326289, 38),
                new GymPokemon('Croagunk', 2326289, 39),
            ], { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Kirlia', 2326289, 40),
                new GymPokemon('Kadabra', 2326289, 40),
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Murkrow', 2326289, 41),
                new GymPokemon('Stunky', 2326289, 41),
            ], { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Golbat', 2326289, 40),
                new GymPokemon('Golbat', 2326289, 38),
            ], { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Golbat', 2326289, 39),
                new GymPokemon('Houndour', 2326289, 39),
            ], { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Scientist',
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Stunky', 2326289, 38),
                new GymPokemon('Croagunk', 2326289, 40),
            ], { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Croagunk', 2326289, 38),
                new GymPokemon('Stunky', 2326289, 38),
                new GymPokemon('Glameow', 2326289, 38),
            ], { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Commander',
            [
                new GymPokemon('Golbat', 2326289, 42),
                new GymPokemon('Bronzor', 2326289, 42),
                new GymPokemon('Toxicroak', 2326289, 42),
            ], { weight: 1 }, 'Saturn', '(saturn)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    2326289,
...
dungeonList['Spear Pillar'] = new Dungeon('Spear Pillar',
    [
        ...
        new DungeonTrainer('Galactic Grunt',
            [new GymPokemon('Stunky', 2385003, 43)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Galactic Grunt',
            [new GymPokemon('Murkrow', 2385003, 43)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Houndour', 2385003, 40),
                new GymPokemon('Golbat', 2385003, 40),
                new GymPokemon('Houndour', 2385003, 40),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Stunky', 2385003, 42),
                new GymPokemon('Golbat', 2385003, 40),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [new GymPokemon('Golbat', 2385003, 43)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Murkrow', 2385003, 39),
                new GymPokemon('Glameow', 2385003, 42),
                new GymPokemon('Murkrow', 2385003, 39),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Croagunk', 2385003, 38),
                new GymPokemon('Croagunk', 2385003, 42),
                new GymPokemon('Stunky', 2385003, 40),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Houndour', 2385003, 40),
        ...
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Glameow', 2385003, 41),
                new GymPokemon('Golbat', 2385003, 41),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Galactic Grunt',
            [
                new GymPokemon('Golbat', 2385003, 39),
                new GymPokemon('Croagunk', 2385003, 40),
                new GymPokemon('Murkrow', 2385003, 41),
            ], { weight: 1 }, undefined, '(female)'),
    ],
    [
        {loot: 'xClick', weight: 4},
...
dungeonList['Victory Road Sinnoh'] = new Dungeon('Victory Road Sinnoh',
    [
        ...
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Haunter', 2566490, 43),
                new GymPokemon('Gengar', 2566490, 46),
                new GymPokemon('Gardevoir', 2566490, 46),
            ], { weight: 1 }, 'Bryce', '(male)'),
        new DungeonTrainer('Bird Keeper',
            [
                new GymPokemon('Noctowl', 2566490, 45),
                new GymPokemon('Togetic', 2566490, 47),
            ], { weight: 1 }, 'Hana'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Blissey', 2566490, 45),
                new GymPokemon('Glalie', 2566490, 46),
                new GymPokemon('Magnezone', 2566490, 48),
            ], { weight: 1 }, 'Mariah', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Mamoswine', 2566490, 45),
                new GymPokemon('Mothim', 2566490, 46),
                new GymPokemon('Rampardos', 2566490, 48),
            ], { weight: 1 }, 'Omar', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Clefable', 2566490, 47),
                new GymPokemon('Torterra', 2566490, 48),
            ], { weight: 1 }, 'Sydney', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Staraptor', 2566490, 47),
                new GymPokemon('Lickilicky', 2566490, 47),
            ], { weight: 1 }, 'Clayton', '(male)'),
        new DungeonTrainer('Double Team',
            [
                new GymPokemon('Staraptor', 2566490, 50),
                new GymPokemon('Ambipom', 2566490, 50),
            ], { weight: 1 }, 'Al & Kay'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Machamp', 2566490, 48)],
            { weight: 1 }, 'Miles'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Chimecho', 2566490, 44),
                new GymPokemon('Absol', 2566490, 45),
                new GymPokemon('Dusknoir', 2566490, 46),
            ], { weight: 1 }, 'Valencia', '(female)'),
        new DungeonTrainer('Double Team',
            [
                new GymPokemon('Lumineon', 2566490, 50),
                new GymPokemon('Rapidash', 2566490, 50),
            ], { weight: 1 }, 'Pat & Jo'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Rhydon', 2566490, 47),
                new GymPokemon('Carnivine', 2566490, 48),
            ], { weight: 1 }, 'Henry', '(male)'),
        new DungeonTrainer('Dragon Tamer',
            [
                new GymPokemon('Altaria', 2566490, 45),
                new GymPokemon('Gabite', 2566490, 47),
            ], { weight: 1 }, 'Ondrej'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Porygon-Z', 2566490, 46),
                new GymPokemon('Tangrowth', 2566490, 46),
                new GymPokemon('Empoleon', 2566490, 46),
            ], { weight: 1 }, 'Edgar', '(male)'),
        new DungeonTrainer('Dragon Tamer',
            [
                new GymPokemon('Gible', 2566490, 43),
                new GymPokemon('Swablu', 2566490, 45),
                new GymPokemon('Gabite', 2566490, 47),
            ], { weight: 1 }, 'Clinton'),
    ],
    [
...
dungeonList['Stark Mountain'] = new Dungeon('Stark Mountain',
    [
        ...
        new DungeonTrainer('Dragon Tamer',
            [new GymPokemon('Dragonite', 2821107, 60)],
            { weight: 1 }, 'Darien'),
        new DungeonTrainer('Commander',
            [
                new GymPokemon('Bronzong', 2821107, 58),
                new GymPokemon('Golbat', 2821107, 58),
                new GymPokemon('Purugly', 2821107, 60),
            ], { weight: 1 }, 'Mars', '(mars)'),
        new DungeonTrainer('Commander',
            [
                new GymPokemon('Bronzong', 2821107, 58),
                new GymPokemon('Golbat', 2821107, 58),
                new GymPokemon('Skuntank', 2821107, 60),
            ], { weight: 1 }, 'Jupiter', '(jupiter)'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Primeape', 2821107, 58),
                new GymPokemon('Banette', 2821107, 59),
                new GymPokemon('Electabuzz', 2821107, 58),
                new GymPokemon('Jumpluff', 2821107, 58),
                new GymPokemon('Ampharos', 2821107, 59),
                new GymPokemon('Onix', 2821107, 58),
            ], { weight: 1 }, 'Keenan & Kassandra'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Pupitar', 2821107, 58),
                new GymPokemon('Torterra', 2821107, 61),
                new GymPokemon('Drapion', 2821107, 61),
            ], { weight: 1 }, 'Stefan & Jasmin'),
        new DungeonTrainer('Fight & Flight',
            [
                new GymPokemon('Staravia', 2821107, 55),
                new GymPokemon('Fearow', 2821107, 57),
                new GymPokemon('Noctowl', 2821107, 59),
                new GymPokemon('Breloom', 2821107, 58),
                new GymPokemon('Toxicroak', 2821107, 58),
            ], { weight: 1 }, 'Krystal & Ray'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Glalie', 2821107, 59),
                new GymPokemon('Crobat', 2821107, 60),
                new GymPokemon('Luxray', 2821107, 58),
                new GymPokemon('Ursaring', 2821107, 59),
                new GymPokemon('Gliscor', 2821107, 58),
            ], { weight: 1 }, 'Abel & Monique'),
        new DungeonTrainer('Melded Minds',
            [
                new GymPokemon('Lunatone', 2821107, 57),
                new GymPokemon('Gardevoir', 2821107, 59),
                new GymPokemon('Solrock', 2821107, 57),
                new GymPokemon('Gallade', 2821107, 59),
            ], { weight: 1 }, 'Chelsey & Sterling', '(both)'),
        new DungeonTrainer('Dragon Warriors',
            [
                new GymPokemon('Raticate', 2821107, 57),
                new GymPokemon('Drifblim', 2821107, 58),
                new GymPokemon('Shiftry', 2821107, 59),
                new GymPokemon('Bagon', 2821107, 57),
                new GymPokemon('Shelgon', 2821107, 57),
                new GymPokemon('Vibrava', 2821107, 57),
            ], { weight: 1 }, 'Harlan & Kenny'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Loudred', 2821107, 58),
                new GymPokemon('Rampardos', 2821107, 59),
                new GymPokemon('Pelipper', 2821107, 58),
                new GymPokemon('Wigglytuff', 2821107, 58),
                new GymPokemon('Gardevoir', 2821107, 59),
                new GymPokemon('Medicham', 2821107, 58),
            ], { weight: 1 }, 'Skylar & Narasha'),
        new DungeonTrainer('Hidden Dragons',
            [
                new GymPokemon('Gible', 2821107, 57),
                new GymPokemon('Gabite', 2821107, 57),
                new GymPokemon('Dragonair', 2821107, 57),
                new GymPokemon('Machamp', 2821107, 60),
...
dungeonList['Floccesy Ranch'] = new Dungeon('Floccesy Ranch',
    [
        ...
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Purrloin', 3297488, 6),
                new GymPokemon('Sewaddle', 3297488, 6),
            ], { weight: 1 }, 'Molly'),
        new DungeonTrainer('Janitor',
            [
                new GymPokemon('Lillipup', 3297488, 6),
                new GymPokemon('Mareep', 3297488, 6),
            ], { weight: 1 }, 'Orville'),
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Patrat', 3297488, 6),
                new GymPokemon('Psyduck', 3297488, 6),
            ], { weight: 1 }, 'Kenny'),
    ],
    [
        {loot: 'xAttack', weight: 4},
...
dungeonList['Castelia Sewers'] = new Dungeon('Castelia Sewers',
    [
        ...
        new DungeonTrainer('Janitor',
            [
                new GymPokemon('Lillipup', 3322046, 16),
                new GymPokemon('Trubbish', 3322046, 16),
            ], { weight: 1 }, 'Felix'),
        new DungeonTrainer('Doctor',
            [new GymPokemon('Sewaddle', 3322046, 17)],
            { weight: 1 }, 'Heath'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Drilbur', 3322046, 17)],
            { weight: 1 }, 'Zack'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Timburr', 3322046, 17)],
            { weight: 1 }, 'Scott'),
        new DungeonTrainer('Scientist',
            [new GymPokemon('Grimer', 3322046, 17)],
            { weight: 1 }, 'Caroline', '(female)'),
        new DungeonTrainer('Scientist',
            [new GymPokemon('Magnemite', 3322046, 17)],
            { weight: 1 }, 'Clarke', '(male)'),
        new DungeonTrainer('Janitor',
            [
                new GymPokemon('Marill', 3322046, 31),
                new GymPokemon('Cinccino', 3322046, 31),
            ], { weight: 1 }, 'Brady'),
    ],
    [
        {loot: 'xClick', weight: 4},
...
dungeonList['Relic Passage'] = new Dungeon('Relic Passage',
    [
        ...
        new DungeonTrainer('Scientist',
            [new GymPokemon('Grimer', 3598119, 18)],
            { weight: 1 }, 'Terrance', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Venipede', 3598119, 17),
                new GymPokemon('Koffing', 3598119, 17),
            ], { weight: 1 }, 'Lumina', '(female)'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Herdier', 3598119, 18)],
            { weight: 1 }, 'Kendall', '(male)'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Sandslash', 3598119, 32)],
            { weight: 1 }, 'Eileen', '(female)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Drilbur', 3598119, 31),
                new GymPokemon('Roggenrola', 3598119, 31),
            ], { weight: 1 }, 'Keith'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Raticate', 3598119, 32)],
            { weight: 1 }, 'Randall', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Roggenrola', 3598119, 31),
                new GymPokemon('Timburr', 3598119, 31),
            ], { weight: 1 }, 'Tobias'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Swoobat', 3598119, 33)],
            { weight: 1 }, 'Tully', '(male)'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Watchog', 3598119, 32)],
            { weight: 1 }, 'Annie', '(female)'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Baltoy', 3598119, 32),
                new GymPokemon('Yamask', 3598119, 32),
            ], { weight: 1 }, 'Ena', '(female)'),
    ],
    [
        {loot: 'Lucky_egg', weight: 4},
...
dungeonList['Relic Castle'] = new Dungeon('Relic Castle',
    [
        ...
        new DungeonTrainer('Psychic',
            [new GymPokemon('Gothita', 3445821, 23)],
            { weight: 1 }, 'Dua', '(female)'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Solosis', 3445821, 23)],
            { weight: 1 }, 'Low', '(male)'),
    ],
    [
        {loot: 'Token_collector', weight: 4},
...
dungeonList['Lostlorn Forest'] = new Dungeon('Lostlorn Forest',
    [
        ...
        new DungeonTrainer('Pokémon Breeder',
            [
                new GymPokemon('Tranquill', 3521472, 24),
                new GymPokemon('Liepard', 3521472, 24),
            ], { weight: 1 }, 'Galen', '(male)'),
        new DungeonTrainer('Pokémon Ranger',
            [new GymPokemon('Trubbish', 3521472, 26)],
            { weight: 1 }, 'Serenity', '(female)'),
        new DungeonTrainer('Pokémon Ranger',
            [new GymPokemon('Emolga', 3521472, 26)],
            { weight: 1 }, 'Forrest', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Larvesta', 3521472, 51),
                new GymPokemon('Pinsir', 3521472, 51),
                new GymPokemon('Heracross', 3521472, 51),
                new GymPokemon('Leavanny', 3521472, 51),
                new GymPokemon('Scolipede', 3521472, 51),
...
dungeonList['Chargestone Cave'] = new Dungeon('Chargestone Cave',
    [
        ...
        new DungeonTrainer('Guitarist',
            [new GymPokemon('Emolga', 3675765, 30)],
            { weight: 1 }, 'Anna'),
        new DungeonTrainer('Scientist',
            [new GymPokemon('Magneton', 3675765, 30)],
            { weight: 1 }, 'Ronald', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Klink', 3675765, 33),
                new GymPokemon('Unfezant', 3675765, 33),
                new GymPokemon('Sandslash', 3675765, 33),
            ], { weight: 1 }, 'Corky', '(male)'),
        new DungeonTrainer('Pokémon Ranger',
            [new GymPokemon('Ampharos', 3675765, 34)],
            { weight: 1 }, 'Louis', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Aron', 3675765, 32),
                new GymPokemon('Nosepass', 3675765, 32),
            ], { weight: 1 }, 'Otto'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Minccino', 3675765, 33),
                new GymPokemon('Excadrill', 3675765, 33),
            ], { weight: 1 }, 'Briana', '(female)'),
        new DungeonTrainer('Doctor',
            [
                new GymPokemon('Solosis', 3675765, 32),
                new GymPokemon('Gothita', 3675765, 32),
            ], { weight: 1 }, 'Kit'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Joltik', 3675765, 32),
                new GymPokemon('Golbat', 3675765, 32),
            ], { weight: 1 }, 'Lumi', '(female)'),
        new DungeonTrainer('Guitarist',
            [new GymPokemon('Zebstrika', 3675765, 33)],
            { weight: 1 }, 'Beverly'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Onix', 3675765, 32),
                new GymPokemon('Boldore', 3675765, 32),
            ], { weight: 1 }, 'Jeremy'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Stoutland', 3675765, 33),
                new GymPokemon('Krokorok', 3675765, 33),
                new GymPokemon('Ferroseed', 3675765, 33),
...
dungeonList['Mistralton Cave'] = new Dungeon('Mistralton Cave',
    [
        ...
        new DungeonTrainer('Hiker',
            [new GymPokemon('Boldore', 3715092, 32)],
            { weight: 1 }, 'Shelby'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Onix', 3715092, 32)],
            { weight: 1 }, 'Jebediah'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Tirtouga', 3715092, 33),
                new GymPokemon('Axew', 3715092, 33),
            ], { weight: 1 }, 'Geoff', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Archen', 3715092, 33),
                new GymPokemon('Axew', 3715092, 33),
...
dungeonList['Celestial Tower'] = new Dungeon('Celestial Tower',
    [
        ...
        new DungeonTrainer('Psychic',
            [new GymPokemon('Musharna', 3754418, 36)],
            { weight: 1 }, 'Joyce', '(female)'),
        new DungeonTrainer('School Kid',
            [new GymPokemon('Litwick', 3754418, 35)],
            { weight: 1 }, 'Alberta', '(female)'),
        new DungeonTrainer('Pokéfan',
            [new GymPokemon('Clefairy', 3754418, 35)],
            { weight: 1 }, 'Jude', '(male)'),
        new DungeonTrainer('Pokéfan',
            [new GymPokemon('Cubchoo', 3754418, 35)],
            { weight: 1 }, 'Georgia', '(female)'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Espeon', 3754418, 36)],
            { weight: 1 }, 'Micki', '(male)'),
        new DungeonTrainer('Nurse',
            [new GymPokemon('Leavanny', 3754418, 35)],
            { weight: 1 }, 'Dixie'),
        new DungeonTrainer('Socialite',
            [new GymPokemon('Roselia', 3754418, 35)],
            { weight: 1 }, 'Grace'),
        new DungeonTrainer('Gentleman',
            [new GymPokemon('Umbreon', 3754418, 35)],
            { weight: 1 }, 'Daniel'),
    ],
    [
        {loot: 'Lucky_egg', weight: 4},
...
dungeonList['Reversal Mountain'] = new Dungeon('Reversal Mountain',
    [
        ...
        new DungeonTrainer('Cyclist',
            [new GymPokemon('Zebstrika', 3794249, 37)],
            { weight: 1 }, 'Jeremiah', '(male)'),
        new DungeonTrainer('Cyclist',
            [new GymPokemon('Unfezant', 3794249, 37)],
            { weight: 1 }, 'Adalaide', '(female)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Gurdurr', 3794249, 37),
                new GymPokemon('Crustle', 3794249, 37),
            ], { weight: 1 }, 'Markus'),
        new DungeonTrainer('Backpacker',
            [
                new GymPokemon('Golbat', 3794249, 37),
                new GymPokemon('Swanna', 3794249, 37),
            ], { weight: 1 }, 'Kiyo', '(male)'),
        new DungeonTrainer('Doctor',
            [new GymPokemon('Swoobat', 3794249, 38)],
            { weight: 1 }, 'Derek'),
        new DungeonTrainer('Backpacker',
            [
                new GymPokemon('Golbat', 3794249, 37),
                new GymPokemon('Darmanitan', 3794249, 37),
            ], { weight: 1 }, 'Kumiko', '(female)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Boldore', 3794249, 37),
                new GymPokemon('Excadrill', 3794249, 37),
            ], { weight: 1 }, 'Jared'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Vibrava', 3794249, 39),
                new GymPokemon('Camerupt', 3794249, 39),
            ], { weight: 1 }, 'Ray', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Grumpig', 3794249, 37),
                new GymPokemon('Drifblim', 3794249, 37),
            ], { weight: 1 }, 'Cora', '(female)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Gurdurr', 3794249, 37),
                new GymPokemon('Scraggy', 3794249, 37),
                new GymPokemon('Scraggy', 3794249, 37),
            ], { weight: 1 }, 'Corey'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Riolu', 3794249, 37),
                new GymPokemon('Gurdurr', 3794249, 37),
                new GymPokemon('Riolu', 3794249, 37),
            ], { weight: 1 }, 'Chan'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Banette', 3794249, 38),
                new GymPokemon('Golduck', 3794249, 38),
            ], { weight: 1 }, 'Eliza', '(female)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Watchog', 3794249, 38),
                new GymPokemon('Camerupt', 3794249, 38),
            ], { weight: 1 }, 'Lewis', '(male)'),
    ],
    [
        {loot: 'Item_magnet', weight: 4},
...
dungeonList['Team Plasma Assault'] = new Dungeon('Team Plasma Assault',
    [
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Watchog', 4162904, 44),
                new GymPokemon('Muk', 4162904, 44),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Golbat', 4162904, 44),
                new GymPokemon('Garbodor', 4162904, 44),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Seviper', 4162904, 44),
                new GymPokemon('Weezing', 4162904, 44),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Pawniard', 4162904, 46),
                new GymPokemon('Pawniard', 4162904, 46),
                new GymPokemon('Absol', 4162904, 46),
...
dungeonList['Seaside Cave'] = new Dungeon('Seaside Cave',
    [
        ...
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Heracross', 4247678, 47)],
            { weight: 1 }, 'Tia'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Vibrava', 4247678, 46),
                new GymPokemon('Gligar', 4247678, 46),
            ], { weight: 1 }, 'Johan', '(male)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Onix', 4247678, 46),
                new GymPokemon('Lairon', 4247678, 46),
            ], { weight: 1 }, 'Mikiko', '(female)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Scrafty', 4247678, 47)],
            { weight: 1 }, 'Drago'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Roggenrola', 4247678, 44),
                new GymPokemon('Roggenrola', 4247678, 44),
                new GymPokemon('Roggenrola', 4247678, 44),
                new GymPokemon('Roggenrola', 4247678, 44),
            ], { weight: 1 }, 'Rocky'),
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Mienfoo', 4247678, 47)],
            { weight: 1 }, 'Maki'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Gurdurr', 4247678, 47)],
            { weight: 1 }, 'Rich'),
    ],
    [
        {loot: 'Token_collector', weight: 4},
...
dungeonList['Plasma Frigate'] = new Dungeon('Plasma Frigate',
    [
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Watchog', 4420335, 46),
                new GymPokemon('Garbodor', 4420335, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Golbat', 4420335, 46),
                new GymPokemon('Drapion', 4420335, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Seviper', 4420335, 46),
                new GymPokemon('Garbodor', 4420335, 46),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
        ...
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Whirlipede', 4420335, 46),
                new GymPokemon('Watchog', 4420335, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Pawniard', 4420335, 45),
                new GymPokemon('Pawniard', 4420335, 45),
                new GymPokemon('Pawniard', 4420335, 45),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Scraggy', 4420335, 46),
                new GymPokemon('Liepard', 4420335, 46),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
        ...
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Krokorok', 4420335, 46),
                new GymPokemon('Raticate', 4420335, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Deino', 4420335, 45),
                new GymPokemon('Deino', 4420335, 45),
                new GymPokemon('Sneasel', 4420335, 45),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Scraggy', 4420335, 45),
                new GymPokemon('Krokorok', 4420335, 45),
                new GymPokemon('Golbat', 4420335, 45),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
...
dungeonList['Giant Chasm'] = new Dungeon('Giant Chasm',
    [
        ...
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Weezing', 4464282, 46),
                new GymPokemon('Muk', 4464282, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Scraggy', 4464282, 46),
                new GymPokemon('Scrafty', 4464282, 46),
                new GymPokemon('Whirlipede', 4464282, 46),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Trubbish', 4464282, 46),
                new GymPokemon('Golbat', 4464282, 46),
                new GymPokemon('Garbodor', 4464282, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Skorupi', 4464282, 45),
                new GymPokemon('Foongus', 4464282, 45),
                new GymPokemon('Golbat', 4464282, 45),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [new GymPokemon('Krookodile', 4464282, 47)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Doctor',
            [new GymPokemon('Leavanny', 4464282, 49)],
            { weight: 1 }, 'Julius'),
        new DungeonTrainer('Team Plasma Grunt',
            [new GymPokemon('Scrafty', 4464282, 47)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [new GymPokemon('Scolipede', 4464282, 47)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Trubbish', 4464282, 46),
                new GymPokemon('Zangoose', 4464282, 46),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Grimer', 4464282, 46),
                new GymPokemon('Seviper', 4464282, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Raticate', 4464282, 47),
                new GymPokemon('Watchog', 4464282, 47),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Krokorok', 4464282, 47),
                new GymPokemon('Krookodile', 4464282, 47),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [new GymPokemon('Drapion', 4464282, 47)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Deino', 4464282, 45),
                new GymPokemon('Deino', 4464282, 45),
                new GymPokemon('Sneasel', 4464282, 45),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Plasma Grunt',
            [
                new GymPokemon('Koffing', 4464282, 46),
                new GymPokemon('Amoonguss', 4464282, 46),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Cryogonal', 4464282, 49),
                new GymPokemon('Cryogonal', 4464282, 49),
                new GymPokemon('Weavile', 4464282, 51),
            ], { weight: 1 }, 'Zinzolin', '(zinzolin)'),
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Magneton', 4464282, 50),
                new GymPokemon('Beheeyem', 4464282, 50),
                new GymPokemon('Metang', 4464282, 50),
                new GymPokemon('Magnezone', 4464282, 50),
                new GymPokemon('Klinklang', 4464282, 52),
            ], { weight: 1 }, 'Colress', '(colress)'),
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Pawniard', 4464282, 49),
                new GymPokemon('Pawniard', 4464282, 49),
                new GymPokemon('Absol', 4464282, 51),
            ], { weight: 1 }, 'Shadow', '(shadow)'),
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Pawniard', 4464282, 49),
                new GymPokemon('Pawniard', 4464282, 49),
                new GymPokemon('Banette', 4464282, 51),
            ], { weight: 1 }, 'Shadow', '(shadow)'),
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Pawniard', 4464282, 49),
                new GymPokemon('Pawniard', 4464282, 49),
                new GymPokemon('Accelgor', 4464282, 51),
            ], { weight: 1 }, 'Shadow', '(shadow)'),
    ],
    [
        {loot: 'Lucky_incense', weight: 4},
...
dungeonList['Victory Road Unova'] = new Dungeon('Victory Road Unova',
    [
        ...
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Golurk', 4508229, 55),
                new GymPokemon('Sigilyph', 4508229, 55),
            ], { weight: 1 }, 'Billy', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Drifblim', 4508229, 55),
                new GymPokemon('Claydol', 4508229, 55),
            ], { weight: 1 }, 'Jamie', '(female)'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Lampent', 4508229, 54),
                new GymPokemon('Musharna', 4508229, 54),
            ], { weight: 1 }, 'Alia', '(female)'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Metang', 4508229, 54),
                new GymPokemon('Cofagrigus', 4508229, 54),
            ], { weight: 1 }, 'Al', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Braviary', 4508229, 55),
                new GymPokemon('Carracosta', 4508229, 55),
            ], { weight: 1 }, 'Claude', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Mandibuzz', 4508229, 55),
                new GymPokemon('Archeops', 4508229, 55),
            ], { weight: 1 }, 'Cecile', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Darmanitan', 4508229, 55),
                new GymPokemon('Tangrowth', 4508229, 55),
            ], { weight: 1 }, 'Chandra', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Whimsicott', 4508229, 55),
                new GymPokemon('Unfezant', 4508229, 55),
            ], { weight: 1 }, 'Beckett', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Swoobat', 4508229, 55),
                new GymPokemon('Lilligant', 4508229, 55),
            ], { weight: 1 }, 'Shelly', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Sigilyph', 4508229, 55),
                new GymPokemon('Crobat', 4508229, 55),
            ], { weight: 1 }, 'Cathy', '(female)'),
        new DungeonTrainer('Doctor',
            [new GymPokemon('Clefable', 4508229, 54)],
            { weight: 1 }, 'Logan'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Sawsbuck (Spring)', 4508229, 54)],
            { weight: 1 }, 'Mae', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Swanna', 4508229, 55),
                new GymPokemon('Ampharos', 4508229, 55),
            ], { weight: 1 }, 'Pierce', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Gigalith', 4508229, 55),
                new GymPokemon('Skarmory', 4508229, 55),
            ], { weight: 1 }, 'Abraham', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Heatmor', 4508229, 55),
                new GymPokemon('Galvantula', 4508229, 55),
            ], { weight: 1 }, 'Shanta', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Durant', 4508229, 55),
                new GymPokemon('Ferrothorn', 4508229, 55),
            ], { weight: 1 }, 'Webster', '(male)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Electabuzz', 4508229, 54),
                new GymPokemon('Probopass', 4508229, 54),
            ], { weight: 1 }, 'Eddie', '(male)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Magmar', 4508229, 54),
                new GymPokemon('Camerupt', 4508229, 54),
            ], { weight: 1 }, 'Elle', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Fraxure', 4508229, 54),
                new GymPokemon('Zweilous', 4508229, 54),
                new GymPokemon('Flygon', 4508229, 54),
            ], { weight: 1 }, 'Hugo', '(male)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Pinsir', 4508229, 54),
                new GymPokemon('Heracross', 4508229, 54),
            ], { weight: 1 }, 'Martell'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 4508229, 54),
                new GymPokemon('Sawk', 4508229, 54),
            ], { weight: 1 }, 'Chalina'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Zweilous', 4508229, 55),
                new GymPokemon('Eelektross', 4508229, 55),
            ], { weight: 1 }, 'Elmer', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Fraxure', 4508229, 55),
                new GymPokemon('Vanilluxe', 4508229, 55),
            ], { weight: 1 }, 'Caroll', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Zebstrika', 4508229, 54),
                new GymPokemon('Sawk', 4508229, 54),
                new GymPokemon('Starmie', 4508229, 54),
            ], { weight: 1 }, 'Portia', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Beartic', 4508229, 54),
                new GymPokemon('Throh', 4508229, 54),
                new GymPokemon('Golurk', 4508229, 54),
...
dungeonList['Twist Mountain'] = new Dungeon('Twist Mountain',
    [
        ...
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Roggenrola', 4597172, 60),
                new GymPokemon('Graveler', 4597172, 60),
                new GymPokemon('Excadrill', 4597172, 60),
            ], { weight: 1 }, 'Cairn'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Tauros', 4597172, 64),
                new GymPokemon('Crobat', 4597172, 64),
                new GymPokemon('Carracosta', 4597172, 64),
            ], { weight: 1 }, 'Carter', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Glaceon', 4597172, 63),
                new GymPokemon('Bastiodon', 4597172, 63),
                new GymPokemon('Rhyperior', 4597172, 63),
                new GymPokemon('Drapion', 4597172, 63),
            ], { weight: 1 }, 'Julia', '(female)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Golett', 4597172, 61),
                new GymPokemon('Mamoswine', 4597172, 61),
            ], { weight: 1 }, 'Wade'),
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Geodude', 4597172, 60),
                new GymPokemon('Steelix', 4597172, 60),
                new GymPokemon('Boldore', 4597172, 60),
            ], { weight: 1 }, 'Gus'),
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Machoke', 4597172, 61),
                new GymPokemon('Abomasnow', 4597172, 61),
            ], { weight: 1 }, 'Patton', '(ice)'),
        new DungeonTrainer('Nurse',
            [new GymPokemon('Blissey', 4597172, 62)],
            { weight: 1 }, 'Carol'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Gyarados', 4597172, 64),
                new GymPokemon('Kangaskhan', 4597172, 64),
                new GymPokemon('Archeops', 4597172, 64),
            ], { weight: 1 }, 'Chloris', '(female)'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Sigilyph', 4597172, 62)],
            { weight: 1 }, 'Cliff'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Larvitar', 4597172, 61),
                new GymPokemon('Probopass', 4597172, 61),
            ], { weight: 1 }, 'Hunter'),
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Glalie', 4597172, 61),
                new GymPokemon('Beartic', 4597172, 61),
            ], { weight: 1 }, 'Victor', '(ice)'),
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Smoochum', 4597172, 60),
                new GymPokemon('Claydol', 4597172, 60),
                new GymPokemon('Kadabra', 4597172, 60),
            ], { weight: 1 }, 'Ryan', '(ice)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Weavile', 4597172, 63),
                new GymPokemon('Rampardos', 4597172, 63),
                new GymPokemon('Toxicroak', 4597172, 63),
                new GymPokemon('Aggron', 4597172, 63),
            ], { weight: 1 }, 'Zach', '(male)'),
    ],
    [
        {loot: 'Token_collector', weight: 4},
...
dungeonList['Moor of Icirrus'] = new Dungeon('Moor of Icirrus',
    [
        ...
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Accelgor', 4687167, 62),
                new GymPokemon('Swalot', 4687167, 62),
                new GymPokemon('Kecleon', 4687167, 62),
            ], { weight: 1 }, 'Elaine', '(female)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Escavalier', 4687167, 62),
                new GymPokemon('Skuntank', 4687167, 62),
                new GymPokemon('Carnivine', 4687167, 62),
            ], { weight: 1 }, 'Parker', '(male)'),
        new DungeonTrainer('Fisherman',
            [
                new GymPokemon('Corphish', 4687167, 60),
                new GymPokemon('Poliwag', 4687167, 60),
                new GymPokemon('Stunfisk', 4687167, 60),
            ], { weight: 1 }, 'Eustace'),
        new DungeonTrainer('Fisherman',
            [
                new GymPokemon('Poliwhirl', 4687167, 60),
                new GymPokemon('Whiscash', 4687167, 60),
                new GymPokemon('Politoed', 4687167, 60),
            ], { weight: 1 }, 'Arnold'),
    ],
    [
        {loot: 'xAttack', weight: 4},
    ...
    4687167,
    [
        new DungeonBossPokemon('Whiscash', 23435835, 100),
        new DungeonBossPokemon('Seismitoad', 23435835, 100),
        new DungeonBossPokemon('Keldeo', 23435835, 100),
    ],
    356500, 15);
...
dungeonList['Dreamyard'] = new Dungeon('Dreamyard',
    [
        ...
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Hypno', 4778219, 62),
                new GymPokemon('Dusclops', 4778219, 62),
            ], { weight: 1 }, 'Nandor', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Gastly', 4778219, 63),
                new GymPokemon('Skuntank', 4778219, 63),
            ], { weight: 1 }, 'Athena', '(female)'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Chingling', 4778219, 62),
                new GymPokemon('Mr. Mime', 4778219, 62),
            ], { weight: 1 }, 'Olesia', '(female)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Klang', 4778219, 63),
                new GymPokemon('Porygon', 4778219, 63),
            ], { weight: 1 }, 'Franklin', '(male)'),
        new DungeonTrainer('School Kid',
            [
                new GymPokemon('Shroomish', 4778219, 63),
                new GymPokemon('Tangrowth', 4778219, 63),
            ], { weight: 1 }, 'William', '(male)'),
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Slakoth', 4778219, 63),
                new GymPokemon('Slaking', 4778219, 63),
            ], { weight: 1 }, 'Keita'),
        new DungeonTrainer('School Kid',
            [
                new GymPokemon('Igglybuff', 4778219, 63),
                new GymPokemon('Lickilicky', 4778219, 63),
...
dungeonList['Santalune Forest'] = new Dungeon('Santalune Forest',
    [
        ...
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Scatterbug', 5569766, 3),
                new GymPokemon('Fletchling', 5569766, 3),
            ], { weight: 1 }, 'Joey'),
        new DungeonTrainer('Lass',
            [new GymPokemon('Pikachu', 5569766, 5)],
            { weight: 1 }, 'Anna'),
    ],
    [
...
dungeonList['Glittering Cave'] = new Dungeon('Glittering Cave',
    [
        ...
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Houndour', 6423260, 18),
                new GymPokemon('Zubat', 6423260, 18),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Gulpin', 6423260, 18),
                new GymPokemon('Electrike', 6423260, 18),
            ], { weight: 1 }, undefined, '(female)'),
    ],
    [
        {loot: 'xClick', weight: 4},
...
dungeonList['Reflection Cave'] = new Dungeon('Reflection Cave',
    [
        ...
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Linoone', 6648213, 26)],
            { weight: 1 }, 'Lane', '(male)'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 6648213, 25),
                new GymPokemon('Hawlucha', 6648213, 26),
            ], { weight: 1 }, 'Hedvig'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Sandile', 6648213, 23),
                new GymPokemon('Dwebble', 6648213, 23),
                new GymPokemon('Diggersby', 6648213, 24),
            ], { weight: 1 }, 'Dunstan'),
        new DungeonTrainer('Tourist',
            [new GymPokemon('Nidorina', 6648213, 26)],
            { weight: 1 }, 'Monami', '(female)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Sawk', 6648213, 28)],
            { weight: 1 }, 'Igor'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Chimecho', 6648213, 24),
                new GymPokemon('Golett', 6648213, 24),
            ], { weight: 1 }, 'Franz', '(male)'),
        new DungeonTrainer('Tourist',
            [new GymPokemon('Nidorino', 6648213, 26)],
            { weight: 1 }, 'Haruto', '(male)'),
        new DungeonTrainer('Honeymooners',
            [
                new GymPokemon('Combee', 6648213, 26),
                new GymPokemon('Vespiquen', 6648213, 26),
            ], { weight: 1 }, 'Yuu & Ami'),
    ],
    [
        {loot: 'Token_collector', weight: 4},
...
dungeonList['Kalos Power Plant'] = new Dungeon('Kalos Power Plant',
    [
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Croagunk', 6994464, 32),
                new GymPokemon('Scraggy', 6994464, 32),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 6994464, 32),
                new GymPokemon('Scraggy', 6994464, 32),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
        ...
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 6994464, 32),
                new GymPokemon('Mightyena', 6994464, 32),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 6994464, 33),
                new GymPokemon('Croagunk', 6994464, 31),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Liepard', 6994464, 31),
                new GymPokemon('Scraggy', 6994464, 31),
                new GymPokemon('Croagunk', 6994464, 31),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
        ...
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Liepard', 6994464, 31),
                new GymPokemon('Swalot', 6994464, 33),
            ], { weight: 1 }, undefined, '(female)'),
...
dungeonList['Pokéball Factory'] = new Dungeon('Pokéball Factory',
    [
        ...
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Mightyena', 7112252, 36),
                new GymPokemon('Golbat', 7112252, 36),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Scraggy', 7112252, 36),
                new GymPokemon('Mightyena', 7112252, 36),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
        ...
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Scraggy', 7112252, 37),
                new GymPokemon('Houndoom', 7112252, 38),
            ],
...
dungeonList['Lost Hotel'] = new Dungeon('Lost Hotel',
    [
        ...
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Scrafty', 7351403, 39),
                new GymPokemon('Sharpedo', 7351403, 39),
                new GymPokemon('Pawniard', 7351403, 39),
            ],
            { weight: 1 }, 'Sid'),
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Skuntank', 7351403, 40),
                new GymPokemon('Crawdaunt', 7351403, 40),
            ], { weight: 1 }, 'Jacques'),
        new DungeonTrainer('Punk Guy',
            [new GymPokemon('Dunsparce', 7351403, 42)],
            { weight: 1 }, 'Slater'),
        new DungeonTrainer('Punk Girl',
            [
                new GymPokemon('Seviper', 7351403, 40),
                new GymPokemon('Arbok', 7351403, 40),
            ],
            { weight: 1 }, 'Jeanne'),
        new DungeonTrainer('Punk Girl',
            [
                new GymPokemon('Liepard', 7351403, 40),
                new GymPokemon('Liepard', 7351403, 40),
            ],
            { weight: 1 }, 'Cecile'),
    ],
...
dungeonList['Frost Cavern'] = new Dungeon('Frost Cavern',
    [
        ...
        new DungeonTrainer('Hiker',
            [new GymPokemon('Vibrava', 7231229, 44)],
            { weight: 1 }, 'Ross'),
        new DungeonTrainer('Sky Trainer',
            [
                new GymPokemon('Carnivine', 7231229, 41),
                new GymPokemon('Swanna', 7231229, 44),
            ], { weight: 1 }, 'Celso', '(male)'),
        new DungeonTrainer('Sky Trainer',
            [new GymPokemon('Cryogonal', 7231229, 45)],
            { weight: 1 }, 'Era', '(female)'),
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 7231229, 44)],
            { weight: 1 }, 'Salvador', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Doublade', 7231229, 46)],
            { weight: 1 }, 'Cordelia', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Raichu', 7231229, 42),
                new GymPokemon('Golduck', 7231229, 42),
                new GymPokemon('Marowak', 7231229, 43),
            ],
            { weight: 1 }, 'Neil', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Graveler', 7231229, 40),
                new GymPokemon('Graveler', 7231229, 41),
                new GymPokemon('Carbink', 7231229, 42),
            ], { weight: 1 }, 'Alain'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Relicanth', 7231229, 42),
                new GymPokemon('Rhydon', 7231229, 42),
            ],
            { weight: 1 }, 'Delmon'),
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Grumpig', 7231229, 44),
                new GymPokemon('Hariyama', 7231229, 46),
            ],
            { weight: 1 }, 'Eoin & Wolf'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Scrafty', 7231229, 43),
                new GymPokemon('Throh', 7231229, 44),
            ],
            { weight: 1 }, 'Alonzo'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Sawk', 7231229, 43),
                new GymPokemon('Mienshao', 7231229, 44),
            ],
            { weight: 1 }, 'Kinsey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Gurdurr', 7231229, 46)], { weight: 1 }, 'Kenji'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Probopass', 7231229, 44)],
            { weight: 1 }, 'Brent'),
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Medicham', 7231229, 46)],
            { weight: 1 }, 'Gabrielle'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 7231229, 42),
                new GymPokemon('Manectric', 7231229, 42),
            ],
            { weight: 1 }, undefined, '(female)'),
    ],
    [
...
dungeonList['Team Flare Secret HQ'] = new Dungeon('Team Flare Secret HQ',
    [
        ...
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Liepard', 7472777, 47),
                new GymPokemon('Manectric', 7472777, 48),
            ], { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Mightyena', 7472777, 47),
                new GymPokemon('Houndoom', 7472777, 48),
            ], { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Admin',
...
dungeonList['Terminus Cave'] = new Dungeon('Terminus Cave',
    [
        ...
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Graveler', 7595354, 46),
                new GymPokemon('Graveler', 7595354, 47),
                new GymPokemon('Golem', 7595354, 48),
            ],
            { weight: 1 }, 'Narek'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Steelix', 7595354, 48),
                new GymPokemon('Boldore', 7595354, 48),
            ], { weight: 1 }, 'Bergin'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Rhydon', 7595354, 50)],
            { weight: 1 }, 'Aaron'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Octillery', 7595354, 50)],
            { weight: 1 }, 'Dimitri'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Probopass', 7595354, 50)],
            { weight: 1 }, 'Yusif'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 7595354, 49),
                new GymPokemon('Conkeldurr', 7595354, 50),
            ], { weight: 1 }, 'Andrea'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Toxicroak', 7595354, 49),
                new GymPokemon('Sawk', 7595354, 50),
            ], { weight: 1 }, 'Gunnar'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Medicham', 7595354, 48),
                new GymPokemon('Hawlucha', 7595354, 51),
            ], { weight: 1 }, 'Hailey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 7595354, 52)],
            { weight: 1 }, 'Ricardo'),
    ],
    [
        {loot: 'xAttack', weight: 4},
...
dungeonList['Victory Road Kalos'] = new Dungeon('Victory Road Kalos',
    [
        ...
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Carbink', 7970352, 56),
                new GymPokemon('Raichu', 7970352, 56),
                new GymPokemon('Kingdra', 7970352, 57),
            ],
            { weight: 1 }, 'Robbie', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Weavile', 7970352, 60)], { weight: 1 }, 'Alanza', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Steelix', 7970352, 56),
                new GymPokemon('Electrode', 7970352, 56),
                new GymPokemon('Kangaskhan', 7970352, 57),
            ],
            { weight: 1 }, 'Bence', '(male)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Machamp', 7970352, 60)],
            { weight: 1 }, 'Markus'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Hawlucha', 7970352, 57),
                new GymPokemon('Mienshao', 7970352, 58),
            ],
            { weight: 1 }, 'Veronique'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Haxorus', 7970352, 58)], { weight: 1 }, 'Farid', '(male)'),
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Medicham', 7970352, 60)], { weight: 1 }, 'Sigrid'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Pangoro', 7970352, 57),
                new GymPokemon('Heracross', 7970352, 58),
            ], { weight: 1 }, 'Ander'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Espeon', 7970352, 58)],
            { weight: 1 }, 'William', '(male)'),
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Medicham', 7970352, 58),
                new GymPokemon('Gallade', 7970352, 60),
            ],
            { weight: 1 }, 'Arman & Hugo'),
        new DungeonTrainer('Fairy Tale Girl',
            [
                new GymPokemon('Azumarill', 7970352, 56),
                new GymPokemon('Florges (Red)', 7970352, 56),
            ], { weight: 1 }, 'Corinne'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Gourgeist', 7970352, 58)],
            { weight: 1 }, 'Raziah', '(kalos)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Slowbro', 7970352, 57),
                new GymPokemon('Altaria', 7970352, 57),
            ],
            { weight: 1 }, 'Petra', '(female)'),
        new DungeonTrainer('Veteran',
            [new GymPokemon('Talonflame', 7970352, 61)],
            { weight: 1 }, 'Inga', '(female)'),
        new DungeonTrainer('Pokémon Ranger',
            [new GymPokemon('Crobat', 7970352, 59)], { weight: 1 }, 'Ralf', '(male)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Banette', 7970352, 57),
                new GymPokemon('Leafeon', 7970352, 59),
            ], { weight: 1 }, 'Gerard'),
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 7970352, 58)], { weight: 1 }, 'Vincent', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Torkoal', 7970352, 56),
                new GymPokemon('Golem', 7970352, 56),
            ],
            { weight: 1 }, 'Corwin'),
    ],
    [
...
dungeonList['Trainers\' School'] = new Dungeon('Trainers\' School',
    [
        ...
        new DungeonTrainer('Youth Athlete',
            [new GymPokemon('Bonsly', 8555504, 7)], { weight: 1 }, 'Hiromi', '(female)'),
        new DungeonTrainer('Preschooler',
            [new GymPokemon('Metapod', 8555504, 7)], { weight: 1 }, 'Mia', '(female)'),
        new DungeonTrainer('Youngster',
            [new GymPokemon('Alolan Grimer', 8555504, 7)], { weight: 1 }, 'Joey'),
        new DungeonTrainer('Rising Star',
            [new GymPokemon('Ekans', 8555504, 8)], { weight: 1 }, 'Joseph', '(male)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    8555504,
    [
...
dungeonList['Hau\'oli Cemetery'] = new Dungeon('Hau\'oli Cemetery',
    [
        ...
        new DungeonTrainer('Pokémon Breeder',
            [new GymPokemon('Pikachu', 8690588, 9)], { weight: 1 }, 'Ikue', '(female)'),
        new DungeonTrainer('Office Worker',
            [new GymPokemon('Pikipek', 8690588, 9)], { weight: 1 }, 'Jeremy', '(male)'),
        new DungeonTrainer('Preschooler',
            [new GymPokemon('Happiny', 8690588, 8)], { weight: 1 }, 'Malia', '(female)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    8690588,
    [
...
dungeonList['Verdant Cavern'] = new Dungeon('Verdant Cavern',
    [
        ...
        new DungeonTrainer('Team Skull Grunt',
            [new GymPokemon('Drowzee', 8758770, 11)], { weight: 1 }, undefined, '(male)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    8758770,
    [
...
dungeonList['Melemele Meadow'] = new Dungeon('Melemele Meadow',
    [
        ...
        new DungeonTrainer('Actor',
            [new GymPokemon('Oricorio (Pom-pom)', 8826953, 12)], { weight: 1 }, 'Meredith'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    8826953,
    [
...
dungeonList['Paniola Ranch'] = new Dungeon('Paniola Ranch',
    [
        ...
        new DungeonTrainer('Madame',
            [new GymPokemon('Carbink', 9034074, 15)], { weight: 1 }, 'Elizabeth'),
        new DungeonTrainer('Pokémon Breeder',
            [new GymPokemon('Tauros', 9034074, 15)], { weight: 1 }, 'Wesley', '(male)'),
        new DungeonTrainer('Pokémon Breeder',
            [new GymPokemon('Mudbray', 9034074, 15)], { weight: 1 }, 'Glenn', '(male)'),
        new DungeonTrainer('Gentleman',
            [new GymPokemon('Sableye', 9034074, 15)], { weight: 1 }, 'Gerald'),
        new DungeonTrainer('Rising Star',
            [
                new GymPokemon('Lillipup', 9034074, 15),
                new GymPokemon('Magnemite', 9034074, 16),
            ], { weight: 1 }, 'Micah', '(male)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    9034074,
...
dungeonList['Brooklet Hill'] = new Dungeon('Brooklet Hill',
    [
        ...
        new DungeonTrainer('Fisherman',
            [new GymPokemon('Tentacool', 9103545, 16)], { weight: 1 }, 'Hal'),
        new DungeonTrainer('Fisherman',
            [
                new GymPokemon('Barboach', 9103545, 16),
                new GymPokemon('Goldeen', 9103545, 16),
            ], { weight: 1 }, 'Ernest'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Fletchling', 9103545, 16)], { weight: 1 }, 'Mikiko', '(female)'),
        new DungeonTrainer('Fisherman',
            [new GymPokemon('Poliwag', 9103545, 16)], { weight: 1 }, 'Herbert'),
        new DungeonTrainer('Fisherman',
            [
                new GymPokemon('Magikarp', 9103545, 16),
                new GymPokemon('Magikarp', 9103545, 16),
                new GymPokemon('Magikarp', 9103545, 16),
            ], { weight: 1 }, 'Carl'),
    ],
...
dungeonList['Wela Volcano Park'] = new Dungeon('Wela Volcano Park',
    [
        ...
        new DungeonTrainer('Sightseer',
            [new GymPokemon('Meowth', 9672294, 19)], { weight: 1 }, 'Mariah', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Noibat', 9672294, 20),
                new GymPokemon('Kadabra', 9672294, 21),
            ], { weight: 1 }, 'Jim', '(male)'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Roggenrola', 9672294, 19)], { weight: 1 }, 'Calhoun'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    9672294,
    [
...
dungeonList['Diglett\'s Tunnel'] = new Dungeon('Diglett\'s Tunnel',
    [
        ...
        new DungeonTrainer('Worker',
            [new GymPokemon('Shieldon', 9891134, 22)], { weight: 1 }, 'Frank'),
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Alolan Diglett', 9891134, 22),
                new GymPokemon('Alolan Diglett', 9891134, 22),
            ], { weight: 1 }, 'Jeff'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Archen', 9891134, 22)], { weight: 1 }, 'Vaclav'),
        new DungeonTrainer('Team Skull Grunt',
            [new GymPokemon('Ekans', 9891134, 23)], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
            [new GymPokemon('Salandit', 9891134, 23)], { weight: 1 }, undefined, '(male)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    9891134,
...
dungeonList['Memorial Hill'] = new Dungeon('Memorial Hill',
    [
        ...
        new DungeonTrainer('Preschooler',
            [
                new GymPokemon('Magby', 9964518, 23),
                new GymPokemon('Ledian', 9964518, 23),
            ], { weight: 1 }, 'Liam', '(male)'),
        new DungeonTrainer('Gentleman',
            [new GymPokemon('Jolteon', 9964518, 24)], { weight: 1 }, 'Smith'),
        new DungeonTrainer('Madame',
            [
                new GymPokemon('Furfrou', 9964518, 24),
                new GymPokemon('Comfey', 9964518, 24),
            ], { weight: 1 }, 'Sayuri'),
        new DungeonTrainer('Punk Girl',
            [new GymPokemon('Ariados', 9964518, 24)], { weight: 1 }, 'Melissa'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    9964518,
    [
...
dungeonList['Malie Garden'] = new Dungeon('Malie Garden',
    [
        ...
        new DungeonTrainer('Sightseer',
            [new GymPokemon('Raticate', 10112607, 28)], { weight: 1 }, 'Mitch', '(male)'),
        new DungeonTrainer('Preschooler',
            [new GymPokemon('Cleffa', 10112607, 27)], { weight: 1 }, 'Nancy', '(female)'),
        new DungeonTrainer('Sightseer',
            [new GymPokemon('Raichu', 10112607, 28)], { weight: 1 }, 'Akali', '(female)'),
        new DungeonTrainer('Tourist Couple',
            [
                new GymPokemon('Alolan Vulpix', 10112607, 28),
                new GymPokemon('Vulpix', 10112607, 28),
...
dungeonList['Ula\'ula Meadow'] = new Dungeon('Ula\'ula Meadow',
    [
        ...
        new DungeonTrainer('Dancer',
            [new GymPokemon('Floette (Red)', 11345289, 36)], { weight: 1 }, 'Mireille', '(female)'),
        new DungeonTrainer('Office Worker',
            [
                new GymPokemon('Torkoal', 11345289, 36),
                new GymPokemon('Whimsicott', 11345289, 36),
            ], { weight: 1 }, 'Michelle', '(female)'),
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Sneasel', 11345289, 35),
                new GymPokemon('Komala', 11345289, 35),
            ], { weight: 1 }, 'Rylee'),
        new DungeonTrainer('Golfer',
            [
                new GymPokemon('Hariyama', 11345289, 39),
                new GymPokemon('Alakazam', 11345289, 39),
            ], { weight: 1 }, 'Dean', '(male)'),
        new DungeonTrainer('Actor',
            [new GymPokemon('Oricorio (Baile)', 11345289, 36)], { weight: 1 }, 'Meredith'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    11345289,
    [
...
dungeonList['Po Town'] = new Dungeon('Po Town',
    [
        ...
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Alolan Raticate', 11505432, 37),
                new GymPokemon('Golbat', 11505432, 37),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Ekans', 11505432, 37),
                new GymPokemon('Salandit', 11505432, 37),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Fomantis', 11505432, 37),
                new GymPokemon('Mareanie', 11505432, 37),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
            [new GymPokemon('Scraggy', 11505432, 40)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Office Worker',
            [
                new GymPokemon('Elgyem', 11505432, 40),
                new GymPokemon('Metang', 11505432, 40),
            ], { weight: 1 }, 'Royce', '(male)'),
        new DungeonTrainer('Team Skull Grunt',
            [new GymPokemon('Drowzee', 11505432, 38)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Salandit', 11505432, 38),
                new GymPokemon('Fomantis', 11505432, 38),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Trubbish', 11505432, 38),
                new GymPokemon('Houndour', 11505432, 38),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
        ...
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Haunter', 11505432, 38),
                new GymPokemon('Alolan Grimer', 11505432, 38),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Skull Grunt',
            [
                new GymPokemon('Spinarak', 11505432, 38),
                new GymPokemon('Pawniard', 11505432, 38),
                new GymPokemon('Golbat', 11505432, 38),
            ], { weight: 1 }, undefined, '(female)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    11505432,
...
dungeonList['Aether Foundation'] = new Dungeon('Aether Foundation',
    [
        new DungeonTrainer('Aether Foundation Employee',
            [
                new GymPokemon('Alolan Dugtrio', 11667617, 40),
                new GymPokemon('Toucannon', 11667617, 40),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employee',
            [
                new GymPokemon('Kecleon', 11667617, 40),
                new GymPokemon('Stoutland', 11667617, 40),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Aether Foundation Employee',
            [
                new GymPokemon('Arbok', 11667617, 40),
                new GymPokemon('Lurantis', 11667617, 40),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Aether Foundation Employee',
            [
                new GymPokemon('Parasect', 11667617, 40),
                new GymPokemon('Drifblim', 11667617, 40),
                new GymPokemon('Sudowoodo', 11667617, 40),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employee',
        ...
        new DungeonTrainer('Aether Foundation Employees',
            [
                new GymPokemon('Anorith', 11667617, 41),
                new GymPokemon('Lileep', 11667617, 41),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employees',
            [
                new GymPokemon('Magmar', 11667617, 42),
                new GymPokemon('Houndoom', 11667617, 42),
                new GymPokemon('Electabuzz', 11667617, 42),
                new GymPokemon('Manectric', 11667617, 42),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Branch Chief',
            [
                new GymPokemon('Claydol', 11667617, 44),
                new GymPokemon('Bruxish', 11667617, 44),
                new GymPokemon('Hypno', 11667617, 44),
            ], { weight: 1 }, 'Faba', '(faba)'),
        new DungeonTrainer('Aether Foundation Employee',
        ...
        new DungeonTrainer('Aether Foundation Employees',
            [
                new GymPokemon('Huntail', 11667617, 41),
                new GymPokemon('Gorebyss', 11667617, 41),
        ...
        new DungeonTrainer('Team Skull Boss',
            [
                new GymPokemon('Golisopod', 11667617, 45),
                new GymPokemon('Vikavolt', 11667617, 45),
                new GymPokemon('Masquerain', 11667617, 45),
                new GymPokemon('Pinsir', 11667617, 45),
            ], { weight: 1 }, 'Guzma', '(guzma)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    11667617,
...
dungeonList['Vast Poni Canyon'] = new Dungeon('Vast Poni Canyon',
    [
        ...
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Beheeyem', 11994033, 47),
                new GymPokemon('Banette', 11994033, 47),
            ], { weight: 1 }, 'Harry', '(male)'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Spinda', 11994033, 45)], { weight: 1 }, 'Perdy', '(female)'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Alolan Sandslash', 11994033, 47),
                new GymPokemon('Alolan Ninetales', 11994033, 47),
            ], { weight: 1 }, 'Kent and Aimee'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Kabutops', 11994033, 46),
                new GymPokemon('Tyrantrum', 11994033, 46),
            ], { weight: 1 }, 'Zachary'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Xatu', 11994033, 48),
                new GymPokemon('Kangaskhan', 11994033, 48),
                new GymPokemon('Dewgong', 11994033, 48),
            ], { weight: 1 }, 'Lynn', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Mawile', 11994033, 47),
                new GymPokemon('Weavile', 11994033, 47),
            ], { weight: 1 }, 'Junko', '(female)'),
        new DungeonTrainer('Scientist',
            [new GymPokemon('Magnezone', 11994033, 46)], { weight: 1 }, 'Ikaika', '(male)'),
        new DungeonTrainer('Punk Girl',
            [new GymPokemon('Scrafty', 11994033, 46)], { weight: 1 }, 'Anna'),
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Pangoro', 11994033, 46),
                new GymPokemon('Crawdaunt', 11994033, 46),
            ], { weight: 1 }, 'Adam'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Poliwrath', 11994033, 47)], { weight: 1 }, 'Curtis'),
        new DungeonTrainer('Team Skull Grunt',
            [new GymPokemon('Pawniard', 11994033, 46)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Alolan Graveler', 11994033, 47),
                new GymPokemon('Lapras', 11994033, 48),
            ], { weight: 1 }, 'Hiroshi', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Talonflame', 11994033, 48),
                new GymPokemon('Wailord', 11994033, 48),
                new GymPokemon('Glaceon', 11994033, 48),
            ], { weight: 1 }, 'Heather', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Noctowl', 11994033, 48),
                new GymPokemon('Flygon', 11994033, 48),
                new GymPokemon('Slowking', 11994033, 48),
                new GymPokemon('Gengar', 11994033, 48),
            ], { weight: 1 }, 'Eric', '(male)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Crabominable', 11994033, 47)], { weight: 1 }, 'Terry'),
        new DungeonTrainer('Surfer',
            [new GymPokemon('Golduck', 11994033, 47)], { weight: 1 }, 'Joshah'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    11994033,
    [
...
dungeonList['Mount Lanakila'] = new Dungeon('Mount Lanakila',
    [
        ...
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Scyther', 12159638, 51),
                new GymPokemon('Malamar', 12159638, 52),
            ], { weight: 1 }, 'Seth', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Shiinotic', 12159638, 51),
                new GymPokemon('Clefable', 12159638, 52),
            ], { weight: 1 }, 'Kailee', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Lickitung', 12159638, 52),
                new GymPokemon('Goodra', 12159638, 52),
            ], { weight: 1 }, 'Alonsa', '(female)'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Relicanth', 12159638, 50)], { weight: 1 }, 'Ovid'),
        new DungeonTrainer('Sparring Partners',
            [
                new GymPokemon('Bewear', 12159638, 51),
                new GymPokemon('Mienfoo', 12159638, 51),
                new GymPokemon('Machamp', 12159638, 51),
            ], { weight: 1 }, 'Alon and Eimar'),
        new DungeonTrainer('Sparring Partners',
            [
                new GymPokemon('Hawlucha', 12159638, 51),
                new GymPokemon('Crabominable', 12159638, 51),
                new GymPokemon('Pangoro', 12159638, 51),
            ], { weight: 1 }, 'Craig and Jason'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Emolga', 12159638, 51)], { weight: 1 }, 'Peren', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Pyroar', 12159638, 53),
                new GymPokemon('Claydol', 12159638, 53),
                new GymPokemon('Milotic', 12159638, 53),
            ], { weight: 1 }, 'Ella', '(female)'),
        new DungeonTrainer('Collector',
            [new GymPokemon('Florges (White)', 12159638, 51)], { weight: 1 }, 'Minty'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Vanilluxe', 12159638, 52),
                new GymPokemon('Mismagius', 12159638, 53),
            ], { weight: 1 }, 'Jada', '(female)'),
        new DungeonTrainer('Master & Apprentice',
            [
                new GymPokemon('Vikavolt', 12159638, 52),
                new GymPokemon('Forretress', 12159638, 53),
                new GymPokemon('Glalie', 12159638, 53),
                new GymPokemon('Tyranitar', 12159638, 53),
                new GymPokemon('Bisharp', 12159638, 53),
            ], { weight: 1 }, 'Breon and Kaimana'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Gigalith', 12159638, 51)], { weight: 1 }, 'Anuhea'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Carbink', 12159638, 65),
                new GymPokemon('Torkoal', 12159638, 65),
                new GymPokemon('Pelipper', 12159638, 65),
                new GymPokemon('Alolan Ninetales', 12159638, 65),
                new GymPokemon('Gigalith', 12159638, 65),
...
dungeonList['Poni Meadow'] = new Dungeon('Poni Meadow',
    [
        ...
        new DungeonTrainer('Actor',
            [new GymPokemon('Oricorio (Sensu)', 12494976, 57)], { weight: 1 }, 'Meredith'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    12494976,
    [
...
dungeonList['Resolution Cave'] = new Dungeon('Resolution Cave',
    [
        ...
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Ribombee', 12835847, 61),
                new GymPokemon('Bewear', 12835847, 61),
            ], { weight: 1 }, 'Leticia', '(female)'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Manectric', 12835847, 59)], { weight: 1 }, 'Maria', '(female)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Alolan Dugtrio', 12835847, 59),
                new GymPokemon('Mudsdale', 12835847, 59),
            ], { weight: 1 }, 'Travis'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    12835847,
