...
dungeonList['Weather Institute'] = new Dungeon('Weather Institute',
    ...
    [
        ...
        new DungeonBossPokemon('Castform (Sunny)', 1820000, 20, {requirement: new MultiRequirement([new ObtainedPokemonRequirement('Castform'), new WeatherRequirement([WeatherType.Sunny])])}),
        new DungeonBossPokemon('Castform (Rainy)', 1820000, 20, {requirement: new MultiRequirement([new ObtainedPokemonRequirement('Castform'), new WeatherRequirement([WeatherType.Rain, WeatherType.Thunderstorm])])}),
        new DungeonBossPokemon('Castform (Snowy)', 1820000, 20, {requirement: new MultiRequirement([new ObtainedPokemonRequirement('Castform'), new WeatherRequirement([WeatherType.Snow, WeatherType.Blizzard, WeatherType.Hail])])}),
    ],
    26000, 101);
