...
dungeonList['Rose Tower'] = new Dungeon('Rose Tower',
    ...
    [
        ...
        new DungeonBossPokemon('Garbodor (G-Max)', 8000000, 70),
    ],
    96500, 201, 35);
...
dungeonList['Watchtower Ruins'] = new Dungeon('Watchtower Ruins',
    ['Gastly', 'Noibat', 'Purrlion', 'Duskull', 'Woobat', 'Haunter', 'Shuckle', 'Ralts', 'Golett', 'Elecktrike', 'Snorunt'],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2203000,
    [
...
dungeonList['West Lake Axwell'] = new Dungeon('West Lake Axwell',
    ['Dewbble', 'Wishiwashi', 'Bunnelby', 'Tympole', 'Palpitoad', 'Remoraid', 'Budew', 'Lotad', 'Krabby', 'Delibird', 'Joltik'],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2203000,
    [
...
dungeonList['South Lake Miloch'] = new Dungeon('South Lake Miloch',
    ['Nincada', 'Roselia', 'Corphish', 'Pyukumuku', 'Bronzor', 'Galvantula', 'Theivul', 'Machoke', 'Whiscash', 'Octillery', 'Wingull'],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    2203000,
    [
        new DungeonBossPokemon('Jellicent', 8000000, 70),
