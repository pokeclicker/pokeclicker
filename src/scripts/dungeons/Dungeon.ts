...
dungeonList['P2 Laboratory'] = new Dungeon('P2 Laboratory',
    ...
    [
        ...
        new DungeonTrainer('Team Plasma',
            [
                new GymPokemon('Magneton', 44000000, 72),
                new GymPokemon('Rotom (wash)', 44000000, 72),
                new GymPokemon('Metagross', 44000000, 72),
                new GymPokemon('Beheeyem', 44000000, 72),
                new GymPokemon('Magnezone', 44000000, 72),
                new GymPokemon('Klinklang', 48000000, 74),
            ], 1, { weight: 1 }, 'Colress', '(colress)'),
    ],
    396500, 18, 100);
