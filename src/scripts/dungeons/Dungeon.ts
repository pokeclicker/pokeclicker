...
dungeonList['Magma Hideout'] = new Dungeon('Magma Hideout',
    [
        ...
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Poochyena', 30000, 29)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Numel', 30000, 29)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Mightyena', 30000, 29)],
            1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Magma Grunt',
            [
                new GymPokemon('Baltoy', 30000, 28),
                new GymPokemon('Numel', 30000, 28),
            ],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Zubat', 30000, 29)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Numel', 30000, 29)],
            1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Magma Grunt',
            ...
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Baltoy', 30000, 29)],
            1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Magma Grunt',
            [new GymPokemon('Baltoy', 30000, 29)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Magma Admin',
            [
                new GymPokemon('Numel', 16000, 26),
                new GymPokemon('Mightyena', 18000, 28),
                new GymPokemon('Zubat', 20000, 30),
                new GymPokemon('Camerupt', 23000, 33),
            ],
            1, { weight: 1 }, 'Tabitha'),
    ],
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
