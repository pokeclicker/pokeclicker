...
dungeonList['Mount Lanakila'] = new Dungeon('Mount Lanakila',
    ...
    [
        ...
        new DungeonBossPokemon('Necrozma', 83527125, 65, { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eater of Light', 4), new GymBadgeRequirement(BadgeEnums.Champion_Stamp)]) }),
        new DungeonTrainer('Trial Site',
            [
