...
dungeonList['Radio Tower'] = new Dungeon('Radio Tower',
    ...
    [
        ...
        {loot: 'Lucky_egg', weight: 4},
        {loot: 'Ultraball', weight: 3},
        {loot: 'Persim', weight: 1},
        {loot: 'Razz', weight: 1},
        {loot: 'Bluk', weight: 1},
        {loot: 'Nanab', weight: 1},
        {loot: 'Wepear', weight: 1},
        {loot: 'Pinap', weight: 1},
        {loot: 'Figy', weight: 1},
        {loot: 'Wiki', weight: 1},
        {loot: 'Mago', weight: 1},
        {loot: 'Aguav', weight: 1},
        {loot: 'Iapapa', weight: 1},
        {loot: 'Max Revive', weight: 0},
        {loot: 'Lum', weight: 0},
    ],
    112000,
...
dungeonList['Paniola Ranch'] = new Dungeon('Paniola Ranch',
    ...
    12161328,
    [
        new DungeonBossPokemon('Tauros', 30403320, 15),
        new DungeonBossPokemon('Miltank', 30403320, 15),
    ],
    855000, 4, 15);
