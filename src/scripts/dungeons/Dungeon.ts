...
dungeonList['Cave of Origin'] = new Dungeon('Cave of Origin',
    ...
    [
        ...
        new DungeonBossPokemon('Primal Kyogre', 95743340, 80, {requirement: new MultiRequirement([new ObtainedPokemonRequirement('Deoxys (Attack)'), new QuestLineCompletedRequirement('Primal Reversion'), new WeatherRequirement([WeatherType.Rain])])}),
        new DungeonBossPokemon('Primal Groudon', 95743340, 80, {requirement: new MultiRequirement([new ObtainedPokemonRequirement('Deoxys (Attack)'), new QuestLineCompletedRequirement('Primal Reversion'), new WeatherRequirement([WeatherType.Sunny])])}),
    ],
    34000, 101);
