...
dungeonList['Team Rocket\'s Hideout'] = new Dungeon('Team Rocket\'s Hideout',
    ...
    [
        ...
        {loot: 'Protein', weight: 0, requirement: new ClearDungeonRequirement(400, GameConstants.getDungeonIndex('Team Rocket\'s Hideout'))},
        {loot: 'Blue Shard', weight: 3},
        {loot: 'Purple Shard', weight: 3},
    ],
    104100,
    [
        new DungeonTrainer('Rocket Executive',
...
dungeonList['Oreburgh Gate'] = new Dungeon('Oreburgh Gate',
    ...
    [
        {loot: 'xAttack', weight: 3.75},
        {loot: 'Dowsing_machine', weight: 3.5},
...
dungeonList['Victory Road Sinnoh'] = new Dungeon('Victory Road Sinnoh',
    ...
    [
        ...
        {loot: 'Crimson Shard', weight: 3},
        {loot: 'Lime Shard', weight: 3},
        {loot: 'White Shard', weight: 3},
        {loot: 'Black Shard', weight: 3},
    ],
    1503000,
    [
...
dungeonList['Delta Petalburg Woods'] = new Dungeon('Delta Petalburg Woods',
    [
        {pokemon: 'Zigzagoon', options: { weight: 1.33 }},
        {pokemon: 'Wurmple', options: { weight: 1.33 }},
        {pokemon: 'Silcoon', options: { weight: 1.33 }},
        {pokemon: 'Cascoon', options: { weight: 1.33 }},
        {pokemon: 'Taillow', options: { weight: 1.33 }},
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Beedrill', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 104);
...
dungeonList['Delta Rusturf Tunnel'] = new Dungeon('Delta Rusturf Tunnel',
    [
        ...
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 10795422, 16),
                new GymPokemon('Geodude', 10795422, 16),
...
dungeonList['Delta Granite Cave'] = new Dungeon('Delta Granite Cave',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Sableye', 53977110, 50)],
            { weight: 1 }, undefined),
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Mawile', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 106);
...
dungeonList['Delta Fiery Path'] = new Dungeon('Delta Fiery Path',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Camerupt', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 112);
...
dungeonList['Delta Meteor Falls'] = new Dungeon('Delta Meteor Falls',
    [
        ...
        {pokemon: 'Zubat', options: { weight: 1.6 }},
        {pokemon: 'Golbat', options: { weight: 1.6 }},
        {pokemon: 'Goldeen', options: { weight: 1.6 }},
        {pokemon: 'Magikarp', options: { weight: 1.6 }},
        {pokemon: 'Barboach', options: { weight: 1.6 }},
        {pokemon: 'Whiscash', options: { weight: 1.6 }},
        {pokemon: 'Bagon', options: { weight: 1.6 }},
        {pokemon: 'Druddigon', options: { weight: 1.6 }},
        {pokemon: 'Deino', options: { weight: 1.6 }},
        new DungeonTrainer('Dragon Tamer',
            [new GymPokemon('Flygon', 10795422, 47)],
            { weight: 1 }, 'Nicolas'),
        new DungeonTrainer('Old Couple',
            [
                new GymPokemon('Medicham', 10795422, 39),
                new GymPokemon('Hariyama', 10795422, 39),
            ], { weight: 1 }, 'John and Jay'),
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Mienshao', 10795422, 46)],
            { weight: 1 }, 'Tess'),
        new DungeonTrainer('Dragon Tamer',
    ...
    [
        ...
        new DungeonBossPokemon('Lunatone', 53977110, 20),
        new DungeonTrainer('Dragon Tamer',
            [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Salamence', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 114);
...
dungeonList['Delta Jagged Pass'] = new Dungeon('Delta Jagged Pass',
    [
        ...
        {pokemon: 'Machop', options: { weight: 2.7 }},
        {pokemon: 'Ponyta', options: { weight: 2.7 }},
        {pokemon: 'Tyrogue', options: { weight: 2.7 }},
        {pokemon: 'Numel', options: { weight: 2.7 }},
        {pokemon: 'Spoink', options: { weight: 2.7 }},
        new DungeonTrainer('Hiker',
            [new GymPokemon('Graveler', 10795422, 25)],
            { weight: 1 }, 'Eric'),
        new DungeonTrainer('Camper',
            [new GymPokemon('Gulpin', 10795422, 24)],
            { weight: 1 }, 'Ethan'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Gloom', 10795422, 22),
                new GymPokemon('Swablu', 10795422, 22),
            ], { weight: 1 }, 'Diana'),
        new DungeonTrainer('Fairy Tale Girl',
            [
                new GymPokemon('Skitty', 10795422, 21),
    ...
    [
        new DungeonTrainer('Expert',
            [
                new GymPokemon('Meditite', 26988555, 24),
                new GymPokemon('Hariyama', 26988555, 26),
...
dungeonList['Delta New Mauville'] = new Dungeon('Delta New Mauville',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Manectric', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 115);
...
dungeonList['Delta Mt. Pyre'] = new Dungeon('Delta Mt. Pyre',
    [
        ...
        {pokemon: 'Growlithe', options: { weight: 4.5 }},
        {pokemon: 'Wingull', options: { weight: 4.5 }},
        {pokemon: 'Meditite', options: { weight: 4.5 }},
        {pokemon: 'Shuppet', options: { weight: 4.5 }},
        {pokemon: 'Duskull', options: { weight: 4.5 }},
        {pokemon: 'Bronzor', options: { weight: 4.5 }},
        {pokemon: 'Elgyem', options: { weight: 4.5 }},
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Lairon', 10795422, 36)],
            { weight: 1 }, 'Mark'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Staryu', 10795422, 35),
                new GymPokemon('Grumpig', 10795422, 35),
            ],
            { weight: 1 }, 'William', '(male)'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Sableye', 10795422, 36)],
            { weight: 1 }, 'Valerie', '(hoenn)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Machoke', 10795422, 37)],
            { weight: 1 }, 'Atsushi'),
        new DungeonTrainer('Fairy Tale Girl',
            [new GymPokemon('Jigglypuff', 10795422, 35)],
            { weight: 1 }, 'Momo'),
        new DungeonTrainer('Young Couple',
            [
                new GymPokemon('Delcatty', 10795422, 36),
                new GymPokemon('Manectric', 10795422, 36),
            ],
            { weight: 1 }, 'Dez & Luke'),
        new DungeonTrainer('Mysterious Sisters',
            [
                new GymPokemon('Girafarig', 10795422, 36),
                new GymPokemon('Mawile', 10795422, 36),
            ],
            { weight: 1 }, 'Elle & Aya'),
        new DungeonTrainer('Hex Maniac',
            [
                new GymPokemon('Shuppet', 10795422, 34),
                new GymPokemon('Xatu', 10795422, 34),
            ],
            { weight: 1 }, 'Tasha', '(hoenn)'),
        new DungeonTrainer('Backpacker',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Banette', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 122);
...
dungeonList['Delta Shoal Cave'] = new Dungeon('Delta Shoal Cave',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Glalie', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 125);
...
dungeonList['Delta Sky Pillar'] = new Dungeon('Delta Sky Pillar',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Rayquaza', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 131);
...
dungeonList['Delta Victory Road Hoenn'] = new Dungeon('Delta Victory Road Hoenn',
    [
        {pokemon: 'Zubat', options: { weight: 4 }},
        {pokemon: 'Golbat', options: { weight: 4 }},
        {pokemon: 'Tentacool', options: { weight: 4 }},
        {pokemon: 'Tentacruel', options: { weight: 4 }},
        {pokemon: 'Goldeen', options: { weight: 4 }},
        {pokemon: 'Magikarp', options: { weight: 4 }},
        {pokemon: 'Loudred', options: { weight: 4 }},
        {pokemon: 'Hariyama', options: { weight: 4 }},
        ...
        {pokemon: 'Lairon', options: { weight: 4 }},
        {pokemon: 'Medicham', options: { weight: 4 }},
        {pokemon: 'Wailmer', options: { weight: 4 }},
        {pokemon: 'Luvdisc', options: { weight: 4 }},
        {pokemon: 'Barboach', options: { weight: 4 }},
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Sigilyph', 10795422, 45),
                new GymPokemon('Rhyperior', 10795422, 45),
            ], { weight: 1 }, 'Albert', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Froslass', 10795422, 47)],
            { weight: 1 }, 'Hope', '(female)'),
        new DungeonTrainer('Expert',
            [
                new GymPokemon('Hitmontop', 10795422, 45),
                new GymPokemon('Throh', 10795422, 45),
            ], { weight: 1 }, 'Bryn', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Mawile', 10795422, 47)],
            { weight: 1 }, 'Edgar', '(male)'),
        new DungeonTrainer('Street Thug',
            [
                new GymPokemon('Houndoom', 10795422, 43),
                new GymPokemon('Shiftry', 10795422, 43),
            ], { weight: 1 }, 'Regan'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Armaldo', 10795422, 47),
                new GymPokemon('Cradily', 10795422, 47),
            ], { weight: 1 }, 'Jude & Rory'),
        new DungeonTrainer('Expert',
            [new GymPokemon('Sawk', 10795422, 47)],
            { weight: 1 }, 'Theodore', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Electrode', 10795422, 44),
                new GymPokemon('Darmanitan', 10795422, 44),
                new GymPokemon('Swalot', 10795422, 44),
            ], { weight: 1 }, 'Vito', '(male)'),
        new DungeonTrainer('Dragon Tamer',
            [new GymPokemon('Kingdra', 10795422, 47)],
            { weight: 1 }, 'Egon'),
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Musharna', 10795422, 47),
    ...
    [
        new DungeonTrainer('PKMN Trainer',
            [
                new GymPokemon('Altaria', 10295422, 46),
                new GymPokemon('Delcatty', 10295422, 46),
                new GymPokemon('Roselia', 10295422, 46),
                new GymPokemon('Magneton', 10295422, 46),
                new GymPokemon('Mega Gallade', 12795422, 48),
            ], { weight: 1 }, 'Wally', '(wally)'),
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Mega Gallade', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 128);
...
dungeonList['Marine Cave'] = new Dungeon('Marine Cave',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Primal Kyogre', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 133);
...
dungeonList['Terra Cave'] = new Dungeon('Terra Cave',
    ...
    [
        ...
        new DungeonTrainer('Mega Challenge',
            [new GymPokemon('Primal Groudon', 53977110, 50)],
            { weight: 1 }, undefined),
    ],
    754000, 113);
