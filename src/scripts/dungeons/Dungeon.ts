...
dungeonList['Abundant Shrine'] = new Dungeon('Abundant Shrine',
    ...
    [
        ...
        {loot: 'Fighting_egg', weight: 1},
        {loot: 'Max Revive', weight: 0},
        {loot: 'Micle', weight: 0, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Abundant Shrine'))},
        {loot: 'Custap', weight: 0, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Abundant Shrine'))},
        {loot: 'Rowap', weight: 0, requirement: new ClearDungeonRequirement(50, GameConstants.getDungeonIndex('Abundant Shrine'))},
        {loot: 'Jaboca', weight: 0, requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Abundant Shrine'))},
...
dungeonList['Glittering Cave'] = new Dungeon('Glittering Cave',
    ...
    [
        ...
        {loot: 'Jaw Fossil', weight: 0},
        {loot: 'Sail Fossil', weight: 0},
    ],
    7037500,
    [
