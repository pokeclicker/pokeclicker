...
dungeonList['Parfum Palace Garden'] = new Dungeon('Parfum Palace Garden',
    ...
    6153195,
    [
        new DungeonBossPokemon('Furfrou (Heart)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Heart)')}),
        new DungeonBossPokemon('Furfrou (Star)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Star)')}),
        new DungeonBossPokemon('Furfrou (Diamond)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Diamond)')}),
        new DungeonBossPokemon('Furfrou (Debutante)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Debutante)')}),
        new DungeonBossPokemon('Furfrou (Matron)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Matron)')}),
        new DungeonBossPokemon('Furfrou (Dandy)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Dandy)')}),
        new DungeonBossPokemon('Furfrou (La Reine)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (La Reine)')}),
        new DungeonBossPokemon('Furfrou (Kabuki)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Kabuki)')}),
        new DungeonBossPokemon('Furfrou (Pharaoh)', 55803095, 15, {hide: true, requirement : new ObtainedPokemonRequirement('Furfrou (Pharaoh)')}),
    ],
    437500, 6
);
