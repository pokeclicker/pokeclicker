...
dungeonList['Stark Mountain'] = new Dungeon('Stark Mountain',
    [   
        ...
        new DungeonTrainer('Bird Keeper & Black Belt',
            [
        ...
        new DungeonTrainer('Dragon Tamer & Black Belt',
            [
