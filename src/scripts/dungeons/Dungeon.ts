...
dungeonList['Mt. Pyre'] = new Dungeon('Mt. Pyre',
    [
        ...
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Rhyhorn', 46000, 31)],
            1, { weight: 1 }, 'Mark'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Spoink', 46000, 31)],
            1, { weight: 1 }, 'Leah'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 46000, 31)],
            1, { weight: 1 }, 'Mark'),
        new DungeonTrainer('Young Couple',
            [
                new GymPokemon('Delcatty', 46000, 31),
                new GymPokemon('Manectric', 46000, 31),
            ],
            1, { weight: 1 }, 'Dez & Luke'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Wobbuffet', 46000, 26),
                new GymPokemon('Natu', 46000, 26),
                new GymPokemon('Kadabra', 46000, 26),
            ],
            1, { weight: 1 }, 'Kayla', '(female)'),
        new DungeonTrainer('Pokémon Breeder',
            [
                ...
                new GymPokemon('Taillow', 28000, 26),
            ],
            1, { weight: 1 }, 'Gabrielle', '(female)'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Ralts', 46000, 26),
                new GymPokemon('Ralts', 46000, 26),
                new GymPokemon('Kirlia', 46000, 26),
            ],
            1, { weight: 1 }, 'William', '(male)'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Shuppet', 46000, 32)],
            1, { weight: 1 }, 'Tasha'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 46000, 32)],
            1, { weight: 1 }, 'Atsushi'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Sableye', 46000, 32)],
            1, { weight: 1 }, 'Valerie'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Wobbuffet', 46000, 32)],
            1, { weight: 1 }, 'Cedric', '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Carvanha', 46000, 32)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [new GymPokemon('Zubat', 46000, 32)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Poochyena', 46000, 30),
                new GymPokemon('Carvanha', 46000, 30),
            ],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Aqua Grunt',
            [
                new GymPokemon('Wailmer', 46000, 30),
                new GymPokemon('Zubat', 46000, 30),
            ],
            1, { weight: 1 }, undefined, '(female)'),
    ],
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.Lucky_egg],
