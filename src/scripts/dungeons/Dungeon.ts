...
dungeonList['Viridian Forest'] = new Dungeon('Viridian Forest',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Weedle', 100, 6),
                new GymPokemon('Caterpie', 100, 6),
            ], { weight: 1 }, 'Rick'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Weedle', 100, 7),
                new GymPokemon('Kakuna', 100, 7),
                new GymPokemon('Weedle', 100, 7),
            ], { weight: 1 }, 'Doug'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Caterpie', 100, 7),
                new GymPokemon('Caterpie', 100, 8),
            ], { weight: 1 }, 'Anthony'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Metapod', 100, 7),
                new GymPokemon('Caterpie', 100, 7),
                new GymPokemon('Metapod', 100, 7),
            ], { weight: 1 }, 'Charlie'),
    ],
    ...
    202,
    [
        new DungeonBossPokemon('Pikachu', 1010, 7),
        new DungeonTrainer('Bug Catcher',
            [new GymPokemon('Weedle', 1010, 9)],
            { weight: 1 }, 'Sammy'),
    ],
    50, 1, 5
);
...
dungeonList['Digletts Cave'] = new Dungeon('Digletts Cave',
    ...
    2408,
    [new DungeonBossPokemon('Dugtrio', 12040, 31)],
    95, 2, 22
);
...
dungeonList['Mt. Moon'] = new Dungeon('Mt. Moon',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Weedle', 150, 11),
                new GymPokemon('Kakuna', 150, 11),
            ], { weight: 1 }, 'Kent'),
        new DungeonTrainer('Lass',
            [new GymPokemon('Clefairy', 150, 14)],
            { weight: 1 }, 'Iris'),
        new DungeonTrainer('Super Nerd',
            [
                new GymPokemon('Magnemite', 150, 11),
                new GymPokemon('Voltorb', 150, 11),
            ], { weight: 1 }, 'Jovan'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Caterpie', 150, 10),
                new GymPokemon('Metapod', 150, 10),
                new GymPokemon('Caterpie', 150, 10),
            ], { weight: 1 }, 'Robby'),
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Oddish', 150, 11),
                new GymPokemon('Bellsprout', 150, 11),
            ], { weight: 1 }, 'Miriam'),
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Rattata', 150, 10),
                new GymPokemon('Rattata', 150, 10),
                new GymPokemon('Zubat', 150, 10),
            ], { weight: 1 }, 'Josh'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 150, 10),
                new GymPokemon('Geodude', 150, 10),
                new GymPokemon('Onix', 150, 10),
            ], { weight: 1 }, 'Marcos'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Sandshrew', 150, 11),
                new GymPokemon('Rattata', 150, 11),
                new GymPokemon('Zubat', 150, 11),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 150, 13),
                new GymPokemon('Ekans', 150, 13),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 150, 13),
                new GymPokemon('Sandshrew', 150, 13),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Rattata', 150, 13),
    ...
    1634,
    [
        new DungeonBossPokemon('Kabuto', 8170, 12, {requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Mt. Moon'))}),
        new DungeonBossPokemon('Omanyte', 8170, 12, {requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Mt. Moon'))}),
        new DungeonTrainer('Super Nerd',
            [
                new GymPokemon('Grimer', 5280, 12),
                new GymPokemon('Voltorb', 5280, 12),
                new GymPokemon('Koffing', 5280, 12),
            ], { weight: 1 }, 'Miguel'),
    ],
    75, 4, 10
);
...
dungeonList['Rock Tunnel'] = new Dungeon('Rock Tunnel',
    [
        ...
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Cubone', 1000, 23),
                new GymPokemon('Slowpoke', 1000, 23),
            ], { weight: 1 }, 'Ashton'),
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Slowpoke', 1000, 25)],
            { weight: 1 }, 'Winston'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Oddish', 1000, 22),
                new GymPokemon('Bulbasaur', 1000, 22),
            ], { weight: 1 }, 'Martha'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Charmander', 1000, 22),
                new GymPokemon('Cubone', 1000, 22),
            ], { weight: 1 }, 'Steve'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Geodude', 1000, 25)],
            { weight: 1 }, 'Allen'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Machop', 1000, 20),
                new GymPokemon('Onix', 1000, 20),
            ], { weight: 1 }, 'Eric'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 1000, 19),
                new GymPokemon('Onix', 1000, 19),
                new GymPokemon('Geodude', 1000, 19),
                new GymPokemon('Geodude', 1000, 19),
            ], { weight: 1 }, 'Lenny'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Onix', 1000, 20),
                new GymPokemon('Onix', 1000, 20),
                new GymPokemon('Geodude', 1000, 20),
            ], { weight: 1 }, 'Oliver'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 1000, 21),
                new GymPokemon('Graveler', 1000, 21),
            ], { weight: 1 }, 'Lucas'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Jigglypuff', 1000, 21),
                new GymPokemon('Pidgey', 1000, 21),
                new GymPokemon('Meowth', 1000, 21),
            ], { weight: 1 }, 'Sofia'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Geodude', 1000, 21),
        ...
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Slowpoke', 1000, 20),
                new GymPokemon('Slowpoke', 1000, 20),
                new GymPokemon('Slowpoke', 1000, 20),
            ], { weight: 1 }, 'Cooper'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Bellsprout', 1000, 22),
                new GymPokemon('Clefairy', 1000, 22),
            ], { weight: 1 }, 'Leah'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Meowth', 1000, 20),
                new GymPokemon('Oddish', 1000, 20),
                new GymPokemon('Pidgey', 1000, 20),
            ], { weight: 1 }, 'Dana'),
    ],
    ...
    8117,
    [
        new DungeonBossPokemon('Onix', 40585, 17),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Pidgey', 26586, 19),
                new GymPokemon('Rattata', 26586, 19),
                new GymPokemon('Rattata', 26586, 19),
                new GymPokemon('Bellsprout', 26586, 19),
            ], { weight: 1 }, 'Ariana'),
    ],
    500, 5, 15
);
...
dungeonList['Power Plant'] = new Dungeon('Power Plant',
    ...
    26507,
    [
        new DungeonBossPokemon('Electabuzz', 127535, 35),
        new DungeonBossPokemon('Zapdos', 201302, 50),
    ],
    1000, 8, 25
);
...
dungeonList['Pokemon Tower'] = new Dungeon('Pokemon Tower',
    [
        ...
        new DungeonTrainer('Channeler',
            [new GymPokemon('Gastly', 1500, 23)],
            { weight: 1 }, 'Hope'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Gastly', 1500, 22)],
            { weight: 1 }, 'Patricia'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Gastly', 1500, 24)],
            { weight: 1 }, 'Carly'),
        new DungeonTrainer('Channeler',
            [
                new GymPokemon('Gastly', 1500, 23),
        ...
        new DungeonTrainer('Channeler',
            ...
            { weight: 1 }, 'Ruth'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Haunter', 1500, 23)],
            { weight: 1 }, 'Tammy'),
        new DungeonTrainer('Channeler',
            [new GymPokemon('Gastly', 1500, 24)],
            { weight: 1 }, 'Karina'),
        ...
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 1500, 25),
                new GymPokemon('Zubat', 1500, 25),
                new GymPokemon('Golbat', 1500, 25),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Koffing', 1500, 26),
                new GymPokemon('Drowzee', 1500, 26),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Rocket Grunt',
            [
                new GymPokemon('Zubat', 1500, 23),
                new GymPokemon('Rattata', 1500, 23),
                new GymPokemon('Raticate', 1500, 23),
                new GymPokemon('Zubat', 1500, 23),
            ], { weight: 1 }, undefined, '(male)'),
    ],
    ...
    15523,
    [new DungeonBossPokemon('Marowak', 75615, 30)],
    750, 10, 20
);
...
dungeonList['Seafoam Islands'] = new Dungeon('Seafoam Islands',
    ...
    35226,
    [
        new DungeonBossPokemon('Seel', 175130, 35),
        new DungeonBossPokemon('Articuno', 259195, 50),
    ],
    1250, 15, 30
);
...
dungeonList['Pokemon Mansion'] = new Dungeon('Pokemon Mansion',
    [
        ...
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Ekans', 3000, 33),
                new GymPokemon('Ekans', 3000, 33),
                new GymPokemon('Raticate', 3000, 34),
            ], { weight: 1 }, 'Johnson'),
        new DungeonTrainer('Burglar',
            [
                new GymPokemon('Charmander', 3000, 34),
                new GymPokemon('Charmeleon', 3000, 34),
            ], { weight: 1 }, 'Arnie'),
        new DungeonTrainer('Burglar',
            [new GymPokemon('Ninetales', 3000, 38)],
            { weight: 1 }, 'Simon'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Magnemite', 3000, 33),
                new GymPokemon('Magneton', 3000, 33),
                new GymPokemon('Voltorb', 3000, 33),
            ], { weight: 1 }, 'Braydon', '(male)'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Electrode', 3000, 29),
                new GymPokemon('Weezing', 3000, 29),
            ], { weight: 1 }, 'Ted', '(male)'),
        new DungeonTrainer('Burglar',
            [
                new GymPokemon('Growlithe', 3000, 34),
                new GymPokemon('Ponyta', 3000, 34),
            ], { weight: 1 }, 'Lewis'),
        new DungeonTrainer('Scientist',
            [
                new GymPokemon('Magnemite', 3000, 34),
                new GymPokemon('Electrode', 3000, 34),
            ], { weight: 1 }, 'Ivan', '(male)'),
    ],
    ...
    34760,
    [new DungeonBossPokemon('Magmar', 176800, 40)],
    1500, 16, 35
);
...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    [
        ...
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Persian', 4000, 42),
                new GymPokemon('Ponyta', 4000, 42),
                new GymPokemon('Rapidash', 4000, 42),
                new GymPokemon('Vulpix', 4000, 42),
                new GymPokemon('Ninetales', 4000, 42),
            ], { weight: 1 }, 'Naomi', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Raticate', 4000, 42),
                new GymPokemon('Ivysaur', 4000, 42),
                new GymPokemon('Wartortle', 4000, 42),
                new GymPokemon('Charmeleon', 4000, 42),
                new GymPokemon('Charizard', 4000, 42),
            ], { weight: 1 }, 'Rolando', '(male)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Machoke', 4000, 43),
                new GymPokemon('Machop', 4000, 43),
                new GymPokemon('Machoke', 4000, 43),
            ], { weight: 1 }, 'Daisuke'),
        new DungeonTrainer('Juggler',
            [
                new GymPokemon('Drowzee', 4000, 41),
                new GymPokemon('Hypno', 4000, 41),
                new GymPokemon('Kadabra', 4000, 41),
                new GymPokemon('Kadabra', 4000, 41),
            ], { weight: 1 }, 'Nelson'),
        new DungeonTrainer('Tamer',
            [
                new GymPokemon('Persian', 4000, 44),
                new GymPokemon('Golduck', 4000, 44),
            ], { weight: 1 }, 'Vincent'),
        new DungeonTrainer('Juggler',
            [new GymPokemon('Mr. Mime', 4000, 48)],
            { weight: 1 }, 'Gregory'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Exeggutor', 4000, 42),
                new GymPokemon('Sandslash', 4000, 42),
                new GymPokemon('Cloyster', 4000, 42),
                new GymPokemon('Electrode', 4000, 42),
                new GymPokemon('Arcanine', 4000, 42),
            ], { weight: 1 }, 'George', '(male)'),
        new DungeonTrainer('PokéManiac',
            [
                new GymPokemon('Charmeleon', 4000, 40),
                new GymPokemon('Lapras', 4000, 40),
                new GymPokemon('Lickitung', 4000, 40),
            ], { weight: 1 }, 'Dawson'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Clefairy', 4000, 42),
                new GymPokemon('Jigglypuff', 4000, 42),
                new GymPokemon('Persian', 4000, 42),
                new GymPokemon('Dewgong', 4000, 42),
                new GymPokemon('Chansey', 4000, 42),
            ], { weight: 1 }, 'Alexa', '(female)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Kingler', 4000, 41),
                new GymPokemon('Poliwhirl', 4000, 42),
                new GymPokemon('Tentacruel', 4000, 42),
                new GymPokemon('Seadra', 4000, 42),
                new GymPokemon('Blastoise', 4000, 42),
            ], { weight: 1 }, 'Colby', '(male)'),
        new DungeonTrainer('Cooltrainer',
            [
                new GymPokemon('Bellsprout', 4000, 42),
                new GymPokemon('Weepinbell', 4000, 42),
                new GymPokemon('Victreebel', 4000, 42),
                new GymPokemon('Paras', 4000, 42),
                new GymPokemon('Parasect', 4000, 42),
            ], { weight: 1 }, 'Caroline', '(female)'),
    ],
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    48595,
    [
        new DungeonBossPokemon('Machoke', 242975, 42),
        new DungeonBossPokemon('Moltres', 364462, 50),
        new DungeonTrainer('Cool Couple',
            [
                new GymPokemon('Nidoking', 242975, 45),
                new GymPokemon('Nidoqueen', 242975, 45),
            ], { weight: 1 }, 'Ray & Tyra'),
    ],
    2000, 20, 40
);
...
dungeonList['Cerulean Cave'] = new Dungeon('Cerulean Cave',
    ...
    28735,
    [
        new DungeonBossPokemon('Rhydon', 363675, 60),
        new DungeonBossPokemon('Mewtwo', 505512, 100),
    ],
    2500, 20, 55
);
...
dungeonList['Aether Foundation'] = new Dungeon('Aether Foundation',
    [
        ...
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Anorith', 3500000, 41)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Lileep', 3500000, 41)], { weight: 1 }, undefined, '(male)'),
        ...
        new DungeonTrainer('Aether Branch Chief',
            [
                ...
                new GymPokemon('Ledian', 33254840, 42),
                new GymPokemon('Pupitar', 33254840, 42),
            ], { weight: 1 }, 'Faba'),
        new DungeonTrainer('Aether Foundation Employee',
        ...
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Huntail', 3500000, 41)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Gorebyss', 3500000, 41)], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
