...
dungeonList['Kalos Power Plant'] = new Dungeon('Kalos Power Plant',//keep going from here down
    ...
    [
        new DungeonTrainer('Team Flare',
            [new GymPokemon('Mightyena', 75384400, 38)], 1, { weight: 1 }, 'Aliana', '(aliana)'),
...
dungeonList['Pokéball Factory'] = new Dungeon('Pokéball Factory',
    [
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Toxicroak', 8173950, 37)], 1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
        ...
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Swalot', 8173950, 37)], 1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
...
dungeonList['Frost Cavern'] = new Dungeon('Frost Cavern',
    [
        ...
        new DungeonTrainer('Battle Girl',
            ...
            1, { weight: 1 }, 'Kinsey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Gurdurr', 8537490, 46)],1, { weight: 1 }, 'Kenji'),
        new DungeonTrainer('Hiker',
...
dungeonList['Team Flare Secret HQ'] = new Dungeon('Team Flare Secret HQ',
    [
        new DungeonTrainer('Team Flare Admin',
            ...
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Liepard', 8739480, 48)],1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Manectric', 8739480, 50)],
            1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Mightyena', 8739480, 48)],1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Houndoom', 8739480, 50)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Scrafty', 8739480, 48)],1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
...
dungeonList['Victory Road Kalos'] = new Dungeon('Victory Road Kalos',
    [
        ...
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Weavile', 3500000, 60)],1, { weight: 1 }, 'Alanza', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
        ...
        new DungeonTrainer('Backpacker ',
            [new GymPokemon('Haxorus', 3500000, 58)], 1, { weight: 1 }, 'Farid', '(male)'),
        new DungeonTrainer('Batlle Girl',
            [new GymPokemon('Medicham', 3500000, 60)], 1, { weight: 1 }, 'Sigrid'),
        new DungeonTrainer('Black Belt',
            [
        ...
        new DungeonTrainer('Pokémon Ranger',
            [new GymPokemon('Crobat', 3500000, 59)], 1, { weight: 1 }, 'Ralf', '(male)'),
        new DungeonTrainer('Black Belt',
            [
        ...
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 3500000, 58)],1, { weight: 1 }, 'Vincent'),
        new DungeonTrainer('Hiker',
            [
