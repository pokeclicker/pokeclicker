...
dungeonList['Pokemon Mansion'] = new Dungeon('Pokemon Mansion',
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Token_collector, GameConstants.BattleItemType.Lucky_incense],
    17760,
...
dungeonList['Victory Road'] = new Dungeon('Victory Road',
    ...
    [GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.xAttack, GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet, GameConstants.BattleItemType.Lucky_incense],
    24595,
    [
