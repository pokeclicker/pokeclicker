...
dungeonList['Wela Volcano Park'] = new Dungeon('Wela Volcano Park',
    [
        ...
        {pokemon: 'Nihilego', options: { weight: 1.7, hide: true, requirement: new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 2)}},
...
dungeonList['Diglett\'s Tunnel'] = new Dungeon('Diglett\'s Tunnel',
    [
        ...
        {pokemon: 'Nihilego', options: { weight: 6.5, hide: true, requirement: new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 2)}},
        new DungeonTrainer('Worker',
