...
dungeonList['Tower of Darkness'] = new Dungeon('Tower of Darkness',
    ...
    2000000, 40,
    () => {
        App.game.party.gainPokemonById(892, PokemonFactory.generateShiny(GameConstants.SHINY_CHANCE_GIFTED));
        Notifier.notify({
...
dungeonList['Tower of Waters'] = new Dungeon('Tower of Waters',
    ...
    2000000, 36,
    () => {
        App.game.party.gainPokemonById(892.1, PokemonFactory.generateShiny(GameConstants.SHINY_CHANCE_GIFTED));
        Notifier.notify({
