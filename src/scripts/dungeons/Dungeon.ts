...
dungeonList['Moor of Icirrus'] = new Dungeon('Moor of Icirrus',
    [
        ...
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Accelgor', 2083186, 62),
                new GymPokemon('Swalot', 2083186, 62),
                new GymPokemon('Kecleon', 2083186, 62),
            ], { weight: 1 }, 'Elaine', '(female)'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Escavalier', 2083186, 62),
                new GymPokemon('Skuntank', 2083186, 62),
                new GymPokemon('Carnivine', 2083186, 62),
            ], { weight: 1 }, 'Parker', '(male)'),
        new DungeonTrainer('Fisherman',
            [
                new GymPokemon('Corphish', 2083186, 60),
                new GymPokemon('Poliwag', 2083186, 60),
                new GymPokemon('Stunfisk', 2083186, 60),
            ], { weight: 1 }, 'Eustace'),
        new DungeonTrainer('Fisherman',
            [
                new GymPokemon('Poliwhirl', 2083186, 60),
                new GymPokemon('Whiscash', 2083186, 60),
                new GymPokemon('Politoed', 2083186, 60),
            ], { weight: 1 }, 'Arnold'),
    ],
    [
        {loot: 'xAttack', weight: 4},
