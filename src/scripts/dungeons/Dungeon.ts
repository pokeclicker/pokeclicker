...
dungeonList['Ula\'ula Meadow'] = new Dungeon('Ula\'ula Meadow',
    [
        ...
        new DungeonTrainer('Actor',
            [new GymPokemon('Oricorio (Baile)', 15127052, 36)], { weight: 1 }, 'Meredith', '(female)'),
    ],
    [{loot: 'xClick', weight: 4}, {loot: 'Item_magnet', weight: 4}],
    15127052,
    [
...
dungeonList['Aether Foundation'] = new Dungeon('Aether Foundation',
    [
        ...
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Anorith', 15619682, 41)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Lileep', 15619682, 41)], { weight: 1 }, undefined, '(male)'),
        ...
        new DungeonTrainer('Aether Branch Chief',
            [
                ...
                new GymPokemon('Ledian', 15619682, 42),
                new GymPokemon('Pupitar', 15619682, 42),
            ], { weight: 1 }, 'Faba'),
        new DungeonTrainer('Aether Foundation Employee',
        ...
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Huntail', 15619682, 41)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Aether Foundation Employee',
            [new GymPokemon('Gorebyss', 15619682, 41)], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Skull Grunt',
