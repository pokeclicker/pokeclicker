...
dungeonList['Santalune Forest'] = new Dungeon('Santalune Forest',
    [
        ...
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Scatterbug', 7426354, 3),
                new GymPokemon('Fletchling', 7426354, 3),
            ], { weight: 1 }, 'Joey'),
        new DungeonTrainer('Lass',
            [new GymPokemon('Pikachu', 7426354, 5)],
            { weight: 1 }, 'Anna'),
    ],
    [
    ...
    [
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Weedle', 18565885, 2),
                new GymPokemon('Bunnelby', 18565885, 4),
            ], { weight: 1 }, 'Lise'),
        new DungeonBossPokemon('Pikachu', 37131770, 4),
    ],
    400000, 2
);
...
dungeonList['Parfum Palace'] = new Dungeon('Parfum Palace',
    ...
    8126092,
    [new DungeonBossPokemon('Furfrou', 40630460, 50)],
    445000, 6);
...
dungeonList['Connecting Cave'] = new Dungeon('Connecting Cave',
    ...
    [
        new DungeonTrainer('Pokémon Breeder',
            [
                new GymPokemon('Ducklett', 10338287, 12),
                new GymPokemon('Pikachu', 10338287, 12),
                new GymPokemon('Litleo', 10338288, 12),
                new GymPokemon('Oddish', 10338288, 12),
            ],
            { weight: 1 }, 'Mercy', '(female)'),
        new DungeonBossPokemon('Axew', 41353150, 20),
    ],
    475000, 7);
...
dungeonList['Glittering Cave'] = new Dungeon('Glittering Cave',
    [
        ...
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Houndour', 8564346, 18),
                new GymPokemon('Zubat', 8564346, 18),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Gulpin', 8564346, 18),
                new GymPokemon('Electrike', 8564346, 18),
            ], { weight: 1 }, undefined, '(female)'),
    ],
    [
        {loot: 'xClick', weight: 4},
    ...
    [
        new DungeonTrainer('Team Flare Grunt Duo',
            [
                new GymPokemon('Scraggy', 21410865, 20),
                new GymPokemon('Croagunk', 21410865, 20),
            ], { weight: 1 }, undefined),
        new DungeonBossPokemon('Kangaskhan', 42821730, 20),
        new DungeonBossPokemon('Mawile', 42821730, 20),
    ],
    505000, 9);
...
dungeonList['Reflection Cave'] = new Dungeon('Reflection Cave',
    [
        ...
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 8864284, 25),
                new GymPokemon('Hawlucha', 8864284, 26),
            ], { weight: 1 }, 'Hedvig'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Sandile', 8864284, 23),
                new GymPokemon('Dwebble', 8864284, 23),
                new GymPokemon('Diggersby', 8864284, 24),
            ], { weight: 1 }, 'Dunstan'),
        ...
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Chimecho', 8864284, 24),
                new GymPokemon('Golett', 8864284, 24),
            ], { weight: 1 }, 'Franz', '(male)'),
        new DungeonTrainer('Tourist',
        ...
        new DungeonTrainer('Honeymooners',
            [
                new GymPokemon('Combee', 8864284, 26),
                new GymPokemon('Vespiquen', 8864284, 26),
            ], { weight: 1 }, 'Yuu & Ami'),
    ],
    [
        {loot: 'Token_collector', weight: 4},
    ...
    [
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Absol', 22160710, 26),
                new GymPokemon('Pinsir', 22160710, 25),
            ], { weight: 1 }, 'Emil', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Doduo', 14773806, 24),
                new GymPokemon('Granbull', 14773807, 24),
                new GymPokemon('Helioptile', 14773807, 25),
...
dungeonList['Kalos Power Plant'] = new Dungeon('Kalos Power Plant',
    [
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Croagunk', 9325952, 32),
                new GymPokemon('Scraggy', 9325952, 32),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 9325952, 32),
                new GymPokemon('Scraggy', 9325952, 32),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Mightyena', 9325952, 34)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 9325952, 32),
                new GymPokemon('Mightyena', 9325952, 32),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 9325952, 33),
                new GymPokemon('Croagunk', 9325952, 31),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Liepard', 9325952, 31),
                new GymPokemon('Scraggy', 9325952, 31),
                new GymPokemon('Croagunk', 9325952, 31),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Swalot', 9325952, 34)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Liepard', 9325952, 31),
                new GymPokemon('Swalot', 9325952, 33),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Houndoom', 9325952, 36)],
    ...
    [
        new DungeonTrainer('Team Flare Aliana',
            [new GymPokemon('Mightyena', 46629760, 38)], { weight: 1 }),
...
dungeonList['Sea Spirit\'s Den'] = new Dungeon('Sea Spirit\'s Den',
    ...
    9170488,
    [new DungeonBossPokemon('Lugia', 45852440, 100)],
    600000, 23);

dungeonList['Pokéball Factory'] = new Dungeon('Pokéball Factory',
    [
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Toxicroak', 9483002, 37)], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Mightyena', 9483002, 36),
                new GymPokemon('Golbat', 9483002, 36),
            ], { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Scraggy', 9483002, 36),
                new GymPokemon('Mightyena', 9483002, 36),
            ], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Swalot', 9483002, 37)], { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Scraggy', 9483002, 37),
                new GymPokemon('Houndoom', 9483002, 38),
            ],
    ...
    [
        new DungeonTrainer('Team Flare Celosia',
            [new GymPokemon('Manectric', 47415010, 41)],
            { weight: 1 }),
        new DungeonTrainer('Team Flare Bryony',
            [new GymPokemon('Liepard', 47415010, 41)],
            { weight: 1 }),
    ],
    615000, 14);
...
dungeonList['Lost Hotel'] = new Dungeon('Lost Hotel',
    [
        ...
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Scrafty', 9801870, 39),
                new GymPokemon('Sharpedo', 9801870, 39),
                new GymPokemon('Pawniard', 9801870, 39),
            ],
            { weight: 1 }, 'Sid'),
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Skuntank', 9801870, 40),
                new GymPokemon('Crawdaunt', 9801870, 40),
            ], { weight: 1 }, 'Jacques'),
        new DungeonTrainer('Punk Guy',
            [new GymPokemon('Dunsparce', 9801870, 42)],
            { weight: 1 }, 'Slater'),
        new DungeonTrainer('Punk Girl',
            [
                new GymPokemon('Seviper', 9801870, 40),
                new GymPokemon('Arbok', 9801870, 40),
            ],
            { weight: 1 }, 'Jeanne'),
        new DungeonTrainer('Punk Girl',
            [
                new GymPokemon('Liepard', 9801870, 40),
                new GymPokemon('Liepard', 9801870, 40),
            ],
            { weight: 1 }, 'Cecile'),
    ],
    ...
    [
        new DungeonTrainer('Punk Couple',
            [
                new GymPokemon('Garbodor', 24504675, 42),
                new GymPokemon('Pangoro', 24504675, 42),
            ], { weight: 2 }, 'Zoya & Asa'),
        new DungeonBossPokemon('Rotom', 49009350, 38),
    ],
    635000, 15);
...
dungeonList['Frost Cavern'] = new Dungeon('Frost Cavern',
    [
        ...
        new DungeonTrainer('Hiker',
            [new GymPokemon('Vibrava', 9641638, 44)],
            { weight: 1 }, 'Ross'),
        new DungeonTrainer('Sky Trainer',
            [
                new GymPokemon('Carnivine', 9641638, 41),
                new GymPokemon('Swanna', 9641638, 44),
            ], { weight: 1 }, 'Celso', '(male)'),
        new DungeonTrainer('Sky Trainer',
            [new GymPokemon('Cryogonal', 9641638, 45)],
            { weight: 1 }, 'Era', '(female)'),
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 9641638, 44)],
            { weight: 1 }, 'Salvador', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Doublade', 9641638, 46)],
            { weight: 1 }, 'Cordelia', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Raichu', 9641638, 42),
                new GymPokemon('Golduck', 9641638, 42),
                new GymPokemon('Marowak', 9641638, 43),
            ],
            { weight: 1 }, 'Neil', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Graveler', 9641638, 40),
                new GymPokemon('Graveler', 9641638, 41),
                new GymPokemon('Carbink', 9641638, 42),
            ], { weight: 1 }, 'Alain'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Relicanth', 9641638, 42),
                new GymPokemon('Rhydon', 9641638, 42),
            ],
            { weight: 1 }, 'Delmon'),
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Grumpig', 9641638, 44),
                new GymPokemon('Hariyama', 9641638, 46),
            ],
            { weight: 1 }, 'Eoin & Wolf'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Scrafty', 9641638, 43),
                new GymPokemon('Throh', 9641638, 44),
            ],
            { weight: 1 }, 'Alonzo'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Sawk', 9641638, 43),
                new GymPokemon('Mienshao', 9641638, 44),
            ],
            { weight: 1 }, 'Kinsey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Gurdurr', 9641638, 46)], { weight: 1 }, 'Kenji'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Probopass', 9641638, 44)],
            { weight: 1 }, 'Brent'),
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Medicham', 9641638, 46)],
            { weight: 1 }, 'Gabrielle'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 9641638, 42),
                new GymPokemon('Manectric', 9641638, 42),
            ],
            { weight: 1 }, undefined, '(female)'),
    ],
    [
    ...
    [
        new DungeonTrainer('Team Flare Mable',
            [new GymPokemon('Houndoom', 48208190, 48)],
            { weight: 1 }),
        new DungeonBossPokemon('Abomasnow', 48208190, 50),
    ],
    665500, 15);
...
dungeonList['Team Flare Secret HQ'] = new Dungeon('Team Flare Secret HQ',
    [
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Toxicroak', 9963702, 50)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Liepard', 9963702, 48)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Manectric', 9963702, 50)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Mightyena', 9963702, 48)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Houndoom', 9963702, 50)],
            { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Scrafty', 9963702, 48)],
            { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Liepard', 9963702, 47),
                new GymPokemon('Manectric', 9963702, 48),
            ], { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Mightyena', 9963702, 47),
                new GymPokemon('Houndoom', 9963702, 48),
            ], { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Swalot', 9963702, 50)],
            { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Golbat', 9963702, 50)],
            { weight: 2 }, undefined, '(male)'),
    ],
    [
        {loot: 'Item_magnet', weight: 4},
    ...
    [
        new DungeonTrainer('Team Flare Lysandre',
            [
                new GymPokemon('Mienshao', 11454627, 49),
                new GymPokemon('Honchkrow', 11954627, 49),
                new GymPokemon('Pyroar', 12954628, 51),
                new GymPokemon('Mega Gyarados', 13454628, 53),
            ],
            { weight: 2 }),
        new DungeonBossPokemon('Xerneas', 49818510, 100, {requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Flare Secret HQ'))}),
        new DungeonBossPokemon('Yveltal', 49818510, 100, {requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Team Flare Secret HQ'))}),
    ],
    675000, 16);
...
dungeonList['Terminus Cave'] = new Dungeon('Terminus Cave',
    [
        ...
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Graveler', 10127138, 46),
                new GymPokemon('Graveler', 10127138, 47),
                new GymPokemon('Golem', 10127138, 48),
            ],
            { weight: 1 }, 'Narek'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Steelix', 10127138, 48),
                new GymPokemon('Boldore', 10127138, 48),
            ], { weight: 1 }, 'Bergin'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Rhydon', 10127138, 50)],
            { weight: 1 }, 'Aaron'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Octillery', 10127138, 50)],
            { weight: 1 }, 'Dimitri'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Probopass', 10127138, 50)],
            { weight: 1 }, 'Yusif'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 10127138, 49),
                new GymPokemon('Conkeldurr', 10127138, 50),
            ], { weight: 1 }, 'Andrea'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Toxicroak', 10127138, 49),
                new GymPokemon('Sawk', 10127138, 50),
            ], { weight: 1 }, 'Gunnar'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Medicham', 10127138, 48),
                new GymPokemon('Hawlucha', 10127138, 51),
            ], { weight: 1 }, 'Hailey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 10127138, 52)],
            { weight: 1 }, 'Ricardo'),
    ],
    [
        {loot: 'xAttack', weight: 4},
    ...
    [
        new DungeonTrainer('Pokémon Rangers',
            [
                new GymPokemon('Nidoqueen', 25317845, 51),
                new GymPokemon('Nidoking', 25317845, 51),
            ], { weight: 3 }, 'Fern & Lee'),
...
dungeonList['Pokémon Village'] = new Dungeon('Pokémon Village',
    ...
    10458850,
    [
        new DungeonBossPokemon('Ditto', 52294250, 50),
        new DungeonBossPokemon('Zoroark', 52294250, 50),
    ],
    725000, 20);
...
dungeonList['Victory Road Kalos'] = new Dungeon('Victory Road Kalos',
    [
        ...
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Carbink', 10627136, 56),
                new GymPokemon('Raichu', 10627136, 56),
                new GymPokemon('Kingdra', 10627136, 57),
            ],
        ...
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Steelix', 10627136, 56),
                new GymPokemon('Electrode', 10627136, 56),
                new GymPokemon('Kangaskhan', 10627136, 57),
            ],
            { weight: 1 }, 'Bence', '(male)'),
        new DungeonTrainer('Black Belt',
        ...
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Hawlucha', 10627136, 57),
                new GymPokemon('Mienshao', 10627136, 58),
            ],
            { weight: 1 }, 'Veronique'),
        new DungeonTrainer('Backpacker',
        ...
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Pangoro', 10627136, 57),
                new GymPokemon('Heracross', 10627136, 58),
            ], { weight: 1 }, 'Ander'),
        new DungeonTrainer('Psychic',
        ...
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Medicham', 10627136, 58),
                new GymPokemon('Gallade', 10627136, 60),
            ],
            { weight: 1 }, 'Arman & Hugo'),
        new DungeonTrainer('Fairy Tale Girl',
            [
                new GymPokemon('Azumarill', 10627136, 56),
                new GymPokemon('Florges (Red)', 10627136, 56),
            ], { weight: 1 }, 'Corinne'),
        new DungeonTrainer('Hex Maniac',
        ...
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Slowbro', 10627136, 57),
                new GymPokemon('Altaria', 10627136, 57),
            ],
        ...
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Banette', 10627136, 57),
                new GymPokemon('Leafeon', 10627136, 59),
            ], { weight: 1 }, 'Gerard'),
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 10627136, 58)], { weight: 1 }, 'Vincent', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Torkoal', 10627136, 56),
                new GymPokemon('Golem', 10627136, 56),
            ],
            { weight: 1 }, 'Corwin'),
    ],
    [
    ...
    [
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Magcargo', 26567840, 57),
                new GymPokemon('Scizor', 26567840, 58),
            ],
            { weight: 1 }, 'Michele', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Trevenant', 26567840, 57),
                new GymPokemon('Gigalith', 26567840, 59),
            ], { weight: 1 }, 'Timeo', '(male)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Glaceon', 26567840, 57),
                new GymPokemon('Snorlax', 26567840, 59),
            ], { weight: 1 }, 'Catrina', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Skarmory', 17711893, 55),
                new GymPokemon('Umbreon', 17711893, 55),
                new GymPokemon('Alakazam', 17711894, 57),
