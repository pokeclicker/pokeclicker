...
dungeonList['Max Lair'] = new Dungeon('Max Lair',
    ['Ivysaur', 'Charmeleon', 'Wartortle', 'Grovyle', 'Sceptile', 'Combusken', 'Blaziken', 'Marshtomp', 'Swampert', 'Cradily', 'Cofagrigus', 'Fraxure', 'Toxtricity (Amped)', 'Toxtricity (Low Key)'],
    {
        ...
        mythic: [
            {loot: 'Protein'},
            {loot: 'Calcium', requirement: new ClearDungeonRequirement(100, GameConstants.getDungeonIndex('Max Lair'))},
            {loot: 'Carbos', requirement: new ClearDungeonRequirement(250, GameConstants.getDungeonIndex('Max Lair'))},
            {loot: 'Rare_Candy', requirement: new ClearDungeonRequirement(500, GameConstants.getDungeonIndex('Max Lair'))},
            ],
    },
    33915762,
    [
