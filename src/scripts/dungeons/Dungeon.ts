...
dungeonList['P2 Laboratory'] = new Dungeon('P2 Laboratory',
    ['Frillish', 'Finneon', 'Horsea', 'Herdier', 'Magneton', 'Klang', 'Weezing', 'Watchog', 'Scrafty', 'Audino'],
    {
        ...
        epic: [
            ...
            {loot: 'Zap Plate'},
            {loot: 'Great_Twisted_Spoon', ignoreDebuff : true, weight: 3, requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 5), new ItemRequirement(1, 'Great_Twisted_Spoon', GameConstants.AchievementOption.less)])},
        ],
        legendary: [{loot: 'Revive'}],
    },
    5403000,
