...
dungeonList['Floaro Gardens'] = new Dungeon('Floaro Gardens',
    ...
    35537738,
    [
        new DungeonBossPokemon('Beautifly', 177688690, 31, {weight: 2}),
        new DungeonBossPokemon('Dustox', 177688690, 31, {weight: 2}),
...
dungeonList['Shrouded Ruins'] = new Dungeon('Shrouded Ruins',
    ['Gastly', 'Haunter', 'Lickitung', 'Rhyhorn', 'Ralts', 'Kirlia', 'Carnivine', 'Burmy (Sand)', 'Geodude', 'Graveler'],
    {
        ...
        rare: [
            { loot: 'Black Shard' },
            // {loot: 'Beige Shard'},
            { loot: 'Spiritomb (Wisp)', ignoreDebuff: true, requirement: new QuestLineStepCompletedRequirement('Arceus: The Deified Pokémon', 14) },
        ],
        epic: [
            { loot: 'Spooky Plate' },
            { loot: 'Dread Plate' },
...
dungeonList['Firespit Island'] = new Dungeon('Firespit Island',
    ...
    49820652,
    [
        new DungeonBossPokemon('Ninetales', 249103260, 61, {weight: 4}),
...
dungeonList['Clamberclaw Cliffs'] = new Dungeon('Clamberclaw Cliffs',
    ...
    51641042,
    [
        new DungeonBossPokemon('Bronzong', 258205210, 55, {weight: 2}),
        new DungeonBossPokemon('Gabite', 258205210, 56, {weight: 2}),
        ...
        new DungeonBossPokemon('Cresselia', 344387435, 70, { hide: true, requirement: new QuestLineStepCompletedRequirement('Arceus: The Deified Pokémon', 12) }),
    ],
...
dungeonList['Ancient Lake Verity'] = new Dungeon('Ancient Lake Verity',
    ...
    57832692,
    [
        new DungeonBossPokemon('Hisuian Goodra', 289163460, 58, { hide: true, requirement: new QuestLineStepCompletedRequirement('The Origin of Sinnoh', 4), weight: 4 }),
...
dungeonList['Ancient Lake Valor'] = new Dungeon('Ancient Lake Valor',
    ...
    57832692,
    [
        new DungeonBossPokemon('Overqwil', 289163460, 58, { hide: true, requirement: new QuestLineStepCompletedRequirement('The Origin of Sinnoh', 4), weight: 4 }),
...
dungeonList['Ancient Lake Acuity'] = new Dungeon('Ancient Lake Acuity',
    ...
    57832692,
    [
        new DungeonBossPokemon('Hisuian Zoroark', 289163460, 58, { hide: true, requirement: new QuestLineStepCompletedRequirement('The Origin of Sinnoh', 4), weight: 4 }),
