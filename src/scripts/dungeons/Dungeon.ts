...
dungeonList['Phenac City Battles'] = new Dungeon('Phenac City Battles',
    [
        ...
        new DungeonTrainer('Cipher Peon XD',
            [
    ...
    [
        ...
        new DungeonTrainer('Cipher Peon XD',
            ...
            ], { weight: 1, hide: true, requirement: new QuestLineCompletedRequirement('Gale of Darkness')}, 'Fostin', '(male)'),
    ],
    38000, 110);
...
dungeonList['Cipher Key Lair'] = new Dungeon('Cipher Key Lair',
    [
        ...
        new DungeonTrainer('Cipher',
            ...
            ], { weight: 1, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Cipher Key Lair'), GameConstants.AchievementOption.less) }, 'Peon XD Fudler', '(commander)'),
        new DungeonTrainer('Cipher',
            [
            ...
            ], { weight: 0.25}, 'Peon XD Angic', '(commander)'),
        new DungeonTrainer('Scientist',
            [
...
dungeonList['Citadark Isle'] = new Dungeon('Citadark Isle', //Skipped some filler trainers with no shadow mons, since this dungeon is very full
    [
        ...
        new DungeonTrainer('Cipher',
            ...
            ], { weight: 0.25}, 'Peon XD Grupel', '(commander)'),
        new DungeonTrainer('Cipher Peon XD',
            [
        ...
        new DungeonTrainer('Cipher Peon XD',
            ...
            ], { weight: 1, requirement: new ClearDungeonRequirement(175, GameConstants.getDungeonIndex('Citadark Isle'), GameConstants.AchievementOption.less) }, 'Kolin', '(female)'),
        new DungeonTrainer('Cipher',
            [
            ...
            ], { weight: 0.25}, 'Peon XD Karbon', '(commander)'),
        new DungeonTrainer('Cipher',
            [
            ...
            ], { weight: 0.25}, 'Peon XD Petro', '(commander)'),
        new DungeonTrainer('Cipher Peon XD',
            [
