...
dungeonList['Delta Petalburg Woods'] = new Dungeon('Delta Petalburg Woods',
    [
        ...
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Wurmple', 12000, 5),
                new GymPokemon('Wurmple', 12000, 5),
                new GymPokemon('Wurmple', 12000, 5),
            ], { weight: 1 }, 'Lyle'),
        new DungeonTrainer('Bug Catcher',
            [
                new GymPokemon('Nincada', 12000, 8),
            ], { weight: 1 }, 'James'),
    ],
    [
        {loot: 'Pokeball', weight: 3.75},
...
dungeonList['Delta Rusturf Tunnel'] = new Dungeon('Delta Rusturf Tunnel',
    ...
    400000,
    [new DungeonBossPokemon('Whismur', 860000, 10)],
    14000, 101);
...
dungeonList['Delta Granite Cave'] = new Dungeon('Delta Granite Cave',
    ...
    410000,
    [
        new DungeonBossPokemon('Sableye', 660000, 20),
...
dungeonList['Delta Meteor Falls'] = new Dungeon('Delta Meteor Falls',
    [
        {pokemon: 'Clefairy', options: { weight: 0.8 }},
        {pokemon: 'Zubat', options: { weight: 0.8 }},
        {pokemon: 'Golbat', options: { weight: 0.8 }},
        {pokemon: 'Goldeen', options: { weight: 0.8 }},
        {pokemon: 'Magikarp', options: { weight: 0.8 }},
        {pokemon: 'Barboach', options: { weight: 0.8 }},
        {pokemon: 'Whiscash', options: { weight: 0.8 }},
        {pokemon: 'Bagon', options: { weight: 0.8 }},
        {pokemon: 'Druddigon', options: { weight: 0.8 }},
        {pokemon: 'Deino', options: { weight: 0.8 }},
        new DungeonTrainer('Dragon Tamer',
            [new GymPokemon('Flygon', 37000, 47)],
            { weight: 1 }, 'Nicolas'),
        new DungeonTrainer('Old Couple',
            [
                new GymPokemon('Medicham', 18000, 39),
        ...
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Mienshao', 37000, 46)],
            { weight: 1 }, 'Tess'),
        new DungeonTrainer('Dragon Tamer',
            [new GymPokemon('Altaria', 37000, 47)],
            { weight: 1 }, 'Dray'),
    ],
    [
        {loot: 'Lucky_incense', weight: 4},
...
dungeonList['Delta Jagged Pass'] = new Dungeon('Delta Jagged Pass',
    [
        {pokemon: 'Mankey', options: { weight: 0.8 }},
        {pokemon: 'Machop', options: { weight: 0.8 }},
        {pokemon: 'Ponyta', options: { weight: 0.8 }},
        {pokemon: 'Tyrogue', options: { weight: 0.8 }},
        {pokemon: 'Numel', options: { weight: 0.8 }},
        {pokemon: 'Spoink', options: { weight: 0.8 }},
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Graveler', 22000, 25),
            ], { weight: 1 }, 'Eric'),
        new DungeonTrainer('Camper',
            [new GymPokemon('Gulpin', 22000, 24)],
            { weight: 1 }, 'Ethan'),
        new DungeonTrainer('Picnicker',
            [
                new GymPokemon('Gloom', 22000, 22),
                new GymPokemon('Swablu', 22000, 22),
            ], { weight: 1 }, 'Diana'),
        new DungeonTrainer('Fairy Tale Girl',
            [
                new GymPokemon('Skitty', 22000, 21),
                new GymPokemon('Jigglypuff', 22000, 23),
            ], { weight: 1 }, 'Nellie'),
    ],
    [
        {loot: 'xClick', weight: 3.5},
    ...
    [
        new DungeonTrainer('Expert',
            [
                new GymPokemon('Meditite', 700000, 24),
                new GymPokemon('Hariyama', 700000, 26),
...
dungeonList['Delta Mt. Pyre'] = new Dungeon('Delta Mt. Pyre',
    [
        ...
        {pokemon: 'Vulpix', options: { weight: 12 }},
        {pokemon: 'Growlithe', options: { weight: 12 }},
        {pokemon: 'Wingull', options: { weight: 12 }},
        {pokemon: 'Meditite', options: { weight: 12 }},
        {pokemon: 'Shuppet', options: { weight: 12 }},
        {pokemon: 'Duskull', options: { weight: 12 }},
        {pokemon: 'Bronzor', options: { weight: 12 }},
        {pokemon: 'Elgyem', options: { weight: 12 }},
        new DungeonTrainer('PokéManiac',
            [new GymPokemon('Lairon', 28000, 36)],
            { weight: 1 }, 'Mark'),
        new DungeonTrainer('Psychic',
            [
                new GymPokemon('Staryu', 28000, 35),
                new GymPokemon('Grumpig', 28000, 35),
            ],
            { weight: 1 }, 'William', '(male)'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Sableye', 28000, 36)],
            { weight: 1 }, 'Valerie', '(hoenn)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Machoke', 28000, 37)],
            { weight: 1 }, 'Atsushi'),
        new DungeonTrainer('Fairy Tale Girl',
            [new GymPokemon('Jigglypuff', 22000, 35)],
            { weight: 1 }, 'Momo'),
        new DungeonTrainer('Young Couple',
            [
                new GymPokemon('Delcatty', 28000, 36),
                new GymPokemon('Manectric', 28000, 36),
            ],
            { weight: 1 }, 'Dez & Luke'),
        new DungeonTrainer('Mysterious Sisters',
            [
                new GymPokemon('Girafarig', 28000, 36),
                new GymPokemon('Mawile', 28000, 36),
            ],
            { weight: 1 }, 'Elle & Aya'),
        new DungeonTrainer('Hex Maniac',
            [
                new GymPokemon('Shuppet', 28000, 34),
                new GymPokemon('Xatu', 28000, 34),
            ],
            { weight: 1 }, 'Tasha', '(hoenn)'),
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Kecleon', 28000, 36)],
...
dungeonList['Delta Victory Road Hoenn'] = new Dungeon('Delta Victory Road Hoenn',
    [
        ...
        {pokemon: 'Sableye', options: { weight: 4 }},
        {pokemon: 'Mawile', options: { weight: 4 }},
        {pokemon: 'Aaron', options: { weight: 4 }},
        {pokemon: 'Lairon', options: { weight: 4 }},
        {pokemon: 'Medicham', options: { weight: 4 }},
        {pokemon: 'Wailer', options: { weight: 4 }},
        {pokemon: 'Luvdisc', options: { weight: 4 }},
        {pokemon: 'Barboach', options: { weight: 4 }},
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Sigilyph', 37000, 45),
                new GymPokemon('Rhyperior', 37000, 45),
            ], { weight: 1 }, 'Albert', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Froslass', 37000, 47)],
            { weight: 1 }, 'Hope', '(female)'),
        new DungeonTrainer('Expert',
            [
                new GymPokemon('Hitmontop', 37000, 45),
                new GymPokemon('Throh', 37000, 45),
            ], { weight: 1 }, 'Bryn', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Mawile', 37000, 47)],
            { weight: 1 }, 'Edgar', '(male)'),
        new DungeonTrainer('Street Thug',
            [
                new GymPokemon('Houndoom', 37000, 43),
                new GymPokemon('Shiftry', 37000, 43),
            ], { weight: 1 }, 'Regan'),
        new DungeonTrainer('Ace Duo',
            [
                new GymPokemon('Armaldo', 37000, 47),
                new GymPokemon('Cradily', 37000, 47),
            ], { weight: 1 }, 'Jude & Rory'),
        new DungeonTrainer('Expert',
            [new GymPokemon('Sawk', 37000, 47)],
            { weight: 1 }, 'Theodore', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Electrode', 30000, 44),
                new GymPokemon('Darmanitan', 30000, 44),
                new GymPokemon('Swalot', 30000, 44),
            ], { weight: 1 }, 'Vito', '(male)'),
        new DungeonTrainer('Dragon Tamer',
            [new GymPokemon('Kingdra', 37000, 47)],
            { weight: 1 }, 'Egon'),
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Musharna', 37000, 47),
                new GymPokemon('Primeape', 37000, 47),
            ], { weight: 1 }, 'Aden & Finn'),
    ],
    [
        {loot: 'xAttack', weight: 3.75},
    ...
    [
        new DungeonTrainer('PKMN Trainer',
            [
                new GymPokemon('Altaria', 680000, 46),
                new GymPokemon('Delcatty', 670000, 46),
                new GymPokemon('Roselia', 680000, 46),
                new GymPokemon('Magneton', 650000, 46),
                new GymPokemon('Mega Gallade', 690000, 48),
            ], { weight: 1 }, 'Wally', '(wally)'),
    ],
    37000, 101);
