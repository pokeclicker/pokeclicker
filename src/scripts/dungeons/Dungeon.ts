...
dungeonList['P2 Laboratory'] = new Dungeon('P2 Laboratory',
    ['Frillish', 'Finneon', 'Horsea', 'Herdier', 'Magneton', 'Klang', 'Weezing', 'Watchog', 'Scrafty', 'Audino'],
    {
        ...
        epic: [
            ...
            {loot: 'Zap Plate'},
            {loot: 'Great_Twisted_Spoon', ignoreDebuff : true, weight: 3, requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 5), new QuestLineStepCompletedRequirement('An Unrivaled Power', 7, GameConstants.AchievementOption.less)])},
        ],
        legendary: [{loot: 'Revive'}],
    },
    5403000,
    ...
    [
        ...
        new DungeonTrainer('Anomaly Mewtwo',
            ...
            { hide: true, requirement: new MultiRequirement([
                ...
                new QuestLineCompletedRequirement('The Strongest Pokémon', GameConstants.AchievementOption.less),
            ])}),
    ],
    725000, 20);
