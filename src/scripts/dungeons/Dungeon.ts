...
dungeonList['Santalune Forest'] = new Dungeon('Santalune Forest',
    [
        ...
        new DungeonTrainer('Youngster',
            [
                new GymPokemon('Scatterbug', 2600000, 11),
                new GymPokemon('Fletchling', 2600000, 11),
            ], 1, { weight: 1 }, 'Joey'),
        new DungeonTrainer('Lass',
            [new GymPokemon('Pikachu', 2600000, 14)],
            1, { weight: 1 }, 'Anna'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    5303000,
    [
        new DungeonTrainer('Lass',
            [
                new GymPokemon('Weedle', 5303000, 11),
                new GymPokemon('Bunnelby', 5303000, 11),
            ], 1, { weight: 1 }, 'Lise'),
...
dungeonList['Connecting Cave'] = new Dungeon('Connecting Cave',
    ...
    [
        new DungeonTrainer('Pokémon Breeder',
            [
                new GymPokemon('Ducklett', 2600000, 11),
                new GymPokemon('Pikachu', 2600000, 11),
                new GymPokemon('Litleo', 2600000, 11),
                new GymPokemon('Oddish', 2600000, 11),
            ],
...
dungeonList['Glittering Cave'] = new Dungeon('Glittering Cave',
    [
        ...
        {pokemon: 'Onix', options: { weight: .88 }},
        ...
        {pokemon: 'Woobat', options: { weight: .88 }},
        {pokemon: 'Ferroseed', options: { weight: .88 }},
        {pokemon: 'Dwebble', options: { weight: .88 }},
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Houndour', 3500000, 11),
                new GymPokemon('Zubat', 3500000, 11),
            ], 1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Gulpin', 3500000, 14),
                new GymPokemon('Electrike', 3500000, 14),
    ...
    [
        new DungeonTrainer('Team Flare Grunt Duo',
            [
                new GymPokemon('Scraggy', 10500000, 14),
                new GymPokemon('Croagunk', 10500000, 14),
            ],1, { weight: 1 }, undefined),
...
dungeonList['Reflection Cave'] = new Dungeon('Reflection Cave',
    [
        ...
        {pokemon: 'Ferroseed', options: { weight: 4 }},
        new DungeonTrainer('Backpacker',
            [new GymPokemon('Linoone', 3500000, 11)],
            1, { weight: 1 }, 'Lane', '(male)'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 3500000, 14),
                new GymPokemon('Hawlucha', 3500000, 14),
            ],1, { weight: 1 }, 'Hedvig'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Sandile', 3500000, 11),
                new GymPokemon('Dwebble', 3500000, 11),
                new GymPokemon('Diggersby', 3500000, 11),
            ], 1, { weight: 1 }, 'Dunstan'),
        new DungeonTrainer('Tourist',
            [new GymPokemon('Nidorina', 3500000, 11)],
            1, { weight: 1 }, 'Monami', '(female)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Sawk', 3500000, 14)],
            1, { weight: 1 }, 'Igor'),
        new DungeonTrainer('Tourist',
            [
                new GymPokemon('Chimecho', 3500000, 11),
                new GymPokemon('Golett', 3500000, 11),
            ], 1, { weight: 1 }, 'Haruto', '(male)'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Throh', 3500000, 14)],
            1, { weight: 1 }, 'Franz', '(male)'),
        new DungeonTrainer('Honeymooners',
            [
                new GymPokemon('Combee', 3500000, 11),
                new GymPokemon('Vespiquen', 3500000, 11),
            ], 1, { weight: 1 }, 'Yuu & Ami'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    7653000,
    [
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Absol', 3500000, 14),
                new GymPokemon('Absol', 3500000, 14),
            ],1, { weight: 1 }, 'Emil', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Doduo', 3500000, 11),
...
dungeonList['Lost Hotel'] = new Dungeon('Lost Hotel',
    [
        ...
        {pokemon: 'Trubbish', options: { weight: 2.6 }},
        {pokemon: 'Rotom (fan)', options: { weight: 0.53 }},
        {pokemon: 'Rotom (frost)', options: { weight: 0.53 }},
        {pokemon: 'Rotom (heat)', options: { weight: 0.53 }},
        {pokemon: 'Rotom (mow)', options: { weight: 0.53 }},
        {pokemon: 'Rotom (wash)', options: { weight: 0.53 }},
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Graveler', 3500000, 11),
                new GymPokemon('Sharpedo', 3500000, 11),
                new GymPokemon('Pawniard', 3500000, 11),
            ],
            1, { weight: 1 }, 'Sid'),
        new DungeonTrainer('Punk Guy',
            [
                new GymPokemon('Skuntank', 3500000, 14),
                new GymPokemon('Crawdaunt', 3500000, 14),
            ],1, { weight: 1 }, 'Jacques'),
        new DungeonTrainer('Punk Guy',
            [new GymPokemon('Dunsparce', 3500000, 11)],
            1, { weight: 1 }, 'Slater'),
        new DungeonTrainer('Punk Girl',
            [
                new GymPokemon('Seviper', 3500000, 11),
                new GymPokemon('Arbok', 3500000, 11),
            ],
            1, { weight: 1 }, 'Jeanne'),
        new DungeonTrainer('Punk Girl',
            [
                new GymPokemon('Liepard', 3500000, 14),
                new GymPokemon('Liepard', 3500000, 14),
            ],
            1, { weight: 1 }, 'Cecile'),
    ],
    ...
    [
        new DungeonTrainer('Punk Couple',
            [
                new GymPokemon('Garbodor', 3500000, 11),
                new GymPokemon('Pangoro', 3500000, 11),
            ],1, { weight: 2 }, 'Zoya & Asa'),
        new DungeonBossPokemon('Garbodor', 92000000, 100),
...
dungeonList['Frost Cavern'] = new Dungeon('Frost Cavern',
    [
        ...
        new DungeonTrainer('Hiker',
            [new GymPokemon('Vibrava', 3500000, 11)],
            1, { weight: 1 }, 'Ross'),
        new DungeonTrainer('Sky Trainer',
            [
                new GymPokemon('Carnivine', 3500000, 14),
                new GymPokemon('Swanna', 3500000, 14),
            ],1, { weight: 1 }, 'Celso', '(male)'),
        new DungeonTrainer('Sky Trainer',
            [new GymPokemon('Cryogonal', 3500000, 11)],
            1, { weight: 1 }, 'Era', '(female)'),
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 3500000, 11)],
            1, { weight: 1 }, 'Salvador'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Doublade', 3500000, 14)],
            1, { weight: 1 }, 'Cordelia', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Raichu', 3500000, 11),
                new GymPokemon('Golduck', 3500000, 11),
                new GymPokemon('Marowak', 3500000, 11),
            ],
            1, { weight: 1 }, 'Neil', '(male)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Graveler', 3500000, 14),
                new GymPokemon('Graveler', 3500000, 14),
                new GymPokemon('Carbink', 3500000, 14),
            ],1, { weight: 1 }, 'Alain'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Relicanth', 3500000, 11),
                new GymPokemon('Rhydon', 3500000, 11),
            ],
            1, { weight: 1 }, 'Delmon'),
        new DungeonTrainer('Brains & Brawn',
            [
                new GymPokemon('Grumpig', 3500000, 11),
                new GymPokemon('Hariyama', 3500000, 11),
            ],
            1, { weight: 1 }, 'Eoin & Wolf'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Scrafty', 3500000, 14),
                new GymPokemon('Throh', 3500000, 14),
            ],
            1, { weight: 1 }, 'Alonzo'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Sawk', 3500000, 11),
                new GymPokemon('Mienshao', 3500000, 11),
            ],
            1, { weight: 1 }, 'Kinsey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Gurdurr', 3500000, 14)],1, { weight: 1 }, 'Kenji'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Probopass', 3500000, 11)],
            1, { weight: 1 }, 'Brent'),
        new DungeonTrainer('Battle Girl',
            [new GymPokemon('Medicham', 3500000, 11)],
            1, { weight: 1 }, 'Gabrielle'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 3500000, 14),
                new GymPokemon('Manectric', 3500000, 14),
            ],
            1, { weight: 1 }, undefined, '(female)'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
...
dungeonList['Team Flare Secret HQ'] = new Dungeon('Team Flare Secret HQ',
    [
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Toxicroak', 3500000, 11)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Steelix', 3500000, 14)],1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Manectric', 3500000, 11)],
            1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Mightyena', 3500000, 14)],1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Houndoom', 3500000, 11)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Scrafty', 3500000, 14)],1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Liepard', 3500000, 14),
                new GymPokemon('Manectric', 3500000, 14),
            ], 1, { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Mightyena', 3500000, 11),
                new GymPokemon('Houndoom', 3500000, 11),
            ],1, { weight: 2 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Swalot', 3500000, 14)],
            1, { weight: 2 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Golbat', 3500000, 14)],
            1, { weight: 2 }, undefined, '(male)'),
    ...
    [
        new DungeonTrainer('Team Flare',
            [
                new GymPokemon('Mienshao', 3500000, 14),
                new GymPokemon('Honchkrow', 3500000, 14),
                new GymPokemon('Pyroar', 3500000, 14),
                new GymPokemon('Gyarados', 3500000, 14),
            ],
            1, { weight: 2 }, 'Lysandre', '(lysandre)'),
...
dungeonList['Terminus Cave'] = new Dungeon('Terminus Cave',
    [
        ...
        {pokemon: 'Shuckle', options: { weight: 3.27 }},
        {pokemon: 'Ariados', options: { weight: 3.27 }},
        {pokemon: 'Noibat', options: { weight: 3.27 }},
        new DungeonTrainer('Worker',
            [
                new GymPokemon('Graveler', 3500000, 11),
                new GymPokemon('Graveler', 3500000, 11),
                new GymPokemon('Golem', 3500000, 11),
            ],
            1, { weight: 1 }, 'Narek'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Steelix', 3500000, 14),
                new GymPokemon('Boldore', 3500000, 14),
            ],1, { weight: 1 }, 'Bergin'),
        new DungeonTrainer('Hiker',
            [new GymPokemon('Rhydon', 3500000, 11)],
            1, { weight: 1 }, 'Aaron'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Octillery', 3500000, 11)],
            1, { weight: 1 }, 'Dimitri'),
        new DungeonTrainer('Worker',
            [new GymPokemon('Probopass', 3500000, 14)],
            1, { weight: 1 }, 'Yusif'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Throh', 3500000, 11),
                new GymPokemon('Conkeldurr', 3500000, 11),
            ], 1, { weight: 1 }, 'Andrea'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Toxicroak', 3500000, 14),
                new GymPokemon('Sawk', 3500000, 14),
            ], 1, { weight: 1 }, 'Gunnar'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Medicham', 3500000, 11),
                new GymPokemon('Hawlucha', 3500000, 11),
            ],1, { weight: 1 }, 'Hailey'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Hariyama', 3500000, 14)],
            1, { weight: 1 }, 'Ricardo'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8753000,
    [
        new DungeonTrainer('Pokémon Rangers',
            [
                new GymPokemon('Nidoqueen', 3500000, 11),
                new GymPokemon('Nidoking', 3500000, 11),
            ],1, { weight: 3 }, 'Fern & Lee'),
...
dungeonList['Pokéball Factory'] = new Dungeon('Pokéball Factory',
    [
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Toxicroak', 3500000, 11)], 1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Mightyena', 3500000, 11),
                new GymPokemon('Golbat', 3500000, 11),
            ], 1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Scraggy', 3500000, 11),
                new GymPokemon('Mightyena', 3500000, 11),
            ], 1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Swalot', 3500000, 11)], 1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [
                new GymPokemon('Scraggy', 3500000, 11),
                new GymPokemon('Houndoom', 3500000, 14),
            ],
            1, { weight: 4 }, undefined, '(female)'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8503000,
    [
...
dungeonList['Kalos Power Plant'] = new Dungeon('Kalos Power Plant',
    [
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Croagunk', 3500000, 11),
                new GymPokemon('Scraggy', 3500000, 11),
            ], 1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
        ...
        new DungeonTrainer('Team Flare Grunt',
            [new GymPokemon('Mightyena', 3500000, 14)],
            1, { weight: 1 }, undefined, '(male)'),
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Golbat', 3500000, 11),
        ...
        new DungeonTrainer('Team Flare Grunt',
            [
                new GymPokemon('Liepard', 3500000, 11),
                new GymPokemon('Swalot', 3500000, 11),
            ], 1, { weight: 1 }, undefined, '(female)'),
        new DungeonTrainer('Team Flare Admin',
            [new GymPokemon('Houndoom', 3500000, 14)],
            1, { weight: 8 }, undefined, '(male)'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    8503000,
    [
...
dungeonList['Victory Road Kalos'] = new Dungeon('Victory Road Kalos',
    [
        ...
        {pokemon: 'Geodude', options: { weight: 3.27 }},
        {pokemon: 'Shuckle', options: { weight: 3.27 }},
        {pokemon: 'Fearow', options: { weight: 3.27 }},
        {pokemon: 'Ariados', options: { weight: 3.27 }},
        {pokemon: 'Noibat', options: { weight: 3.27 }},
        ...
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Carbink', 3500000, 11),
                new GymPokemon('Raichu', 3500000, 11),
                new GymPokemon('Kingdra', 3500000, 11),
            ],
            1, { weight: 1 }, 'Robbie', '(male)'),
        new DungeonTrainer('Ace Trainer',
            [new GymPokemon('Weavile', 3500000, 14)],1, { weight: 1 }, 'Alanza', '(female)'),
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Steelix', 3500000, 11),
                new GymPokemon('Electrode', 3500000, 11),
                new GymPokemon('Kangaskhan', 3500000, 11),
            ],
            1, { weight: 1 }, 'Bence', '(male)'),
        new DungeonTrainer('Black Belt',
            [new GymPokemon('Machamp', 3500000, 11)],
            1, { weight: 1 }, 'Markus'),
        new DungeonTrainer('Battle Girl',
            [
                new GymPokemon('Hawlucha', 3500000, 14),
            ...
            1, { weight: 1 }, 'Veronique'),
        new DungeonTrainer('Backpacker ',
            [new GymPokemon('Haxorus', 3500000, 11)], 1, { weight: 1 }, 'Farid', '(male)'),
        new DungeonTrainer('Batlle Girl',
            [new GymPokemon('Medicham', 3500000, 14)], 1, { weight: 1 }, 'Sigrid'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Pangoro', 3500000, 11),
                new GymPokemon('Gallade', 3500000, 11),
            ],1, { weight: 1 }, 'Ander'),
        new DungeonTrainer('Psychic',
            [new GymPokemon('Espeon', 3500000, 14)],
        ...
        new DungeonTrainer('Brains & Brawn',
            ...
            1, { weight: 1 }, 'Arman & Hugo'),
        new DungeonTrainer('Fairy Tale GIrl',
            [
                new GymPokemon('Azumarill', 3500000, 14),
                new GymPokemon('Florges (Red)', 3500000, 14),
            ],1, { weight: 1 }, 'Corrine'),
        new DungeonTrainer('Hex Maniac',
            [new GymPokemon('Gourgeist', 3500000, 11)],
            1, { weight: 1 }, 'Raziah'),
        new DungeonTrainer('Pokémon Ranger',
            [
                new GymPokemon('Slowbro', 3500000, 11),
                new GymPokemon('Altaria', 3500000, 11),
            ],
            1, { weight: 1 }, 'Petra', '(female)'),
        new DungeonTrainer('Veteran',
            [new GymPokemon('Talonflame', 3500000, 14)],
            1, { weight: 1 }, 'Inga', '(female)'),
        new DungeonTrainer('Pokémon Ranger',
            [new GymPokemon('Crobat', 3500000, 11)], 1, { weight: 1 }, 'Ralf', '(male)'),
        new DungeonTrainer('Black Belt',
            [
                new GymPokemon('Banette', 3500000, 14),
                new GymPokemon('Leafeon', 3500000, 14),
            ], 1, { weight: 1 }, 'Gerard', '(male)'),
        new DungeonTrainer('Artist',
            [new GymPokemon('Smeargle', 3500000, 11)],1, { weight: 1 }, 'Vincent'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Trevenant', 3500000, 14),
                new GymPokemon('Gigalith', 3500000, 14),
            ],1, { weight: 1 }, 'Timeo', '(male)'),
    ],
    [GameConstants.BattleItemType.xClick, GameConstants.BattleItemType.Item_magnet],
    9003000,
    [
        new DungeonTrainer('Ace Trainer',
            [
                new GymPokemon('Magcargo', 3500000, 14),
                new GymPokemon('Scizor', 3500000, 14),
            ],
            1, { weight: 1 }, 'Michele', '(female)'),
        new DungeonTrainer('Hiker',
            [
                new GymPokemon('Torkoal', 3500000, 11),
                new GymPokemon('Golem', 3500000, 11),
            ],
            1, { weight: 1 }, 'Corwin'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Glaceon', 3500000, 14),
                new GymPokemon('Snorlax', 3500000, 14),
            ],1, { weight: 1 }, 'Catrina', '(female)'),
        new DungeonTrainer('Veteran',
            [
                new GymPokemon('Skarmory', 3500000, 14),
                new GymPokemon('Umbreon', 3500000, 14),
                new GymPokemon('Alakazam', 3500000, 14),
            ],1, { weight: 1 }, 'Giles', '(male)'),
        new DungeonBossPokemon('Skarmory', 95000000, 100),
        new DungeonBossPokemon('Hydreigon', 95000000, 100),
        new DungeonBossPokemon('Poliwrath', 95000000, 100),
    ],
    96500, 230, 100);
