...
dungeonList['Seafloor Cavern'] = new Dungeon('Seafloor Cavern',
    [
        {pokemon: 'Zubat', options: { weight: 12 }},
        {pokemon: 'Golbat', options: { weight: 12 }},
        {pokemon: 'Tentacool', options: { weight: 12 }},
        {pokemon: 'Magikarp', options: { weight: 12 }},
        {pokemon: 'Wailmer', options: { weight: 12 }},
        new DungeonTrainer('Team Aqua Grunt',
