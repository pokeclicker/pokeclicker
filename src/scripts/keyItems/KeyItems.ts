class KeyItems implements Feature {
    ...
    initialize() {
        this.itemList = [
            ...
            new KeyItem(KeyItems.KeyItem.Coin_case, 'A case for holding money. It can hold an infinite amount of coins', null, true, undefined, 'Coin Case'),
