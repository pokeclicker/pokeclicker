...
class QuestHelper {
    ...
    public static highestOneShotRoute(region: GameConstants.Region): number {
        ...
        const attack = Math.max(1, App.game.party.calculatePokemonAttack(PokemonType.None, PokemonType.None, false, region, true, false, WeatherType.Clear, true, false, 0));
