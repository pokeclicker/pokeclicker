...
class QuestLineHelper {
    ...
    public static createVivillonQuestLine() {
        ...
        const createVivillonQuest = (type: PokemonType, vivillon: PokemonNameType, hint: string) => {
            // Capture 100 Pokemon of specified type
        ...
        createVivillonQuest(PokemonType.Water, 'Vivillon (Marine)', 'It has been spotted at some Lakes.'); // Lake Verity, Lake Valor, Lake Acuity
        createVivillonQuest(PokemonType.Psychic, 'Vivillon (Modern)', 'It\'s surrounded by strong Pokémon.'); // Cerulean Cave
        createVivillonQuest(PokemonType.Poison, 'Vivillon (Jungle)', 'It has been spotted in a swamp.'); // Moor of Icirrus
        createVivillonQuest(PokemonType.Dark, 'Vivillon (Monsoon)', 'It\'s hiding at a dark place.'); // Dark Cave
        createVivillonQuest(PokemonType.Steel, 'Vivillon (Tundra)', 'It flew into a factory.'); // Poké Ball Factory
        createVivillonQuest(PokemonType.Fire, 'Vivillon (Sun)', 'It seems to like hot places.'); // Mt. Chimney Crater
        createVivillonQuest(PokemonType.Fighting, 'Vivillon (Archipelago)', 'It\'s sitting on a swaying pillar.'); // Sprout Tower
        createVivillonQuest(PokemonType.Ghost, 'Vivillon (Elegant)', 'It\'s visiting an abandoned and spooky place.'); // Lost Hotel
        createVivillonQuest(PokemonType.Fairy, 'Vivillon (Ocean)', 'It\'s flying around an overgrown place full of dreams.'); // Dreamyard
        createVivillonQuest(PokemonType.Electric, 'Vivillon (Continental)', 'It\'s currently in a City full of Electric-type Pokémon.'); // New Mauville
        createVivillonQuest(PokemonType.Bug, 'Vivillon (River)', 'It hides in a dark Forest.'); // Eterna Forest
        createVivillonQuest(PokemonType.Flying, 'Vivillon (Polar)', 'It\'s high up in the sky.'); // Sky Pillar
        createVivillonQuest(PokemonType.Ground, 'Vivillon (Sandstorm)', 'It got lost in the desert sand.'); // Relic Castle
        createVivillonQuest(PokemonType.Grass, 'Vivillon (Garden)', 'It only shows up amongst the most beautiful flowers.'); // Flower Paradise
        createVivillonQuest(PokemonType.Rock, 'Vivillon (High Plains)', 'It has been spotted dancing in the moonlight.'); // Mt. Moon
        createVivillonQuest(PokemonType.Dragon, 'Vivillon (Savanna)', 'It\'s surrounded by dragons.'); // Dragonspiral Tower
        createVivillonQuest(PokemonType.Ice, 'Vivillon (Icy Snow)', 'It can be found at a very cold place.'); // Frost Cavern
