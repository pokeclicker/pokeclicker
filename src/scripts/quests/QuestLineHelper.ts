...
class QuestLineHelper {
    ...
    public static createGigantamaxQuestLine() {
        const gigantamaxQuestLine = new QuestLine('The Lair of Giants', 'TODO', new MultiRequirement([new GymBadgeRequirement(BadgeEnums.Elite_GalarChampion), new DevelopmentRequirement()]), GameConstants.BulletinBoards.Galar);
