...
class QuestLineHelper {
    ...
    public static createVivillonQuestLine() {
        const vivillonQuestLine = new QuestLine('The Great Vivillon Hunt!', 'Discover the beauty of Vivillon.', true, GameConstants.BulletinBoards.Kalos);
    ...
    public static createAshKetchumQuestLine() {
        const ashKetchumQuestLine = new QuestLine('The New Kid', 'A new kid from your home town is making waves. Show him who the real prodigy of Pallet Town is.', true, GameConstants.BulletinBoards.Kalos);
