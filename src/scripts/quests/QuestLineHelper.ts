class QuestLineHelper {
    ...
    public static createTutorial() {
        ...
        //Buy pokeballs
        let buyPokeballs = new BuyPokeballsQuest(10, GameConstants.Pokeball.Pokeball, 50);
        buyPokeballs.pointsReward = 50;
        buyPokeballs.description = "Buy 10 pokeballs. You can find these in the Pewter City Shop.";
        ...
        //Buy Dungeon ticket
        let buyDungeonTicket = new CustomQuest(1, 10, 'Buy the Dungeon ticket from Pewter City Shop.', () => +player.hasKeyItem('Dungeon ticket'));
