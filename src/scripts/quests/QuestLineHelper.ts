...
class QuestLineHelper {
    ...
    public static createSwordsQuestLine() {
        const swordsofJusticeQuest = new QuestLine('Swords of Justice', 'The Swords of Justice sense something bad is about to happen, will you be able to help them?', new GymBadgeRequirement(BadgeEnums.Elite_UnovaChampion), GameConstants.BulletinBoards.Unova);
        ...
        const reuniteTerrakion = new DefeatDungeonQuest(5, 0, 'Victory Road Unova').withDescription('Start Reuniting the Swords of Justice once again. You should probably start looking for Terrakion around the Victory Road Unova.');
        ...
        const talkToCobalion2 = new TalkToNPCQuest(Cobalion2, 'Talk to Cobalion at Moor of Icirrus to know where to find Virizion.');
        ...
        const talkToVirizion1 = new TalkToNPCQuest(Virizion1, 'Now that you\'ve found Virizion tell them to meet the others at Moor of Icirrus.');
        swordsofJusticeQuest.addQuest(talkToVirizion1);

        const proveVirizion = new GainGemsQuest(5000, 0, PokemonType.Grass).withDescription('Virizion is asking you to gather them 5,000 Grass Gems to prove you\'re a trustworthy ally.');
        ...
        const talkToCobalion4 = new TalkToNPCQuest(Cobalion4, 'Report to Cobalion your findings at Moor of Icirrus.');
        ...
        const talkToCobalion5 = new TalkToNPCQuest(Cobalion5, 'Seems like Kyurem has fled the town. You should talk to the Swords of Justice while you\'re there.');
        swordsofJusticeQuest.addQuest(talkToCobalion5);

        const searchForKyurem2 = new DefeatDungeonQuest(5, 0, 'Giant Chasm').withDescription('Kyurem is now probably hiding on their hideout. Search for them once again inside the Giant Chasm!');
        ...
        const defeatKyurem3 = new DefeatTemporaryBattleQuest('Kyurem 3', 'Defeat Kyurem and lock them from causing any more harm!');
