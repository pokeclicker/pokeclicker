class QuestLineHelper {
    ...
    public static createTutorial() {
        ...
        //Buy pokeballs
        let buyPokeballs = new BuyPokeballsQuest(20, GameConstants.Pokeball.Pokeball, 50);
        ...
        //Buy Dungeon ticket
        let buyDungeonTicket = new CustomQuest(1, 10, 'Buy the Dungeon ticket from Pewter City Shop.', () => + App.game.keyItems.hasKeyItem(KeyItems.KeyItem.Dungeon_ticket));
