...
class QuestLineHelper {
    ...
    public static createDrSplashQuestLine() {
        ...
        drSplashQuestLine.addQuest(new MultipleQuestsQuest([
            ...
            ItemList.Sand_Bag_Magikarp_Jump.gain(1);
            ItemList.Jump_Counter_Magikarp_Jump.gain(1);
            ItemList.Timber_Magikarp_Jump.gain(1);
            ItemList.Rock_Cruncher_Magikarp_Jump.gain(1);
            ItemList.Power_Generator_Magikarp_Jump.gain(1);
            ItemList.Pokeball_Smash_Magikarp_Jump.gain(1);
            ItemList.Frost_Cruncher_Magikarp_Jump.gain(1);
        }));
        ...
        drSplashQuestLine.addQuest(new MultipleQuestsQuest([
            ...
            ItemList.Push_Dwebble_Magikarp_Jump.gain(1);
            ItemList.Push_Boldore_Magikarp_Jump.gain(1);
            ItemList.Push_Forretress_Magikarp_Jump.gain(1);
            ItemList.Push_Golem_Magikarp_Jump.gain(1);
            ItemList.Push_Steelix_Magikarp_Jump.gain(1);
        }));
