...
class AchievementHandler {
    ...
    public static initialize(multiplier: Multiplier, challenges: Challenges) {
        ...
        AchievementHandler.addAchievement('Who dropped these here?', 'Pick up 10 Items in the Safari Zone', new SafariItemsRequirement(10), 0.2);
        AchievementHandler.addAchievement('This is not a Pokéball!', 'Throw 10 Rocks in the Safari Zone', new SafariRocksRequirement(10), 0.2);
        AchievementHandler.addAchievement('Hope it likes berries', 'Throw 10 Bait in the Safari Zone', new SafariBaitRequirement(10), 0.2);
        AchievementHandler.addAchievement('Gotta get your steps in!', 'Walk 100 Steps in the Safari Zone', new SafariStepsRequirement(100), 0.2);
