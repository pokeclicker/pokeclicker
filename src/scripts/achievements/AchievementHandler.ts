...
class AchievementHandler {
    ...
    public static initialize(multiplier: Multiplier, challenges: Challenges) {
        ...
        AchievementHandler.addAchievement('Oak is the best!', 'Level 8 Oak Items to the maximum level', new MaxLevelOakItemRequirement(8), 0.15, GameConstants.Region.none, () => !challenges.list.disableOakItems.active());
        AchievementHandler.addAchievement('Prepared for anything!', 'Level 12 Oak Items to the maximum level', new MaxLevelOakItemRequirement(12), 0.15, GameConstants.Region.none, () => !challenges.list.disableOakItems.active());
