...
class Weather {
    ...
    public static weatherConditions: { [weather in WeatherType]?: WeatherCondition } = {
        ...
        [WeatherType.Overcast]:           new WeatherCondition(WeatherType.Overcast, '#bed8ff', 'Clouds fill the skies.', 20),
        ...
        [WeatherType.Sunny]:         new WeatherCondition(WeatherType.Sunny, '#f5ac78', 'The sunlight is strong.', 10,
        ...
        [WeatherType.Windy]:            new WeatherCondition(WeatherType.Windy, '#81c4ca', 'Mysterious strong winds blow.', 0,
